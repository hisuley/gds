 ...
 * ============================================================================
 * $Id: ctl.conf.php 5624 2008-08-21 02:39:40Z Wj $
 */
            ...
            foreach ($group_items as $group_code => $items)
            {
                foreach ($items as $item)
                {
                    ...
                    else
                    {
                        ...
                        {
                            $_POST[$item['code']] = $this->get_editor_content($_POST[$item['code']], 0);
                        }
            ...
            foreach ($group_items as $group_code => $items)
            {
                ...
                foreach ($items as $key => $res)
                {
                    ...
                    if ($res['code'] == 'store_intro')
                    {
                        ...
                        $this->build_editor('store_intro', $values['store_intro'], '96%', '300', 'store_intro', 'true', $attachments, 0);
                    }
