 ...
 * ============================================================================
 * $Id: order.php 5622 2008-08-21 02:23:49Z Garbin $
 */
...
class OrderController extends ControllerBackend
{
    ...
    function drop()
    {
        ...
        $this->show_message($this->str_format('drop_order_sucessful', $del_num), $this->lang('view_order'), 'admin.php?app=order&amp;act=view');
        return;
    }
