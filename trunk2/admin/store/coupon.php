 ...
 * ============================================================================
 * $Id: coupon.php 5614 2008-08-20 07:25:13Z Wj $
 */
...
class CouponController extends ControllerBackend
{
    ...
    function sent()
    {
        ...
        else
        {
            ...
            if (!empty($users))
            {
                ...
                if ($model < 2)
                {
                    $this->_pm_to_user($users, $coupon['coupon_value']);
                }

                if ($model != 1)
                {
                    $this->_mail_to_user($users, $coupon['coupon_value']);
                }
     ...
     * @return  void
     */
    function _pm_to_user($users, $coupon_value)
    {
        ...
        foreach ($users AS $val)
        {
            ...
            $msg = $this->str_format('send_coupon_message', $store_name, $coupon_value,
                $val['coupon'], $url);
     ...
     * @return  void
     */
    function _mail_to_user($users, $coupon_value)
    {
        $store_name = $this->_store_name();
        ...
        foreach ($users AS $val)
        {
            ...
            $values['coupon_value'] = $coupon_value;
