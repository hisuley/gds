 ...
 * ============================================================================
 * $Id: cls.captcha.php 5512 2008-08-12 06:10:30Z Wj $
 */
if (!defined('IN_ECM'))
{
...
$code->animator = 0;
$code->display();
$code->fontpath = ROOT_PATH.'/data/captcha/fonts/';
$code->imagepath = ROOT_PATH.'/data/captcha/';
...
class Captcha
{
    ...
    function Captcha()
    {
        $this->fontpath = ROOT_PATH.'/data/captcha/fonts/';
        $this->imagepath = ROOT_PATH.'/data/captcha/';
    }
    ...
    function image()
    {
        ...
        {
            include_once(ROOT_PATH.'/includes/cls.gifmerge.php');
