 ...
 * ============================================================================
 * $Id: mod.category.php 5639 2008-08-25 02:40:24Z Wj $
 */
...
class Category extends Model
{
     ...
     * @return void
     */
    function list_child_id ()
    {
        return array_keys($this->_get_child(0));
    }
   ...
   function drop ()
   {
       ...
       $sql = "DELETE FROM `ecm_category` WHERE cate_id='{$this->_id}'";
