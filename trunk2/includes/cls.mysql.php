 ...
 * ============================================================================
 * $Id: cls.mysql.php 5663 2008-09-01 06:12:11Z Garbin $
 */
...
class cls_mysql
{
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        ...
        else
        {
            ...
            echo '<a href="http://faq.comsenz.com/?type=mysql&amp;dberrno=' . $error_no . '&amp;dberror=' . urlencode($error) . '" target="_blank">'. Language::get('mysql_error_report') . '</a>';
        }
