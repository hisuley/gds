 ...
 * ============================================================================
 * $Id: storelist.php 5692 2008-09-05 09:02:16Z Scottye $
 */
...
class StoreListController extends ControllerFrontend
{
    ...
    function view()
    {
        ...
        if (!$need_cache || !$this->is_cached($cache_id))
        {
            ...
            $sort_list = array(
                $url . 'sort=add_time&order=desc'       => $this->lang('store_sort.time_asc'),
                $url . 'sort=add_time&order=asc'        => $this->lang('store_sort.time_desc'),
                $url . 'sort=store_name&order=desc'     => $this->lang('store_sort.name_asc'),
                $url . 'sort=store_name&order=asc'      => $this->lang('store_sort.name_desc'),
                $url . 'sort=goods_count&order=desc'    => $this->lang('store_sort.goods_asc'),
                $url . 'sort=goods_count&order=asc'     => $this->lang('store_sort.goods_desc'),
                $url . 'sort=seller_credit&order=desc'  => $this->lang('store_sort.credit_asc'),
                $url . 'sort=seller_credit&order=asc'   => $this->lang('store_sort.credit_desc'),
            );
