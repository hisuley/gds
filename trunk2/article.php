 ...
 * ============================================================================
 * $Id: article.php 5368 2008-07-31 06:58:31Z Liupeng $
 */
...
class ArticleController extends ControllerFrontend
{
    ...
    function site_news()
    {
        ...
        else
        {
            ...
            $this->assign('title', $article['title'] . '-' . $this->lang('site_news'));
        }
    ...
    function help_center()
    {
        ...
        if (!$this->is_cached($cache_id))
        {
            ...
            $this->assign('title', $cur_article['title'] . '-' . $this->lang('help_center'));
        }
