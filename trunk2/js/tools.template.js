 ...
 * ============================================================================
 * $Id: tools.template.js 5241 2008-07-15 06:41:53Z Liupeng $
 */
var ecmtcp = null;
...
function _templateUpdate(noalert, force) {
  ...
  if(config.toJSONString() == data.toJSONString() && !skinChanged && !force) {
    if (!noalert) d.show();
    return;
  } else {
    if (config.toJSONString() != data.toJSONString())
