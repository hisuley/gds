 ...
 * ============================================================================
 * $Id: validator.js 5396 2008-08-01 06:38:40Z Wj $
 */
...
var Validator =
{
  ...
  addInput : function (theInput) {
    ...
    if (Tips.length > 0) theInput.tip = $(Tips[0]);
  ...
  addSelect : function (theSelect){
    ...
    if (Tips.length > 0) theSelect.tip = $(Tips[0]);
  ...
  showOk : function (theInput) {
    theInput.msg.innerHTML = '<img src="admin/images/check_right.gif" alt="ok" />';
