 ...
 * ============================================================================
 * $Id: shopping.php 5690 2008-09-05 08:42:53Z Garbin $
 */
...
class ShoppingController extends ControllerFrontend
{
    ...
    function evaluation()
    {
        ...
        $is_add_friend = intval($_GET['is_add_friend']);
    ...
    function _fee_count($order_info)
    {
        ...
        /* 优惠费用 */
        $coupon_value = isset($_SESSION['coupons'][$this->_store_id]) ? $_SESSION['coupons'][$this->store_id]['value'] : 0;
