  ...
  <div class="os_x"></div>
    ...
    <p><em>(工作日：9:00-18:30)</em></p>
      <p><strong>在线QQ</strong></p>
        <a target="_blank" href="http://wpa.qq.com/msgrd@v=3&uin=1792347823&site=qq&menu=yes"><p id="ico_onlineqq" class="qq"></p></a>
...
$j(document).ready(function(){
  ...
  $boxOsFun = function(){var st=$j(document).scrollTop();if (!window.XMLHttpRequest) {$j('.box_os').css('top',st+44);$j('.onlineService').css('top',st+44);}};
