...
if ($goodsinfo['lock_flg']) {
    trigger_error($s_langpackage->s_goods_locked);
}
if (!$goodsinfo) {
    ...
    <div id="contents" class="clearfix">
        ...
        <div id="itemContents" class="clearfix">
            <div id="intro">
                ...
                <div class="box">
                    <div id="magnifier"><img id="img" alt=""
                                             src="<?php echo isset($gallery[0]['img_original']) ? $gallery[0]['img_original'] : 'skin/default/images/nopic_big.gif'; ?>">

                        <div id='Browser'></div>
                    </div>
                    <div id="mag"><img id="magnifierImg"/></div>
                    <div class="pic_box clear"><a class="left_button" href="javascript:void(0);"
                                                  onclick="img_pre('list1_1');"></a>

                        <div id="thumbbox">
                            <div class="long_box" id="list1_1"> <?php foreach ($gallery as $val) { ?> <a
                                    href="javascript:;" rev="<?php echo $val['img_url']; ?>"
                                    rel="<?php echo $val['img_original']; ?>" onclick="javascript:return false;"> <img
                                        src="<?php echo $val['thumb_url']; ?>" onclick="changeImage(this)"
                                        onerror="this.src='skin/default/images/nopic.gif'"></a> <?php } ?> </div>
                        </div>
                        <a class="right_button" href="javascript:void(0);" onclick="img_next('list1_1');"></a></div>
                </div>
                <div class="itemProperty">
                    <ul id="attr_ul">
                        <li><span><?php echo $s_langpackage->s_goods_price; ?>
                                ：</span> <?php if ($goodsinfo['goods_price'] == '0.00') { ?> <em
                                class="price"><?php echo $s_langpackage->s_no_price; ?></em> <?php } else { ?>
                                <?php echo $s_langpackage->s_money_sign; ?><em class="price"
                                                                               id="price_value"><?php echo $goodsinfo['goods_price']; ?></em> <?php echo $s_langpackage->s_yuan; ?>
                            <?php } ?> </li>
                        <li><span><?php echo $s_langpackage->s_goods_transport; ?>：</span>
                            <?php if ($goodsinfo['is_transport_template'] == '1') { ?>
                                <span style="display:bolck; position:relative" onmouseover="showarealist(1)"><span
                                        id="area_name"><?php echo $s_langpackage->s_area; ?></span>
							<div
                                style="position:absolute;style:top:0px;left:-70px; border:3px #eee solid; padding:10px; padding-left:25px; background:#f8f8f8;display:none; width:300px;"
                                id="areabox"> <?php foreach ($area_list as $value) { ?>
                                    <div style="float:left; width:60px;"><a href="javascript:;"
                                                                            onclick="gettransport_price(<?php echo $value['area_id']; ?>,'<?php echo $value['area_name']; ?>')"><?php echo $value['area_name']; ?></a>
                                    </div>
                                <?php } ?> <input class="new_button" type="button" name="btu"
                                                  value="<?php echo $s_langpackage->s_close; ?>"
                                                  onclick="showarealist(0)"/></div>
...
=======
                        ...
                        <li><span><?php echo $s_langpackage->s_goods_wtbuy; ?>：</span> <span> <input type="text"
                                                                                                     size="4" value="1"
                                                                                                     maxvalue="1"
                                                                                                     minvalue="1"
                                                                                                     id='num'/> <input
                                    type="hidden" value="<?php echo $goodsinfo['goods_number']; ?>" id="goods_number"/> <input
                                    type="hidden" value="<?php echo $shop_id; ?>" id="shop_id"/> <input type="hidden"
                                                                                                        value="<?php echo $USER['user_id']; ?>"
                                                                                                        id="shop_user"/> <input
                                    type="hidden" value="<?php echo $goodsinfo['favpv']; ?>"
                                    id="favpv_num"> <label></label> </span>
                            (<?php echo $s_langpackage->s_may_buy; ?><?php echo $goodsinfo['goods_number']; ?> <?php echo $s_langpackage->s_piece; ?>
                            )
                        </li>
                        <?php if ($goodsinfo['goods_price'] == '0.00') { ?>
                        <li class="b_none clearfix"><a class="btn_inquiry"
                                                       href="inquiry.php?gid=<?php echo $goodsinfo['goods_id']; ?>"
                                                       title="<?php echo $s_langpackage->s_g_askprice; ?>"></a> <?php } else { ?>
                        <li class="b_none clearfix"> <?php if ($goodsinfo['goods_number'] == '0') { ?> <a
                                class="btn_buy" href="javascript:alert('<?php echo $s_langpackage->s_kucun_0; ?>');"
                                title="<?php echo $s_langpackage->s_g_buy; ?>"></a> <?php } else { ?> <a class="btn_buy"
                                                                                                         href="javascript:gotoOrder(<?php echo $goodsinfo['goods_id']; ?>);"
                                                                                                         title="<?php echo $s_langpackage->s_g_buy; ?>"></a> <?php } ?>
                            <a class="btn_add" href="javascript:addCart(<?php echo $goodsinfo['goods_id']; ?>);"
                               title="<?php echo $s_langpackage->s_g_tocart; ?>"></a> <?php } ?> <a class="btn_fav"
                                                                                                    href="javascript:addFavorite(<?php echo $goodsinfo['goods_id']; ?>);"
                                                                                                    title="<?php echo $s_langpackage->s_g_tofavorite; ?>"></a>
                        </li>
                        <li><span><?php echo $s_langpackage->s_company_Support; ?>：</span> <?php if ($payment_info) { ?>
                                <?php foreach ($payment_info as $val) { ?> <a><img
                                        src="plugins/<?php echo $val; ?>/min_logo.gif" height="25"/></a> <?php } ?>
                            <?php } else { ?> <label
                                class='fc'><?php echo $s_langpackage->s_no_payment; ?></label> <?php } ?> </li>
                        <li><span><?php echo $s_langpackage->s_goods_number; ?>
                                ：</span> <?php echo str_replace("{num}", "<em>" . $goodsinfo['goods_number'] . "</em>", $s_langpackage->s_goods_mum); ?>
                        </li>
                        <li><span><?php echo $s_langpackage->s_goods_pv; ?>
                                ：</span> <?php echo str_replace("{pv}", "<em>" . $goodsinfo['pv'] . "</em>", $s_langpackage->s_goods_pvnum); ?>
                        </li>
                        <li><span><?php echo $s_langpackage->s_collect_num; ?>
                                ：</span><?php echo $s_langpackage->s_have; ?><em><span
                                    id="favpv"><?php echo $goodsinfo['favpv']; ?></span></em><?php echo $s_langpackage->s_collect; ?>
                        </li>
                        <li><span><?php echo $s_langpackage->s_send_address; ?>
                                ：</span> <?php echo $areainfo[$SHOP['shop_province']]; ?>
                            .<?php echo $areainfo[$SHOP['shop_city']]; ?> </li>
                        <li class="b_none"><span class="colorOr"><?php echo $s_langpackage->s_share; ?></span> <a
                                class="link_renren"
                                href=javascript:window.open('http://share.xiaonei.com/share/buttonshare.do?title='+encodeURIComponent(document.title)+'&link='+encodeURIComponent(document.location.href),'favit','');void(0)><?php echo $s_langpackage->s_renren; ?></a>
                            <a class="link_kaixin"
                               href=javascript:window.open('http://www.kaixin001.com/repaste/share.php?rtitle='+encodeURIComponent(document.title)+'&rurl='+encodeURIComponent(document.location.href),'favit','');void(0)><?php echo $s_langpackage->s_kaixin; ?></a>
                            <a class="link_douban"
                               href=javascript:window.open('http://www.douban.com/recommend/?title='+encodeURIComponent(document.title)+'&url='+encodeURIComponent(location.href),'favit','');void(0)><?php echo $s_langpackage->s_douban; ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="shopInfo mg12b">
                <h2><a href="<?php echo shop_url($shop_id, 'index'); ?>"><img
                            src="<?php echo $SHOP['shop_logo'] ? $SHOP['shop_logo'] : 'skin/default/images/shop_nologo.gif'; ?>"
                            width="198" height="98" onerror="this.src='skin/default/images/no_page.jpg'"/></a></h2>

                <h2 class="sName"><a
                        href="<?php echo shop_url($shop_id, 'index'); ?>"><?php echo $SHOP['shop_name']; ?></a></h2>
                ...
                <p><?php echo $s_langpackage->s_seller_c; ?>： <a href="<?php echo shop_url($shop_id, 'credit'); ?>"
                                                                 hideFocus=true> <img
                            style="margin-left:5px; vertical-align:text-bottom"
                            src="<?php echo $credit_row['int_img']; ?>"
                            title="<?php echo $credit['SUM(seller_credit)']; ?>"/> </a></p>

                <p><?php echo $s_langpackage->s_new_login; ?>：<span><?php echo $ranks['last_login_time']; ?></span></p>

                <p><?php echo $s_langpackage->s_creat_time; ?>：<span><?php echo $SHOP['shop_creat_time']; ?></span></p>

                <p><?php echo $s_langpackage->s_certification; ?>：<span><?php echo $rank_name['rank_name']; ?></span>
                </p>

                <p><a href="<?php echo shop_url($shop_id, 'index'); ?>"><img
                            src="skin/<?php echo $SYSINFO['templates']; ?>/images/gotoshop.gif" width="183" height="36"
                            alt="<?php echo $s_langpackage->s_seller_shop; ?>"/></a></p>

                <p><a class="favShop" href="javascript:;"
                      onclick="add_shopFavorite(<?php echo $shop_id; ?>)"><?php echo $s_langpackage->s_store_shop; ?></a>
                    <!--        <a class="setLatter" href="shop.php?shopid=<?php echo  $shop_id;?>&app=index#message"><?php echo $s_langpackage->s_send_mail;?></a>-->
                </p>
            </div>
        </div>
        <div id="itemDetail">
            <ul class="list_tab clearfix">
                <li id="tab_content1" class="now" onclick="show_tabs('1');"><a
                        href="javascript:;"><?php echo $s_langpackage->s_details; ?></a></li>
                <li id="tab_content2" onclick="show_tabs('2');"><a
                        href="javascript:;"><?php echo $s_langpackage->s_wholesale; ?></a></li>
                <li id="tab_content3" onclick="show_tabs('3');"><a href="javascript:;">商品评价</a></li>
                <li id="tab_content4" onclick="show_tabs('4');"><a href="javascript:;">成交记录</a></li>
...
=======
                    ...
                    if ($attr_status) {
                        foreach ($attr as $key => $value) {
                            ...
                            <?php if ($attribute[$key]['attr_values'] == '地图') { ?>
                                <img class="map"
                                     src="http://api.map.baidu.com/staticimage?width=230&height=150&center=<?php echo $value['attr_values']; ?>&markers=<?php echo $value['attr_values']; ?>&zoom=14&markerStyles=s,A,0xff0000">
                            <?php
                            }
                        }
                    }?>
...
=======
        ...
        <div id="goodTags">
            ...
            <div class="link_tags"> <?php foreach ($tag_list as $value) { ?>
                    <?php foreach ($value['tag_num'] as $v) { ?>
                        <?php if ($v['num'] != 1) { ?> <a href="<?php echo $value['url']; ?>"
                                                          style="color:<?php echo $value['tag_color']; ?>;<?php if ($value['is_blod']) { ?>font-weight:bold;<?php } ?>"><?php echo $value['tag_name']; ?>
                            (<?php echo $v['num']; ?>)</a> <?php } else { ?> <a href="<?php echo $value['url']; ?>"
                                                                                style="color:<?php echo $value['tag_color']; ?>;<?php if ($value['is_blod']) { ?>font-weight:bold;<?php } ?>"><?php echo $value['tag_name']; ?></a> <?php } ?>
                    <?php } ?>
                <?php } ?> </div>
            <div class="addTags">
                <form action="do.php?act=good_tag_add" method="post" onsubmit="return submitform();">
                    <input class="txt_tag" size="25" type="text" name="tag" id="tag" onblur="inputTxt(this,'set');"
                           onfocus="inputTxt(this,'clean');"
                           value="<?php echo $s_langpackage->s_enter_label; ?>"/> <?php if ($verifycode['4'] == 1) { ?>
                        <input type="text" class="txt_tag" name="veriCode" id="veriCode" style="width:100px"
                               maxlength="4"/> <img border="0" align="absmiddle" src="servtools/veriCodes.php"
                                                    id="verCodePic"><a href="javascript:;"
                                                                       onclick="return getVerCode();"><?php echo $i_langpackage->i_change_img; ?></a> <?php } ?>
                    <input class="btn_ser" type="submit" value="<?php echo $s_langpackage->s_add; ?>"/> <input
                        type="hidden" name="goods_id" value="<?php echo $goods_id; ?>"/> <input type="hidden"
                                                                                                name="tag_userid"
                                                                                                id="tag_userid"
                                                                                                value="<?php echo $USER['user_id']; ?>"/>
                </form>
            ...
            <ul class="list_125 clearfix">
                <?php if ($best_goods) {
                    foreach ($best_goods as $value) {
                        ?>
                        <li>
                            <p class="photo"><a href="<?php echo goods_url($value['goods_id']); ?>"><img
                                        src="<?php echo $value['is_set_image'] ? str_replace('thumb_', '', $value['goods_thumb']) : 'skin/default/images/nopic.gif'; ?>"
                                        width="112" height="112"
                                        onerror="this.src='skin/default/images/nopic.gif'"/></a></p>
                            <h4 class="summary"><a
                                    href="<?php echo goods_url($value['goods_id']); ?>"><?php echo sub_str($value['goods_name'], 20); ?></a>
                            </h4>
