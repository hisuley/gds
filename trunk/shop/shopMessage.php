...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_messageshow; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <?php if ($status == '1') { ?>
            <div id="stepTip">
                <ul class="list_step clearfix">
                    <li><?php echo $m_langpackage->m_u_first; ?>:<br/><?php echo $m_langpackage->m_a_info; ?></li>
                    <li><?php echo $m_langpackage->m_u_secound; ?>:<br/><?php echo $m_langpackage->m_a_shop_info; ?>
                    </li>
                    <li><?php echo $m_langpackage->m_u_third; ?>:<br/><?php echo $m_langpackage->m_a_manager_info; ?>
                    </li>
                    <li class="now" style="padding-right:0"><?php echo $m_langpackage->m_u_fore; ?>
            ...
            <div style="padding:20px;">
                ...
                <div class="message">&nbsp;&nbsp;<img
                        src="skin/default/images/right.gif"/><?php echo $m_langpackage->m_a_past_auccess; ?><a
                        href="do.php?act=refresh_shop"><font color="blue"><?php echo $m_langpackage->m_a_this; ?></font></a>
                </div>
                <div class="clear"></div>
            </div>
        <?php } else { ?>
            <?php if ($status == '2') { ?>
                <div style="padding:20px;">
                    <div class="message">&nbsp;&nbsp;<img
                            src="skin/default/images/prompt.gif"/><?php echo $m_langpackage->m_a_no_request; ?></div>
                    <div class="clear"></div>
                </div>
            <?php } else { ?>
                <div id="stepTip">
                    <ul class="list_step clearfix">
                        ...
                        <li class="now"><?php echo $m_langpackage->m_u_third; ?>
                            :<br/><?php echo $m_langpackage->m_a_manager_info; ?></li>
                ...
                <div style="padding:20px;">
                    ...
                    <div class="message">&nbsp;&nbsp;<img
                            src="skin/default/images/prompt.gif"/><?php echo $m_langpackage->m_a_commit_auccess; ?>
                    </div>
                    <div class="clear"></div>
                </div>
            <?php } ?>
