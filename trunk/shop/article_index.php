    ...
    <div id="contents" class="clearfix">
                    ...
                    <div class="content-news-list">
                        ...
                        <ul>
                            <?php foreach ($latestNews_result['result'] as $val) { ?>
                                <li>
                                    <a href="<?php echo article_url($val['article_id']); ?>"><font
        ...
        <div class="column-3">
            <div class="content-common-box content-left-middle-box content-siver">
                <div class="title"><h2><a href="news_list.php?id=20">节庆活动</a></h2><span><a href="news_list.php?id=20">更多&gt;&gt;</a></span>
                </div>
                <div class="content">
                    <ul>
        ...
        <div class="column-7">
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=12">桂林景点</a></h2><span><a href="news_list.php?id=12">更多&gt;&gt;</a></span>
                </div>
            ...
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=13">桂林酒店</a></h2><span><a href="news_list.php?id=13">更多&gt;&gt;</a></span>
                </div>
            ...
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=15">桂林美食</a></h2><span><a href="news_list.php?id=15">更多&gt;&gt;</a></span>
                </div>
            ...
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=19">夜美桂林</a></h2><span><a href="news_list.php?id=19">更多&gt;&gt;</a></span>
                </div>
            ...
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=17">桂林特产</a></h2><span><a href="news_list.php?id=17">更多&gt;&gt;</a></span>
                </div>
            ...
            <div class="content-common-box">
                <div class="title"><h2><a href="news_list.php?id=18">购在桂林</a></h2><span><a href="news_list.php?id=18">更多&gt;&gt;</a></span>
                </div>
                <?php foreach ($techan_result['result'] as $v) { ?>
                    <?php if ($v['thumb'] != '') { ?>
                        <div class="item-box" style="margin-left:0px;">
