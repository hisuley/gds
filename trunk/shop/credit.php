...
if (!$SHOP) {
    trigger_error($s_langpackage->s_no_this_goods);
}
//商铺分类
    ...
    <div id="contents" class="clearfix">
        ...
        <div id="rightCloumn">
            <div class="wrp_b mg12b">
                ...
                <table class="tab_credit " width="96%">
                    <tr>
                        <td style="background:#FFF3E8; text-align:right; border-right:0px; font-weight:bold;"
                            colspan="2"><?php echo $s_langpackage->s_seller_credit; ?>：<?php echo $seller_credit; ?>
                        <td style="text-align:left; background:#FFF3E8; border-right:0px;"><span
                                class="icon<?php echo $seller_integral['int_grade']; ?>" style="float:left;"></span>
                        </td>
                        </td>
                        <td style="background:#FFF3E8; text-align:right;"
                            colspan="3"><?php echo $s_langpackage->s_good_pro; ?>：<?php echo $seller_percentage; ?>%&nbsp;</td>
                    </tr>
                    <tr>
                        <th width="30"></th>
                        <th width="100"><?php echo $s_langpackage->s_week; ?></th>
                    ...
                    <tr>
                        <td><?php echo $s_langpackage->s_good; ?></td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,1,'<?php echo $LastWeek; ?>',1);"><?php echo $seller_credit_weed_2; ?></a>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,1,'<?php echo $LastMonth; ?>',1);"><?php echo $seller_credit_month_2; ?></a>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,1,'<?php echo $SexMonth; ?>',1);"><?php echo $seller_credit_sex_2; ?></a>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,1,'-1',1);"><?php echo $seller_credit_before_2; ?></a>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,1,'',1);"><?php echo $seller_credit_num_2; ?></a>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_centre; ?></td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,0,'<?php echo $LastWeek; ?>',1);"><?php echo $seller_credit_weed_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,0,'<?php echo $LastMonth; ?>',1);"><?php echo $seller_credit_month_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,0,'<?php echo $SexMonth; ?>',1);"><?php echo $seller_credit_sex_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,0,'-1',1);"><?php echo $seller_credit_before_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,0,'',1);"><?php echo $seller_credit_num_1; ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_diff; ?></td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,-1,'<?php echo $LastWeek; ?>',1);"><?php echo $seller_credit_weed_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,-1,'<?php echo $LastMonth; ?>',1);"><?php echo $seller_credit_month_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,-1,'<?php echo $SexMonth; ?>',1);"><?php echo $seller_credit_sex_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,-1,'-1',1);"><?php echo $seller_credit_before_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,-1,'',1);"><?php echo $seller_credit_num_0; ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_sum; ?></td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','<?php echo $LastWeek; ?>',1);"><?php echo $seller_credit_weed; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','<?php echo $LastMonth; ?>',1);"><?php echo $seller_credit_month; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','<?php echo $SexMonth; ?>',1);"><?php echo $seller_credit_sex; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','-1',1);"><?php echo $seller_credit_before; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','',1);"><?php echo $seller_credit_num; ?>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="wrp_b mg12b">
                ...
                <table class="tab_credit " width="96%">
                    <tr>
                        <td style="background:#FFF3E8; text-align:right; border-right:0px; font-weight:bold;"
                            colspan="2"><?php echo $s_langpackage->s_buyer_credit; ?>：<?php echo $buyer_credit; ?>
                        <td style="text-align:left; background: #FFF3E8; border-right:0px;"><span
                                class="icon<?php echo $buyer_integral['int_grade']; ?>" style="float:left;"></span></td>
                        </td>
                        <td style="background: #FFF3E8; text-align:right;"
                            colspan="3"><?php echo $s_langpackage->s_good_pro; ?>：<?php echo $buyer_percentage; ?>%&nbsp;</td>
                    </tr>
                    <tr>
                        <th width="30"></th>
                        <th width="100"><?php echo $s_langpackage->s_week; ?></th>
                    ...
                    <tr>
                        <td><?php echo $s_langpackage->s_good; ?></td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,1,'<?php echo $LastWeek; ?>',1);"><?php echo $buyer_credit_weed_2; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,1,'<?php echo $LastMonth; ?>',1);"><?php echo $buyer_credit_month_2; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,1,'<?php echo $SexMonth; ?>',1);"><?php echo $buyer_credit_sex_2; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,1,'-1',1);"><?php echo $buyer_credit_before_2; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,1,'',1);"><?php echo $buyer_credit_num_2; ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_centre; ?></td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,0,'<?php echo $LastWeek; ?>',1);"><?php echo $buyer_credit_weed_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,0,'<?php echo $LastMonth; ?>',1);"><?php echo $buyer_credit_month_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,0,'<?php echo $SexMonth; ?>',1);"><?php echo $buyer_credit_sex_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,0,'-1',1);"><?php echo $buyer_credit_before_1; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,0,'',1);"><?php echo $buyer_credit_num_1; ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_diff; ?></td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,-1,'<?php echo $LastWeek; ?>',1);"><?php echo $buyer_credit_weed_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,-1,'<?php echo $LastMonth; ?>',1);"><?php echo $buyer_credit_month_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,-1,'<?php echo $SexMonth; ?>',1);"><?php echo $buyer_credit_sex_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,-1,'-1',1);"><?php echo $buyer_credit_before_0; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,-1,'',1);"><?php echo $buyer_credit_num_0; ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $s_langpackage->s_sum; ?></td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','<?php echo $LastWeek; ?>',1);"><?php echo $buyer_credit_weed; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','<?php echo $LastMonth; ?>',1);"><?php echo $buyer_credit_month; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','<?php echo $SexMonth; ?>',1);"><?php echo $buyer_credit_sex; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','-1',1);"><?php echo $buyer_credit_before; ?>
                        </td>
                        <td>
                            <a href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','',1);"><?php echo $buyer_credit_num; ?>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <ul class="list_tab_02 clearfix">
                <li id="seller_selected" class="selected"><a
                        href="javascript:get_appraise('buyer',<?php echo $user_id; ?>,'','',1);"
                        hidefocus="true"><?php echo $s_langpackage->s_from_seller_credit; ?></a></li>
                <li id="buyer_selected" class=""><a
                        href="javascript:get_appraise('seller',<?php echo $user_id; ?>,'','',1);"
                        hidefocus="true"><?php echo $s_langpackage->s_from_buyer_credit; ?></a></li>
            </ul>
