...
=======
    ...
    <div class="top">
        <div class="top_left left"></div>
        <div class="top_center left">
            <span class="left"><a href="search.php"><?php echo $s_langpackage->s_want_buy; ?></a>|<a
                    href="modules.php?app=goods_add"><?php echo $s_langpackage->s_want_sell; ?></a>|<a
                    href="modules.php?app=shop_info"><?php echo $s_langpackage->s_want_mkstore; ?></a></span>
            <span class="right top_ico"><a
                    href="<?php echo article_list_url(2); ?>"><?php echo $s_langpackage->s_shop_help; ?></a><a
                    href="index.php"><?php echo $s_langpackage->s_back_index; ?></a></span>
        </div>
        <div class="top_right left"></div>
    </div>
    <!--top end -->
    <?php if ($SYSINFO['sys_logo']) { ?>
        <div class="logo left">
            <a href="index.php"><img
                    style="-moz-background-clip:border;-moz-background-inline-policy:continuous;-moz-background-origin:padding;display:block;height:43px;margin:8px 0 0 8px;overflow:hidden;text-indent:9999px;width:177px;"
                    src="<?php echo $SYSINFO['sys_logo']; ?>" onerror="this.src='skin/default/images/nopic.gif'"/>
            </a>
        </div>
    <?php } else { ?>
        <div class="logo left">
    ...
    <?php } ?>
    <div class="tool left">
        <div class="tool_right"><a href="modules.php?app=user_favorite"><?php echo $s_langpackage->s_favorite; ?></a>
        </div>
    </div>
    <div class="tool left">
        <div class="tool_right"><a href="modules.php?app=user_cart"><?php echo $s_langpackage->s_cart; ?></a></div>
    ...
    <?php } else { ?>
        <div class="tool left">
            <div class="tool_right"><a href="modules.php?app=reg"><?php echo $s_langpackage->s_register_free; ?></a>
            </div>
        </div>
        <div class="tool left">
            <div class="tool_right"><a href="login.php"><?php echo $s_langpackage->s_login; ?></a></div>
