   ...
   <?php  require("shop/index_header.php");?>
      <div class="content-common-box">
        ...
        <div class="content" style="height:70px;">
            <form class="pretty-form ticket-form">
              
              <div class="column-1">
                <div class="radio-group">
                  <input type="radio" name="round" value="single" id="singleRadio"/>
                  <label for="singleRadio">单程</label>
                </div>

                <div class="radio-group">
                  <input type="radio" name="round" value="single" id="doubleRadio"/>
              ...
              <div class="column-3">
                ...
                <div class="column-8">
                  <input class="column-10" type="text" name="start_city" value=""/>
                  <input class="column-10" type="text" name="start_city" value=""/>
                </div>
              </div>
