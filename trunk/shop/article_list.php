    ...
    <div id="contents" class="clearfix">
        ...
        <?php } else {
            ...
            <div id="pkz"> <?php echo $i_langpackage->i_location; ?>：<a
                    href="index.php"><?php echo $i_langpackage->i_index; ?></a> > <?php echo $cat_name; ?> </div>
            ...
            <div id="artContents" class=" clearfix">
                <ul class="artlist_ttlm">
                    <?php foreach ($article_cat as $val) { ?>
                        <li <?php if ($val['cat_id'] == $cat_id){ ?>class="now"<?php } ?>><a
                        ...
                        <?php if ($result['result']) { ?>
                            <?php foreach ($result['result'] as $val) { ?>
                                <li class="clearfix"><span class="right"><?php echo $val['add_time']; ?></span>
                                    <a href="<?php echo article_list_url($val['cat_id']); ?>">[<?php echo $cat_name; ?>
                                        ]</a>
