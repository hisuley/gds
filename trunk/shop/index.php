                            ...
                            foreach ($best_goods as $value) {
                                ...
                                <li>
                                    <div class="photo"><a target="_blank"
                                                          href="<?php echo goods_url($value['goods_id']); ?>">
                                            <img
                                    ...
                                    <div>
                                        <h4>
                                            <a href="<?php echo goods_url($value['goods_id']); ?>"><?php echo sub_str($value['goods_name'], 50, false); ?></a>
                                        </h4>
                                    </div>
                                    <div class="price">
                                        <span><?php echo $s_langpackage->s_money_sign; ?><?php echo $value['goods_price']; ?><?php echo $s_langpackage->s_yuan; ?></span>
                                        <span class="ship"><?php echo $s_langpackage->s_freight; ?>
                                            ：<?php echo $value['transport_template_price']; ?></span></div>
                                </li>
                            <?php } ?>
                        <?php } ?>
                    </ul>
                            ...
                            <li>
                                <p class="photo"><a href="<?php echo goods_url($value['goods_id']); ?>">
                                        <img
                                            ...
                                            width="112" height="112" alt="<?php echo $value['goods_name']; ?>"
                                            onerror="this.src='skin/default/images/nopic.gif'"/></a></p>
                                <h4>
                                    <a href="<?php echo goods_url($value['goods_id']); ?>"><?php echo sub_str($value['goods_name'], 30, false); ?></a>
                                </h4>
                ...
                <div class="guestInput">
                    <form action="do.php?act=shop_guestbook" name="guestForm" method="post" id="guestForm"
                        ...
                        <table id="sendbox" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="right" valign="top"><?php echo $s_langpackage->s_buyer_comm; ?>：</td>
                                <td><textarea class="border_c" cols="80" rows="8" name="content" id="textareac"
                                              onkeyup="this.value=this.value.slice(0,300);"></textarea></td>
                            </tr>
                            <?php if ($verifycode['3'] == 1) { ?>
                                <tr>
                                    <td></td>
                                    <td><input type="text" class="border_c" name="veriCode" id="veriCode"
                            ...
                            <tr>
                                <td></td>
                                <td><input class="btnSetmess" type="submit"
                                           value="<?php echo $s_langpackage->s_wantto_comm; ?>"/></td>
                            </tr>
                        </table>
                    </form>
                    <!--<p class="mg12b">
