                ...
                <ul class="clearfix">
                    <?php if ($result['result']) {
                        foreach ($result['result'] as $v) { ?>
                            <li>
                                <div class="photo"><a href="<?php echo goods_url($v['goods_id']); ?>"><img
                                ...
                                <div class="smmery">
                                    <h4><a class="pro_name" href="<?php echo goods_url($v['goods_id']); ?>"
                                           title="<?php echo $v['goods_name']; ?>"><?php echo sub_str($v['goods_name'], 22, false); ?></a>
                                    </h4>
                                </div>
                                <div class="price">
                                    <span><?php echo $s_langpackage->s_money_sign; ?><?php echo $v['goods_price']; ?><?php echo $s_langpackage->s_yan; ?></span>
                                    <span class="ship"><?php echo $s_langpackage->s_freight; ?>
                                        ：<?php echo $v['transport_template_price']; ?></span></div>
                            </li>
                        <?php } ?>
                    <?php } else {
