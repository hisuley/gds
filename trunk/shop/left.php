...
//引入语言包
    ...
    <div id="leftCloumn">
        <div class="shopInfo mg12b">
            <h2><p>
                    <img
                        ...
                        alt="<?php echo $SHOP['shop_name']; ?>"/></p></h2>
            <p><?php echo $s_langpackage->s_nickname; ?>：<span><a target="_blank" href=""
                                                                  title="<?php echo $ranks['user_name']; ?>"><?php echo $ranks['user_name']; ?></a></span>
            </p>
            <?php if ($im_enable == true) { ?>
                <p><?php echo $s_langpackage->s_contact_seller; ?>：
                <script src="imshow.php?u=<?php echo $SHOP['user_id']; ?>"></script></p><?php } ?>
            ...
            <p><?php echo $s_langpackage->s_seller_c; ?>：<a href="shop_rank.php" hideFocus=true>
                    <img style="margin-left:5px; vertical-align:text-bottom" src="<?php echo $credit_row['int_img']; ?>"
                         title="<?php echo $credit['SUM(seller_credit)']; ?>"/>
                </a></p>
            ...
            <p><?php echo $s_langpackage->s_approve_info; ?>：<span><a href="javascript:;"
                                                                      title="<?php echo $rank_name['rank_name']; ?>"
                                                                      class="shop_cert left"><?php echo $rank_name['rank_name']; ?></a></span>
            </p>

            <p><a class="favShop" onclick="add_shopFavorite(<?php echo $shop_id; ?>)"
                  href="javascript:;"><?php echo $s_langpackage->s_store_shop; ?></a>
        ...
        <div class="shopSearch bg_gary mg12b">
            <h3 class="ttlm_shopsec"><a class="highlight"
                                        href="ucategory.php?s=<?php echo $SHOP['shop_id']; ?>"><?php echo $s_langpackage->s_store_insearch; ?></a>
            </h3>
        ...
        <div class="itemsCate bg_gary">
            <h3 class="ttlm_itemsCate"><a
                    href="<?php echo shop_url($shop_id, 'products'); ?>"><?php echo $s_langpackage->s_goods_category; ?></a>
            </h3>
            <ul class="items">
                ...
                <?php
                    ...
                    foreach ($category_0 as $v) {
                        ...
                        <li class="unflod">
                            <h4>
                                <a href="<?php echo ucategory_url($v['shop_cat_id']); ?>"><?php echo $v['shop_cat_name']; ?></a>
                            </h4>
                            <?php
                            ...
                            if (!empty($category_sub)) {
                                ...
                                <ul class="per_items">
                                    <?php foreach ($category_sub as $value) { ?>
                                        <li><h4>
                                                <a href="<?php echo ucategory_url($value['shop_cat_id']); ?>"><?php echo $value['shop_cat_name']; ?></a>
                                            </h4></li>
                                    <?php } ?>
                                </ul>
                            <?php } ?>
