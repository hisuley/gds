...
<head>
    ...
    <style>
        .detail .pro_detail .pro_text ul li.operate a.inquiry {
            width: 89px;
            background: url(skin/<?php echo $SYSINFO['templates'];?>/images/inquiry.gif) 0 0 no-repeat;
            margin-left: 10px;
        }
...
<div id="pkz">
    ...
    <?php echo $i_langpackage->i_location; ?>：<a href="index.php"><?php echo $i_langpackage->i_index; ?></a> &gt; <a
        href="<?php echo shop_url($shop_id, 'index'); ?>"><?php echo $SHOP['shop_name']; ?></a>
    &gt; <?php echo $groupbuyinfo['group_name']; ?>
...
<div class="box">
    <div class="pro_pic" align="center">
        <img id="img1" alt=""
             src="<?php echo isset($gallery[0]['img_url']) ? $gallery[0]['img_url'] : "skin/default/images/nopic_big.gif"; ?>"
        ...
        <div id="thumbbox">
            <div class="long_box" id="list1_1">
                <?php foreach ($gallery as $val) { ?>
                    <a href="javascript:;" rev="<?php echo $val['img_url']; ?>"
                       rel="<?php echo $val['img_original']; ?>" onclick="javascript:return false;">
                        <img src="<?php echo $val['thumb_url']; ?>" onclick="changeImage(this)"
...
<?php if ($groupbuyinfo['recommended']) { ?>
    ...
    <li><span><?php echo $i_langpackage->i_all_num; ?>:</span><label
            id="all_num"><?php echo $groupbuyinfo['all_num']; ?></label></li>
            ...
            <?php if ($isset_groupbuy) { ?>
                ...
                <?php } else { ?>
                    <li><a href="javascript:exitGroupbuy(<?php echo $groupbuyinfo['group_id']; ?>);"
                           title="<?php echo $s_langpackage->s_groupbuy_del; ?>"
                           style=" background: url(skin/default/images/shop/btn_groundbuy.gif);display:block; width:80px; height:18px;text-align:center;padding-top:5px;"><?php echo $s_langpackage->s_groupbuy_del; ?></a>
                    </li>
                <?php } ?>
            <?php } else { ?>
                <li><span><?php echo $s_langpackage->s_groupbuy_buy_num; ?>:</span>
                    <input size="8" value="1" id='num'/>
                    (<?php echo $s_langpackage->s_required; ?>)
                </li>
                <li><span><?php echo $s_langpackage->s_groupbuy_real_name; ?>:</span>
                ...
                <li><a href="javascript:gotoGroupbuy(<?php echo $groupbuyinfo['group_id']; ?>);"
                       title="<?php echo $s_langpackage->s_groupbuy_add; ?>"
                       style=" background: url(skin/default/images/shop/btn_groundbuy.gif);display:block; width:80px; height:18px;text-align:center;padding-top:5px;"><?php echo $s_langpackage->s_groupbuy_add; ?></a>
                </li>
            <?php } ?>
        <?php } else if ($start_time > $now_time) { ?>
            <li><span><?php echo $s_langpackage->s_group_buy_state; ?>:</span>
...
<div class="shopInfo mg12b">
    <h2><a href="<?php echo shop_url($shop_id, 'index'); ?>" title=""><img
                src="<?php echo $SHOP['shop_logo'] ? $SHOP['shop_logo'] : 'skin/default/images/shop_nologo.gif'; ?>"
                width="198" height="98" alt=""/></a></h2>
    ...
    <p><?php echo $s_langpackage->s_seller_c; ?>：
        <a href="<?php echo shop_url($shop_id, 'credit'); ?>" hideFocus=true>
            <?php if ($credit['SUM(seller_credit)']) { ?>
                <img style="margin-left:5px; vertical-align:text-bottom"
                     src="skin/default/images/shop/rank_<?php echo $integral; ?>.gif"
                     title="<?php echo $credit['SUM(seller_credit)']; ?>" width="80" height="13"/>
            <?php } else { ?>
                0
            <?php } ?>
        </a>
    ...
    <p><span class="left"><?php echo $s_langpackage->s_certification; ?>：</span> <a href="javascript:;"
                                                                                    title="<?php echo $rank_name['rank_name']; ?>"
                                                                                    class="shop_cert left"><?php echo $rank_name['rank_name']; ?></a>
    </</p>
    <p><a class="go2shop" href="<?php echo shop_url($shop_id, 'index'); ?>" title=""><img
    ...
    <p>
        ...
        <a class="favShop" href="javascript:;"
           onclick="add_shopFavorite(<?php echo $shop_id; ?>)"><?php echo $s_langpackage->s_store_shop; ?></a>
        <a class="setLatter"
           href="goods.php?id=<?php echo $groupbuyinfo['group_id']; ?>&app=groupbuyinfo#message"><?php echo $s_langpackage->s_send_mail; ?></a>
    </p>
</div>
</div>
<div id="itemDetail">
    ...
    <ul class="list_tab clearfix">
        ...
        <li id="tab_content2" onclick="show_tabs('2');"><a
                href="javascript:;"><?php echo $s_langpackage->s_group_buy_introduction; ?></a></li>
    </ul>
    ...
    <div id="message" class="guestbook  bg_gradual mg12b">
        ...
        <div class="guestInput">
            <form action="do.php?act=shop_guestbook" name="guestForm" method="post" id="guestForm"
                ...
                <input maxlength="50" name="group_name" type="hidden"
                       value="<?php echo $groupbuyinfo['group_name']; ?>"/>
        ...
        <ul class="list_125 clearfix">
            <?php if ($best_goods) {
                foreach ($best_goods as $value) {
                    ?>
                    <li>
                        <p class="photo"><a target="_blank" href="<?php echo goods_url($value['goods_id']); ?>"><img
                                    src="<?php echo $value['is_set_image'] ? str_replace('thumb_', '', $value['goods_thumb']) : 'skin/default/images/nopic.gif'; ?>"
                                    alt="" height="112" width="112" onerror="this.src='skin/default/images/nopic.gif'"/></a>
                        </p>
                        <h4 class="summary"><a
                                href="<?php echo goods_url($value['goods_id']); ?>"><?php echo sub_str($value['goods_name'], 20, false); ?></a>
                        </h4>
