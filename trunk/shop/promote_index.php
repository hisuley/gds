            ...
            <div class="content-common-box content-left-big-box">
                ...
                <?php foreach ($goods_card as $v) { ?>
                    <div class="item-box" style="margin-left:0px;">
                        <div class="images">
                            <a href="<?php echo goods_url($v['goods_id']); ?>"><img
                                    src="<?php echo $v['goods_thumb']; ?>"/></a>
                        </div>
                        <div class="description">
                            <a href="<?php echo goods_url($v['goods_id']); ?>">
                                <h3><?php echo sub_str($v['goods_name'], 30); ?><span class="stars">✮</span></h3></a>
            ...
            <div class="content-common-box content-left-big-box">
                ...
                <?php  if ($result['result']) {
                    foreach ($result['result'] as $v) {
                        ...
                        <div class="item-box" style="margin-left:0px;">
                            <div class="images">
                                <a href="goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo"><img
                                        src="<?php echo $v['is_set_image'] ? $v['goods_thumb'] : 'skin/default/images/nopic.gif'; ?>"
                                        width="200" height="150" alt="<?php echo $v['goods_name']; ?>"
                                        onerror="this.src='skin/default/images/nopic.gif'"/></a>
                            </div>
                            <div class="description">
                                <a href="goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo">
                                    <h3><?php echo sub_str($v['goods_name'], 30); ?><span class="stars">✮</span></h3>
                                </a>
