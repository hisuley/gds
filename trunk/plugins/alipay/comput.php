...
// 获取订单信息
$orderinfo = get_order_info($dbo, $t_order_info, $t_order_goods, $t_goods, $t_shop_info, $order_id);
if (!$orderinfo) {
    exit("非法操作");
}
if (!$orderinfo['pay_status']) {
    throw_succes("1", "对方未付款！", "0");
}
// 获取支付配置信息
    ...
    <form action="comput.php?case=ok" method="post" name="myform">
        <table width="400" align="center">
            ...
            <tr>
                ...
                <td width="" class=title><?php echo $orderinfo['trade_no']; ?><input name="TxtTrade_no" type="hidden"
                                                                                     id="TxtTrade_no"
                                                                                     value="<?php echo $orderinfo['trade_no']; ?>"/>
                </td>
            </tr>
            <tr>
