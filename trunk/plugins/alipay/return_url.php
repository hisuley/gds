...
if ($verify_result) { //认证合格
    ...
    <table style="border:1px solid #ccc; width:770px; margin:20px auto;">
        <tr class="center">
            <th height="75" colspan="6" style="background:#fcfded; font-size:12px;"><h1
                    style="font-family: '黑体'; margin:auto; width:70%; height:53px; font-size:26px; background:url(../../skin/default/images/payok.gif) 0 0px no-repeat; line-height:53px;">
                    恭喜你，您此次的支付操作已成功</h1>
                <ul style="width:65%; text-align:left; margin:auto; ">
                    <li>· 点击<a style="color:#900" href="../../modules.php?app=user_my_order">我的订单</a>，进入会员中心查看您的订单信息
                    </li>
...
<?php
    ...
    <table style="border:1px solid #ccc; width:770px; margin:20px auto;">
        <tr class=center>
            <th height="75" colspan="6" style="background:#fcfded; font-size:12px;"><h1
                    style="font-family: '黑体'; margin:auto; width:70%; height:53px; font-size:26px; background:url(../../skin/default/images/payerror.gif) 0 0px no-repeat; line-height:53px;">
                    很抱歉，您此次的支付操作失败</h1>
                <ul style="width:65%; text-align:left; margin:auto; ">
                    <li>· 点击<a style="color:#900" href="../../modules.php?app=user_my_order">我的订单</a>，进入会员中心查看您的订单信息
                    </li>
                    <li>· 点击<a style="color:#900" href="../../modules.php?app=user_profile">个人信息</a>，进入会员中心查看或修改您的个人资料
                    </li>
                    </li>
                    <li>· 如有疑问，请致电客服：<?php echo $SYSINFO['sys_kftelphone']; ?></li>
                </ul>
