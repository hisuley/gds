...
<div id="wrapper">
    ...
    <div class="site_map">
        <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
            href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_page_first; ?>
    </div>
    <div class="clear"></div>
    <?php require("modules/left_menu.php"); ?>
    <div class="main_right">
        <div class="cont">
            <div class="index_top">
                ...
                <?php echo $m_langpackage->m_last_ip; ?>: <?php echo $user_info['last_ip']; ?>
                <br/>
                <?php echo $m_langpackage->m_you_have; ?> <font
                    color="#FF0000"><?php echo $remind_num; ?></font> <?php echo $m_langpackage->m_site_rem; ?>，<a
                    href="modules.php?app=user_remind_info"
                    class="highlight bold"><?php echo $m_langpackage->m_click_view; ?></a>
                <br/>

                <div class="q_nav">
                    <?php if (get_sess_shop_id() > 0) { ?>
                    <?php } else { ?>
                        <a id="qn_1" href="modules.php?app=shop_request"
                           title="<?php echo $m_langpackage->m_i_mk_store; ?>"><?php echo $m_langpackage->m_i_mk_store; ?></a>
                    <?php } ?>
                    <a id="qn_2" href="modules.php?app=shop_rate&t=buyer"
                       title="<?php echo $m_langpackage->m_buy_pingjia; ?>"><?php echo $m_langpackage->m_buy_pingjia; ?></a>
                    <a id="qn_3" href="modules.php?app=user_my_order"
                       title="<?php echo $m_langpackage->m_order_inquiry; ?>"><?php echo $m_langpackage->m_order_inquiry; ?></a>
                    <a id="qn_4" href="modules.php?app=user_favorite"
                       title="<?php echo $m_langpackage->m_my_favorite; ?>"><?php echo $m_langpackage->m_my_favorite; ?></a>
                    <a id="qn_5" href="modules.php?app=user_profile"
                       title="<?php echo $m_langpackage->m_base_setting; ?>"><?php echo $m_langpackage->m_base_setting; ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="index_tab">
            ...
            <div class="tab_box">
                <b><?php echo $m_langpackage->m_buy_prompt; ?></b>
                <hr/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_num_need_pay; ?></span> <?php echo $m_langpackage->m_pending_payment_order; ?>
                “<b><a href="modules.php?app=user_my_order&state=3"
                       class="highlight bold"><?php echo $m_langpackage->m_payment_orders_be; ?></a></b>”<?php echo $m_langpackage->m_in_payment; ?>
                <br/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_num_send; ?></span> <?php echo $m_langpackage->m_seller_shipped_orders; ?>“<b><a
                        href="modules.php?app=user_my_order&state=8"
                        class="highlight bold"><?php echo $m_langpackage->m_yes_no; ?></a></b>”
                <br/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_num; ?></span> <?php echo $m_langpackage->m_order_not_evaluated; ?>“<b><a
                        href="modules.php?app=user_my_order&state=9"
                        class="highlight bold"><?php echo $m_langpackage->m_yes_pingjia; ?></a></b>”<?php echo $m_langpackage->m_confirmed; ?>
                <br/>
        ...
        <div class="index_tab">
            ...
            <div class="tab_box">
                ...
                <hr/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_sale_no_pay; ?></span> <?php echo $m_langpackage->m_payment_no; ?><?php echo $m_langpackage->m_payment_no_to; ?>
                “<b><a href="modules.php?app=shop_my_order&state=1"
                       class="highlight bold"><?php echo $m_langpackage->m_payment_no; ?></a></b>”<?php echo $m_langpackage->m_confirmed; ?>
                <br/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_sale_no_huo; ?></span> <?php echo $m_langpackage->m_order_notransported_no; ?><?php echo $m_langpackage->m_payment_no_to; ?>
                “<b><a href="modules.php?app=shop_my_order&state=8"
                       class="highlight bold"><?php echo $m_langpackage->m_order_notransported_to; ?></a></b>”<?php echo $m_langpackage->m_confirmed; ?>
                <br/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_sale_no_ping; ?></span> <?php echo $m_langpackage->m_order_not_evaluated; ?>“<b><a
                        href="modules.php?app=shop_my_order&state=9"
                        class="highlight bold"><?php echo $m_langpackage->m_completed_orders; ?></a></b>”<?php echo $m_langpackage->m_confirmed; ?>
                <br/>
                <?php echo $m_langpackage->m_you_have; ?>
                <span><?php echo $order_sale_no_liu; ?></span> <?php echo $m_langpackage->m_unread_no; ?><?php echo $m_langpackage->m_payment_no_to; ?>
                “<b><a href="modules.php?app=shop_guestbook&state=1"
                       class="highlight bold"><?php echo $m_langpackage->m_unread_no; ?></a></b>”<?php echo $m_langpackage->m_unread_kan; ?>
                <br/>
