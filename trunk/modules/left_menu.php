...
=======
    ...
    */
    ...
    <div class="main_left">
        ...
        <!--点击回到个人中心首页-->
        <div class="menu">
            <div class="menu_title"><span class="put"><a href="javascript:;" hidefocus="true"
                                                         title="<?php echo $m_langpackage->m_programa; ?>"></a></span>
                <a class="menuicon" id="buyer" href="javascript:;"><?php echo $m_langpackage->m_buyer; ?></a></div>
            <div class="menu_li">
                <ul>
                    <li><a id="user_cart" onclick="menu_style_change('user_cart')"
                           href="modules.php?app=user_cart"><?php echo $m_langpackage->m_my_cart; ?></a></li>
                    <li><a id="user_my_order" onclick="menu_style_change('user_my_order')"
                           href="modules.php?app=user_my_order"><?php echo $m_langpackage->m_my_order; ?></a></li>
                    <li><a id="user_group" onclick="menu_style_change('user_group')"
                           href="modules.php?app=user_group"><?php echo $m_langpackage->m_my_groupbuy; ?></a></li>
                    <li><a id="user_favorite" onclick="menu_style_change('user_favorite')"
                           href="modules.php?app=user_favorite"><?php echo $m_langpackage->m_my_favorite; ?></a></li>
                    <li><a id="user_guestbook" onclick="menu_style_change('user_guestbook')"
                           href="modules.php?app=user_guestbook"><?php echo $m_langpackage->m_my_guestbook; ?></a></li>
                    <li><a id="user_address" onclick="menu_style_change('user_address')"
                           href="modules.php?app=user_address"><?php echo $m_langpackage->m_getgoods_address; ?></a>
                    </li>
                    <li><a id="user_account_add" onclick="menu_style_change('user_account_add')"
                           href="modules.php?app=user_account_add"><?php echo $m_langpackage->m_account_add; ?></a></li>
                    <li><a id="user_account_minus" onclick="menu_style_change('user_account_minus')"
                           href="modules.php?app=user_account_minus"><?php echo $m_langpackage->m_account_minus; ?></a>
                    </li>
                </ul>
            </div>
            <div class="menu_title"><span class="put"><a href="javascript:;" hidefocus="true"
                                                         title="<?php echo $m_langpackage->m_programa; ?>"></a></span>
                <a class="menuicon" id="seller" href="javascript:;"><?php echo $m_langpackage->m_seller; ?></a></div>
            <div class="menu_li">
                <ul>
                    <?php if (isset($user_privilege[1]) && $user_privilege[1] == 1) { ?>
                        <?php if ($shop_exist_flg == 1) { ?>
                            <?php if ($shop_pass_flg == 1) { ?>
                                <?php if ($shop_lock_flg == 0) { ?>
                                    <li style="position:relative">
                                        <a style="_margin-bottom:-18px" id="shop_info"
                                           onclick="menu_style_change('shop_info')" href="modules.php?app=shop_info">
                                            <?php echo $m_langpackage->m_shop_info; ?>
                                        </a>
								<span id="shop_flg" style="position:absolute;width:37px;right:20px;top:4px;_top:3px"> 
								<?php if ($shop_open_flg == 1) { ?>
                                    <label onclick="change_open_status('0')"
                                           style="color:red; cursor:pointer; font-weight:normal">
                                        <?php echo $m_langpackage->m_open; ?>
                                    </label>
                                <?php } else { ?>
                                    <label onclick="change_open_status('1')"
                                           style="color:red; cursor:pointer; font-weight:normal"><?php echo $m_langpackage->m_close; ?></label>
                                <?php } ?> </span></li>
                                    <li>
                                        <a href="<?php echo shop_url($shop_id); ?>"
                                           target="_blank"><?php echo $m_langpackage->m_shop_view; ?></a>
                                    </li>
                                    <!-- <li><a href="modules.php?app=shop_honor"><?php echo  $m_langpackage->m_shop_honor;?></a></li> -->
                                    <li>
                                        <a id="shop_category" onclick="menu_style_change('shop_category')"
                                           href="modules.php?app=shop_category"><?php echo $m_langpackage->m_shop_category; ?></a>
                                    </li>
                                    <li>
                                        <a id="goods_list" onclick="menu_style_change('goods_list')"
                                           href="modules.php?app=goods_list"><?php echo $m_langpackage->m_goods_list; ?></a>
                                    </li>
                                    <!-- <li><a id="goods_add" onclick="menu_style_change('goods_add')" href="modules.php?app=goods_add"><?php echo  $m_langpackage->m_add_newgoods;?></a></li> -->
                                    <li>
                                        <a id="groupbuy_list" onclick="menu_style_change('groupbuy_list')"
                                           href="modules.php?app=groupbuy_list">
                                            <?php echo $m_langpackage->m_groupbuy_list; ?></a>
                                    </li>
                                    <!--<li><a id="groupbuy_add" onclick="menu_style_change('groupbuy_add')" href="modules.php?app=groupbuy_add"><?php echo  $m_langpackage->m_add_groupbuy;?></a></li>-->
                                    <!--<li><a id="csv_export" onclick="menu_style_change('csv_export')" href="modules.php?app=csv_export"><?php echo  $m_langpackage->m_csv_export;?></a></li>
										<li><a id="csv_import" onclick="menu_style_change('csv_import')" href="modules.php?app=csv_import"><?php echo  $m_langpackage->m_csv_import;?></a></li>-->
                                    <li>
                                        <a id="shop_my_order" onclick="menu_style_change('shop_my_order')"
                                           href="modules.php?app=shop_my_order">
                                            <?php echo $m_langpackage->m_rc_order; ?>(<?php echo $get_order_num; ?>
                                            )<?php if ($get_order_num > 0) { ?>
                                                <img src="skin/<?php echo $SYSINFO['templates']; ?>/images/woo.gif"
                                                     width="21" height="12" /><?php } ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a id="shop_guestbook" style="_padding-top:5px;_margin-bottom:-5px"
                                           onclick="menu_style_change('shop_guestbook')"
                                           href="modules.php?app=shop_guestbook">
                                            <?php echo $m_langpackage->m_rc_guestbook; ?>
                                            (<?php echo $shop_guestbook_num; ?>)<?php if ($shop_guestbook_num > 0) { ?>
                                                <img src="skin/<?php echo $SYSINFO['templates']; ?>/images/woo.gif"
                                                     width="21" height="12" /><?php } ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a id="shop_askprice" onclick="menu_style_change('shop_askprice')"
                                           href="modules.php?app=shop_askprice">
                                            <?php echo $m_langpackage->m_rc_askprice; ?>
                                            (<?php echo $shop_inquiry_num; ?>)<?php if ($shop_inquiry_num > 0) { ?>
                                                <img src="skin/<?php echo $SYSINFO['templates']; ?>/images/woo.gif"
                                                     width="21" height="12"/>
                                            <?php } ?>
                                        </a>
                                    </li>
                                    <li><a id="shop_notice" onclick="menu_style_change('shop_notice')"
                                           href="modules.php?app=shop_notice"><?php echo $m_langpackage->m_shop_notice; ?></a>
                                    </li>
                                    <!-- <li><a href="modules.php?app=shop_news"><?php echo  $m_langpackage->m_shopnews_manage;?></a></li> -->
                                    <!-- <li><a href="modules.php?app=shop_news_add"><?php echo  $m_langpackage->m_add_shopnews;?></a></li> -->
                                    <li>
                                        <a id="shop_payment" onclick="menu_style_change('shop_payment')"
                                           href="modules.php?app=shop_payment">
                                            <?php echo $m_langpackage->m_payment_setting; ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a id="shop_receiv_list" onclick="menu_style_change('shop_receiv_list')"
                                           href="modules.php?app=shop_receiv_list">
                                            收款单
                                        </a>
                                    </li>
                                    <li>
                                        <a id="shop_shipping_list" onclick="menu_style_change('shop_shipping_list')"
                                           href="modules.php?app=shop_shipping_list">
                                            发货单
                                        </a>
                                    </li>
                                    <li>
                                        <a id="shop_refund_list" onclick="menu_style_change('shop_refund_list')"
                                           href="modules.php?app=shop_refund_list">
                                            退款单
                                        </a>
                                    </li>
                                <?php } else { ?>
                        ...
                        <?php } else { ?>
                            <?php if ($user_privilege[1] == 1) { ?>
                                <li><a id="shop_request" onclick="menu_style_change('shop_request')"
                                       href="modules.php?app=shop_request"
                                       style="color:#1E88C0"><?php echo $m_langpackage->m_reg_com_user; ?></a></li>
                            <?php } ?>
                        <?php } ?>
                    <?php } else { ?>
                        <?php if ($user_rank < 2) { ?>
            ...
            <div class="menu_title"><span class="put"><a href="javascript:;" hidefocus="true"
                                                         title="<?php echo $m_langpackage->m_programa; ?>"></a></span>
                <a class="menuicon" name="shoprate_manage" id="comment"
                   href="javascript:;"><?php echo $m_langpackage->m_shoprate_manage; ?></a></div>
            <div class="menu_li">
                <ul>
                    <li><a id="shop_rate_buyer" onclick="menu_style_change('shop_rate_buyer')"
                           href="modules.php?app=shop_rate&t=buyer"><?php echo $m_langpackage->m_shoprate_frombuyer; ?></a>
                    </li>
                    <li><a id="shop_rate_seller" onclick="menu_style_change('shop_rate_seller')"
                           href="modules.php?app=shop_rate&t=seller"><?php echo $m_langpackage->m_shoprate_fromseller; ?></a>
                    </li>
                    <li><a id="shop_rate_bymain" onclick="menu_style_change('shop_rate_bymain')"
                           href="modules.php?app=shop_rate&t=bymain"><?php echo $m_langpackage->m_shoprate_topep; ?></a>
                    </li>
                </ul>
            </div>
            <div class="menu_title"><span class="put"><a href="javascript:;" hidefocus="true"
                                                         title="<?php echo $m_langpackage->m_programa; ?>"></a></span>
                <a class="menuicon" name="base_setting" id="option"
                   href="javascript:;"><?php echo $m_langpackage->m_base_setting; ?></a></div>
            <div class="menu_li">
                <ul>
                    <li><a id="user_profile" onclick="menu_style_change('user_profile')"
                           href="modules.php?app=user_profile"><?php echo $m_langpackage->m_profile; ?></a></li>
                    <?php if ($my_shop_info_num > 0) { ?>
                        <li><a id="user_remind" onclick="menu_style_change('user_remind')"
                               href="modules.php?app=user_remind"><?php echo $m_langpackage->m_remind_setting; ?></a>
                        </li>
                        <li><a id="user_remind_info" onclick="menu_style_change('user_remind_info')"
                               href="modules.php?app=user_remind_info"><?php echo $m_langpackage->m_my_remind; ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($im_enable) { ?>
                        <li><a href="modules.php?app=user_ico"><?php echo $m_langpackage->m_userico_setting; ?></a></li>
                    <?php } ?>
                    <li><a id="user_passwd" onclick="menu_style_change('user_passwd')"
                           href="modules.php?app=user_passwd"><?php echo $m_langpackage->m_edit_password; ?></a></li>
                    <li><a href="do.php?act=logout"><?php echo $m_langpackage->m_logout; ?></a></li>
                </ul>
            </div>
            <div class="menu_title"><span class="put"><a href="javascript:;" hidefocus="true" title="我的订阅"></a></span>
                <a class="menuicon" name="my_rss" id="option" href="javascript:;">我的订阅</a></div>
            <div class="menu_li">
                <ul>
                    <li><a id="user_profile" onclick="menu_style_change('user_profile')"
                           href="modules.php?app=rss_list">订阅列表</a></li>
                    <?php if ($my_shop_info_num > 0) { ?>
                        <li><a id="user_remind" onclick="menu_style_change('user_remind')"
                               href="modules.php?app=user_remind"><?php echo $m_langpackage->m_remind_setting; ?></a>
                        </li>
            ...
            <!-- plugins !-->
            <div
                id="user_menu_buttun"> <?php echo isset($plugins['user_menu_buttun']) ? show_plugins($plugins['user_menu_buttun']) : ''; ?> </div>
            <!-- plugins !-->
