...
<div id="contents" class="clearfix"  >
	...
	<div class="pro_class"><?php echo  $m_langpackage->m_caution_app;?>
		<div class="find_pwd">
			<input class="btn_02" type="button" value="<?php echo  $m_langpackage->m_accomplish;?>" onclick="jump()" />
		</div>
	</div>
...
<div id="wrapper">
    ...
    <div id="contents" class="clearfix">
        ...
        <div class="pro_class"><?php echo $m_langpackage->m_caution_app; ?>
            <div class="find_pwd">
                <input class="btn_02" type="button" value="<?php echo $m_langpackage->m_accomplish; ?>"
                       onclick="jump()"/>
            </div>
        </div>
        <div class="top5 clear"></div>
