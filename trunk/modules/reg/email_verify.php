...
<div id="wrapper">
    ...
    <div id="contents" class="clearfix">
        ...
        <div class="regbox">
            <div class="reginbox">
                <h3><?php echo $m_langpackage->m_think_register; ?>
                    ，<?php echo $i_langpackage->i_email_complete_registration; ?></h3>

                <div style="min-height: 100px;">
                    <p><?php echo $m_langpackage->m_we; ?><span
                            style="color:red;"><?php echo $user_info['user_email']; ?></span><?php echo $m_langpackage->m_send_email; ?>
                    </p>
                ...
                <div class="rsend">
                    <h4><?php echo $m_langpackage->m_receive_email; ?></h4>
                    <ul>
                        <li><?php echo $m_langpackage->m_register_prompt; ?><a href="javascript:;"
                                                                               onclick="return showspan()"><?php echo $m_langpackage->m_register_prompt1; ?></a>
	                <span id="codespan" style="display: none"><input type="text" class="" name="veriCode" id="veriCode"
                                                                     style="width:100px" maxlength="4"/>
          	        <img height="30" src="servtools/veriCodes.php" align="absmiddle" id="verCodePic"
                         onclick="getVerCode(this)"><input type="button" value="确定"/></span></li>
                        <li><?php echo $m_langpackage->m_register_prompt2; ?><?php echo $user_info['user_email']; ?> (<a
                                href="modules.php?app=chanage_email&user_id=<?php echo $user_id; ?>"><?php echo $m_langpackage->m_register_prompt3; ?></a>)
                        </li>
                    </ul>
                </div>
            </div>
