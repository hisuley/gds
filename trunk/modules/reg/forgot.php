                ...
                <table class="tab_findpsw">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img style="margin-bottom:-16px; width:81px; height:41px;" align="absmiddle" border="0"
                                 src="servtools/veriCodes.php" id="verCodePic" onclick="getVerCode();">
                            <a href="#" onclick="getVerCode();">  <?php echo $m_langpackage->m_change_pic; ?> </a><SPAN
                                id="veriCode_message"></SPAN>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
                        <td><input class="btn_02" type="submit" value="<?php echo $m_langpackage->m_getback_pw; ?>"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
