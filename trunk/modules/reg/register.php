...
<div id="contents" class="clearfix">
    ...
    <form action="do.php?act=register" name="reg_form" method="post">
        <div id="login_leftColumn" class="w_395">
            ...
            <p class="mg12b">
                <input type="text" class="txt_230 ipt_nomal" name="user_email" autocomplete="off"
                       value="<?php echo $rmail; ?>"/><span id="user_email_message" class="hint"></span>
            </p>
            ...
            <p class="mg12b">
                <input type="text" class="txt_230 ipt_nomal" name="user_name" id="user_name" onblur="checkname();"
                       autocomplete="off" value="<?php echo $ruser; ?>"/><span id="user_name_message"
                                                                               class="hint"></span>
            </p>
            ...
            <p class="mg12b">
                <input class="txt_230 ipt_nomal" type="password" name="user_password" id="user_password"
                       autocomplete="off"/><span id="user_password_message" class="hint"></span>
            </p>
            ...
            <p class="mg12b">
                <input class="txt_230 ipt_nomal" type="password" name="user_repassword" id="user_repassword"/><span
                    id="user_repassword_message" class="hint"></span>
            </p>
            ...
            <div class="login_submit">
                <input class="btn_02" type="button" value="<?php echo $i_langpackage->i_register_now; ?>"
                       name="regcheckbtn" onclick="checkcode();"/>
            </div>
        </div>
    </form>
...
user_email.onmouseover = function () {
    user_email.className = 'txt_230 ipt_focus'
};
user_email.onmouseout = function () {
    user_email.className = 'txt_230 ipt_nomal'
};
...
user_password.onmouseover = function () {
    user_password.className = 'txt_230 ipt_focus'
};
user_password.onmouseout = function () {
    user_password.className = 'txt_230 ipt_nomal'
};
...
user_repassword.onmouseover = function () {
    user_repassword.className = 'txt_230 ipt_focus'
};
user_repassword.onmouseout = function () {
    user_repassword.className = 'txt_230 ipt_nomal'
};
