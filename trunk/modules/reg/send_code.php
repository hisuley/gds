...
<div id="wrapper">
    ...
    <div class="path"><?php echo $i_langpackage->i_location; ?>：<a
            href="index.php"><?php echo $i_langpackage->i_index; ?></a> > <?php echo $m_langpackage->m_getback_pw; ?>
    </div>
    <div class="pro_class">
        <div class="forgotleft">
            <form action="do.php?act=send_code" method="post" onsubmit="return checkform();">
                <div
                    style="font-size:14px; font-weight:bold;"><?php echo $i_langpackage->i_resend_verification; ?></div>
                <div><?php echo $m_langpackage->m_mail_register; ?>：<input type="text" name="user_email"/></div>
                <div style="text-align:right;"><input type="submit"
                                                      value="<?php echo $i_langpackage->i_resend_verification; ?>"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
            </form>
        </div>
        <div class="forgotright">
