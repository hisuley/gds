...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_error_messageshow; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <div style="padding:20px;">
            <div style="float:left; width:100px; height:100px;"><img src="skin/default/images/error.png" width="100"
                                                                     height="100"/></div>
