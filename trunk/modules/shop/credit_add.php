...
=======
        <div class="bigapart">
            <div class="title_uc"><h3><?php echo $m_langpackage->m_evaluate; ?></h3></div>
            <hr/>
            <form action="do.php?act=shop_credit_add&id=<?php echo $oid; ?>&t=<?php echo $t; ?>" name="form1"
                ...
                <table width="98%" class="form_table_02">
                    ...
                    <tr class="center">
                        <th class="hor"><?php echo $m_langpackage->m_goods_info; ?></th>
                        <td class=" textleft"><a href="goods.php?id=<?php echo $result['goods_id']; ?>" target="_blank"
                                                 style="color:#0044DD;"><?php echo $result['goods_name']; ?></a></td>
                    </tr>
