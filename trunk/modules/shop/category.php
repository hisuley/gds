...
<body onload="menu_style_change('shop_category');changeMenu();">
	...
	<div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_shop_category;?></div>
    <div class="clear"></div>
    	<?php  require("modules/left_menu.php");?>
        <div class="main_right">
           <div class="right_top"></div>
            <div class="cont">
                <div class="cont_title"><?php echo  $m_langpackage->m_shop_category;?><span class="tr_op"><a href="modules.php?app=shop_category_add" ><?php echo  $m_langpackage->m_shop_category_add;?></a></span>
			</div>
                <hr />
				<table width="100%" border="0" cellspacing="0">
					<tr class=""><th align="left"><?php echo  $m_langpackage->m_category_name;?></th>
					 <th width="60"></th>
					...
					<tr>
						...
						<span><a href="#?<?php echo  $v['shop_cat_id'];?>"><?php echo  $v['shop_cat_name'];?></a></span>
						 ...
						 <td class="center edit" id="unit_id_<?php echo  $v['shop_cat_id'];?>"><span onclick="edit_unit(this,<?php echo  $v['shop_cat_id'];?>)">&nbsp;&nbsp;</span></td>
					...
					<?php 
							...
							<tr>
								...
								<span><a href="#?<?php echo  $value['shop_cat_id'];?>"><?php echo  $value['shop_cat_name'];?></a></span>
								 ...
								 <td class="center edit" id="unit_id_<?php echo  $value['shop_cat_id'];?>"><span onclick="edit_unit(this,<?php echo  $value['shop_cat_id'];?>)">&nbsp;&nbsp;</span></td> 
...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_shop_category; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    <div class="right_top"></div>
    <div class="cont">
        <div class="cont_title"><?php echo $m_langpackage->m_shop_category; ?><span class="tr_op"><a
                    href="modules.php?app=shop_category_add"><?php echo $m_langpackage->m_shop_category_add; ?></a></span>
        </div>
        <hr/>
        <table width="100%" border="0" cellspacing="0">
            <tr class="">
                <th align="left"><?php echo $m_langpackage->m_category_name; ?></th>
                <th width="60"></th>
                <th width="40"><?php echo $m_langpackage->m_sort; ?></th>
                <th width="200"><?php echo $m_langpackage->m_manage; ?></th>
            </tr>
            <?php if (empty($category_list_new)) { ?>
                <tr class="center">
                    <td colspan="4"><?php echo $m_langpackage->m_nocat_addnow; ?></td>
                </tr>
            <?php
            } else {
                $category_0 = get_sub_category($category_list_new, 0);
                foreach ($category_0 as $v) {
                    ...
                    <tr>
                        <td><img src="skin/default/images/menu_minus.gif" style="margin-left:1em"/>
                            <span><a
                                    href="#?<?php echo $v['shop_cat_id']; ?>"><?php echo $v['shop_cat_name']; ?></a></span>
                        </td>
                        <td class="center edit" id="unit_id_<?php echo $v['shop_cat_id']; ?>"><span
                                onclick="edit_unit(this,<?php echo $v['shop_cat_id']; ?>)">&nbsp;&nbsp;</span></td>
                        <td class="center edit" id="cat_id_<?php echo $v['shop_cat_id']; ?>"><span
                                onclick="edit_sort(this,<?php echo $v['shop_cat_id']; ?>)">&nbsp;<?php echo $v['sort_order']; ?>
                                &nbsp;</span></td>
                        <td class="center"><a
                                href="modules.php?app=shop_category_add&id=<?php echo $v['shop_cat_id']; ?>"><?php echo $m_langpackage->m_add_subcategory; ?></a>
                            <a href="modules.php?app=shop_category_edit&id=<?php echo $v['shop_cat_id']; ?>"><?php echo $m_langpackage->m_edit; ?></a>
                            <a href="javascript:del_cat('<?php echo $v['shop_cat_id']; ?>')"><?php echo $m_langpackage->m_del; ?></a>
                        </td>
                    </tr>
                    <?php
                    $category_sub = get_sub_category($category_list_new, $v['shop_cat_id']);
                    if (!empty($category_sub)) {
                        foreach ($category_sub as $value) {
                            ...
                            <tr>
                                <td><img src="skin/default/images/menu_minus.gif" style="margin-left:2em"/>
                                    <span><a
                                            href="#?<?php echo $value['shop_cat_id']; ?>"><?php echo $value['shop_cat_name']; ?></a></span>
                                </td>
                                <td class="center edit" id="unit_id_<?php echo $value['shop_cat_id']; ?>"><span
                                        onclick="edit_unit(this,<?php echo $value['shop_cat_id']; ?>)">&nbsp;&nbsp;</span>
                                </td>
                                <td class="center edit" id="cat_id_<?php echo $value['shop_cat_id']; ?>"><span
                                        onclick="edit_sort(this,<?php echo $value['shop_cat_id']; ?>)">&nbsp;<?php echo $value['sort_order']; ?>
                                        &nbsp;</span></td>
                                <td class="center"><a
                                        href="modules.php?app=shop_category_edit&id=<?php echo $value['shop_cat_id']; ?>"><?php echo $m_langpackage->m_edit; ?></a>
                                    <a href="javascript:del_cat('<?php echo $value['shop_cat_id']; ?>')"><?php echo $m_langpackage->m_del; ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
            ...
            <?php } ?>
            <tr>
                <td colspan="4">&nbsp;&nbsp;<?php echo $m_langpackage->m_remark_edit; ?></td>
            </tr>
        </table>
    </div>
    <div class="clear"></div>
