...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_shop_info; ?>
</div>
<div class="clear"></div>
        ...
        <form action="do.php?act=shop_info" method="post" name="form_shop_info" onsubmit="return checkForm();"
            ...
            <table width="100%" style="border:0;" cellspacing="0">
                <?php if ($SYSINFO['sys_domain']) { ?>
                    <?php if ($flag) { ?>
                        <tr>
                            ...
                            <td><input type="text" name="shop_domain" value="<?php echo $shop_info['shop_domain']; ?>"
                                       style="width:250px;" maxlength="50"/></td>
                        </tr>
                    <?php } ?>
                <?php } ?>
                <tr>
                    <td class="textright" width="15%"><?php echo $m_langpackage->m_shop_name; ?>:</td>
                    <td><input type="text" name="shop_name" value="<?php echo $shop_info['shop_name']; ?>"
                               style="width:250px;" maxlength="50"/>
                        <span class="red">*</span></td>
                </tr>
                <tr>
                    <td class="textright" width="15%"><?php echo $m_langpackage->m_shop_categories; ?>:</td>
                    <td style="float:none;">
								...
								<select name="categories_parent" onchange="categorieschanged(this.value)">
                                    ...
                                    <?php foreach ($shop_categories_parent as $v) { ?>
                                        <option value="<?php echo $v['cat_id']; ?>"
                                            <?php if ($v['cat_id'] == $categories_parent) {
                                                echo 'selected';
								...
								<select name="country" onchange="areachanged(this.value,0);">
                                    ...
                                    <?php foreach ($areas_info[0] as $v) { ?>
                                        <option value="<?php echo $v['area_id']; ?>"
                                            <?php if ($v['area_id'] == $shop_info['shop_country']) {
                                                echo 'selected';
                ...
                <tr>
                    ...
                    <td><input type="text" name="shop_management" value="<?php echo $shop_info['shop_management']; ?>"
                ...
                <tr>
                    ...
                    <td><input type="text" name="shop_address" value="<?php echo $shop_info['shop_address']; ?>"
                               style="width:250px;" maxlength="200"/> <span class="red">*</span>
                        <?php if ($SYSINFO['map'] == 'true') { ?>
                            &nbsp;【<a onclick="discontrol('map_canvas',this)"
                                      href="#"><?php echo $m_langpackage->m_open_map; ?></a>】
                            <div id="map_canvas" style="width:600px; height:400px;"></div>
                        <?php } ?>
                    </td>
                </tr>
                <tr style="line-height:18px;">
                    <td class="textright"><?php echo $m_langpackage->m_shop_intro; ?>:</td>
                    <td>
                        <textarea name="shop_intro" id="shopintro" cols="65"
                                  rows="10"><?php echo $shop_info['shop_intro']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_select_template; ?>:</td>
                        ...
                        <?php foreach ($shoptemplate_arr as $v) { ?>
                            <span><img src="<?php echo $v['imgurl']; ?>" width="95" alt="<?php echo $v['tplname']; ?>"
                                       ...
                                       onerror="this.src='skin/default/images/nopic.gif'"/><br/><input type="radio"
                                                                                                       name="shop_template"
                                                                                                       value="<?php echo $v['tpltag']; ?>" <?php if ($shop_info['shop_template'] == $v['tpltag']) { ?> checked<?php } ?> /> <?php echo $v['tplname']; ?></span>
                        <?php } ?>
                    </td>
                </tr>

                <tr style="display:none;">
                    <td class="textright"><?php echo $m_langpackage->m_shop_introimg; ?>:</td>
                    <td><input type="file" name="attach_images[]"/> <?php  if ($shop_info['shop_images']) {
                            echo "<img src='" . $shop_info['shop_images'] . "' height='80' onerror=\"javascript:this.src='skin/default/images/no_page.jpg'\"/>";?><?php
                        }?> <?php echo $m_langpackage->m_shop_introimg_msg; ?></td>
                </tr>

                <tr>
                    <td class="textright" style="white-space:nowrap"><?php echo $m_langpackage->m_shop_logoimg; ?>:</td>
                    <td><input type="file" name="attach_logo[]"/> <?php  if ($shop_info['shop_logo']) {
                            echo "<img src='" . $shop_info['shop_logo'] . "' height='80' onerror=\"javascript:this.src='skin/default/images/no_page.jpg'\"/>";?><?php
                        }?> <?php echo $m_langpackage->m_shop_logoimg_msg; ?></td>
                </tr>
                <tr>
                    <td class="textright" style="white-space:nowrap"><?php echo $m_langpackage->m_shop_bannerimg; ?>:
                    </td>
                    <td><input type="file" name="attach_template[]"/> <?php  if ($shop_info['shop_template_img']) {
                            echo "<img src='" . $shop_info['shop_template_img'] . "' height='80' onerror=\"javascript:this.src='skin/default/images/no_page.jpg'\"/>";?><?php
                        }?> <?php echo $m_langpackage->m_shop_bannerimg_msg; ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/>
                        <input class="submit" type="submit" name="submit"
                               value="<?php echo $m_langpackage->m_edit_shop; ?>"/></td>
                </tr>
