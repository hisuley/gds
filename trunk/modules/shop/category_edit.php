...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_edit_ucategory; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        <div class="title_uc"><h3><span class="tr_op"><a
                        href="modules.php?app=shop_category"><?php echo $m_langpackage->m_s_category; ?></a>&nbsp;&nbsp;</span><?php echo $m_langpackage->m_edit_ucategory; ?>
            </h3>
            <hr/>
        </div>
        <form action="do.php?act=shop_category_edit" method="post" name="shop_category_edit"
            ...
            <table width="100%" border="0" cellspacing="0">
                        ...
                        <select name="parent_id">
                            ...
                            <?php  if (!empty($category_list_new) && $shop_category_info['parent_id'] > 0) {
                                ...
                                foreach ($category_0 as $v) {
                                    ?>
                                    <option
                                        value='<?php echo $v['shop_cat_id']; ?>' <?php if ($v['shop_cat_id'] == $shop_category_info['parent_id']) echo 'selected'; ?>><?php echo $v['shop_cat_name']; ?></option>
                                <?php } ?>
                            <?php } ?>
                        </select>
                    </td>
                ...
                <tr>
                    <td colspan="2" class="center"><input type="hidden" name="shop_cat_id"
                                                          value="<?php echo $id; ?>"/><input type="hidden"
                                                                                             name="shop_id"
                                                                                             value="<?php echo $shop_id; ?>"/><input
                            type="submit" name="submit" value="<?php echo $m_langpackage->m_edit_ucategory; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
