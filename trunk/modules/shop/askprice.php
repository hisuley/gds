...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_rc_askprice; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
        ...
        <form action="do.php?act=shop_askprice_del" name="form" method="post" onsubmit="return submitform();">
            <table class="form_table">
                <tr class="center">
                    ...
                    <th><?php echo $m_langpackage->m_name; ?></th>
                    <th><?php echo $m_langpackage->m_askprice_content; ?></th>
                    ...
                    foreach ($result['result'] as $v) {
                        ...
                        <tr class="trcolor">
                            ...
                            <td align="center">
                                <a href="do.php?act=shop_askprice_del&id=
								<?php echo $v['iid']; ?>"
                                   onclick="return confirm('<?php echo $m_langpackage->m_suredel_askprice; ?>');">
                                    <?php echo $m_langpackage->m_del; ?>
                                </a><br/>
                                <a href="modules.php?app=shop_askprice_r&id=<?php echo $v['iid']; ?>"><?php echo $m_langpackage->m_view; ?></a>
                            </td>
