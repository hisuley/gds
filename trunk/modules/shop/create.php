...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_create_shop; ?>
</div>
<div class="clear"></div>
<div class="apart">
        ...
        <div id="stepTip">
            <ul class="list_step clearfix">
                ...
                <li class="now"><?php echo $m_langpackage->m_u_secound; ?>
                    :<br/><?php echo $m_langpackage->m_a_shop_info; ?></li>
        ...
        <form action="do.php?act=shop_create" method="post" name="form_shop_create" onsubmit="return checkForm();">
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr style="line-height:18px;">
                    ...
                    <td>
                        <textarea name="shop_intro" id="shop_intro" cols="75"
                                  rows="5"><?php echo $shop_info['shop_intro']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><input type="submit" name="submit"
                                                          value="<?php echo $m_langpackage->m_create_shop; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
