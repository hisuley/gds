 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/shop/receiv_export.html
 * 如果您的模型要进行修改，请修改 models/modules/shop/receiv_export.php
 *
...
if(filemtime("templates/default/modules/shop/receiv_export.html") > filemtime(__file__) || (file_exists("models/modules/shop/receiv_export.php") && filemtime("models/modules/shop/receiv_export.php") > filemtime(__file__)) ) {
    tpl_engine("default", "modules/shop/receiv_export.html", 1);
    include(__file__);
} else {
/* debug模式运行生成代码 结束 */
<<<<<<< HEAD
...
<body onload="menu_style_change('shop_receiv_list');changeMenu();">
	...
	<div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;收款单导出
	</div>
    <div class="clear"></div>
    <div class="apart">
        ...
        <div class="main_right">
            ...
            <div class="cont">
                <div class="cont_title">收款单导出</div>
                <hr />
			<form action="do.php?act=shop_receiv_export" method="post" id="cvsform" name='cvsform' onsubmit="return checkform(this)">
				<input type="hidden" name="shop_id" value="<?php echo $shop_id;?>" />
					<table width="100%" style="border:0" cellspacing="0">
						...
						<tr><td></td>
							<td colspan="2">
								<input class="submit" type="submit" name="submit" value="收款单导出" />
							</td>
						</tr>
					</table>
			</form>
...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;收款单导出
</div>
<div class="clear"></div>
<div class="apart">
    <?php require("modules/left_menu.php"); ?>
    <div class="main_right">
        ...
        <div class="cont">
            <div class="cont_title">收款单导出</div>
            <hr/>
            <form action="do.php?act=shop_receiv_export" method="post" id="cvsform" name='cvsform'
                  onsubmit="return checkform(this)">
                <input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/>
                <table width="100%" style="border:0" cellspacing="0">
                    <tr>
                        <td width="120" align="right"><?php echo $m_langpackage->m_csv_name; ?>:</td>
                        <td width="180"><input type="text" name="filename" value=""/></td>
                        <td><?php echo $m_langpackage->m_no_csv_name; ?></td>
                    </tr>
                    <tr>
                        <td align="right"><?php echo $m_langpackage->m_export_code; ?>:</td>
                        <td align="left" colspan="2">
