...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;退款单
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <div class="search">
            <form action="modules.php" method="get" name="search_form" style="float:left;">
                ...
                <p>操作日期：<input class="Wdate" type="text" name="start_time" id="start_time"
                               onFocus="WdatePicker({isShowClear:false,readOnly:true})"
                               value="<?php echo $start_time; ?>"/>~
                    <input class="Wdate" type="text" name="end_time" id="end_time"
                           onFocus="WdatePicker({isShowClear:false,readOnly:true})" value="<?php echo $end_time; ?>"/>
                    <input type="hidden" value="shop_refund_list" name="app"/>
                    <input type="submit" name="submit" value="搜索"/></p>
            </form>
        </div>
        ...
        <table width="100%" class="">
            ...
            <?php } else { ?>
                <tr>
                    <td colspan="6" class="center">没有退款单！</td>
                </tr>
            <?php } ?>
        </table>
    </div>
