...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_shop_category_add; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        <div class="title_uc"><h3><span class="tr_op"><a
                        href="modules.php?app=shop_category"><?php echo $m_langpackage->m_shop_category; ?></a>&nbsp;&nbsp;</span><?php echo $m_langpackage->m_shop_category_add; ?>
            </h3>
            <hr/>
        </div>
        <form action="do.php?act=shop_category_add" method="post" name="shop_category_add"
              onsubmit="return checkForm();">
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    <td class="textright" width="100px;"><?php echo $m_langpackage->m_category_name; ?>:</td>
                    <td><input type="text" name="shop_cat_name"
                               value="<?php echo $shop_category_info['shop_cat_name']; ?>" style="width:250px;"
                        ...
                        <select name="parent_id">
                            ...
                            <?php  if (!empty($category_list_new)) {
                                ...
                                foreach ($category_0 as $v) {
                                    ?>
                                    <option
                                        value='<?php echo $v['shop_cat_id']; ?>' <?php if ($v['shop_cat_id'] == $shop_category_info['parent_id']) { ?> selected<?php } ?>><?php echo $v['shop_cat_name']; ?></option>
                                <?php
                                }
                            }?>
                        </select>
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_sort; ?>:</td>
                    <td><input type="text" name="sort_order" value="<?php echo $shop_category_info['sort_order']; ?>"
                               style="width:70px;" maxlength="2"/></td>
                </tr>
                <tr>
                    <td colspan="2" class="center"><input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/><input
                            type="submit" name="submit" value="<?php echo $m_langpackage->m_shop_category_add; ?>"/>
                    </td>
                </tr>
            </table>
        </form>
