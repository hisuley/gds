...
<div class="site_map"> <?php echo $m_langpackage->m_current_position; ?><A
        ...
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;商铺退款
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=shop_protect_rights&id=<?php echo $order_id; ?>" method="post"
            ...
            <table class="form_table_02">
                ...
                <tr>
                    <td colspan="2">
                        <div id="display_order" class="tab_box">
                            <textarea type="text" id="protect_content" name="protect_content" cols="73"
                                      rows="15"></textarea>
                            ...
                            <div id="fsUploadProgress"></div>
                            <div id="divStatus"></div>
                            <div><span id="spanButtonPlaceHolder"></span> <input id="btnCancel" type="button" value="取消"
                                                                                 onclick="swfu.cancelQueue();"
                                                                                 disabled="disabled"
                                                                                 style="display:none"/></div>
                            <span>按ctrl键选择多个文件</span></div>
                    </td>
                </tr>
                <tr>
                    <th>是否同意:</th>
