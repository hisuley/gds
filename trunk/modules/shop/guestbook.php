...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_rc_guestbook; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
                ...
                if (!empty($result['result'])) {
                    foreach ($result['result'] as $v) {
                        ...
                        <?php if ($v['group_id']) { ?>
                            <tr class="center">
                                <td><input type="checkbox" name="guest[]" value="<?php echo $v['gid']; ?>"/></td>
                                <td class="center">[<?php echo $m_langpackage->m_group_buy; ?>:<a
                                        href="goods.php?id=<?php echo $v['goods_id']; ?>&app=groupbuyinfo&groupid=<?php echo $v['group_id']; ?>"><?php echo $v['group_name']; ?></a>]<br/><?php echo $v['name']; ?>
                                </td>
                                <td class="center"><?php echo substr($v['add_time'], 0, 16); ?></td>
                                <td class="center"><?php echo sub_str($v['reply'], 15); ?></td>
                                <td class="center">
                    ...
                    <tr>
                        <td colspan="6"><INPUT class="submit" type="submit"
                                               value="<?php echo $m_langpackage->m_pl_del; ?>" name="deletesubmit"/>
                        </td>
                    </tr>
                <?php } else { ?>
                    <tr>
