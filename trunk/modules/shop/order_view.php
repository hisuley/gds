...
<div class="site_map"> <?php echo $m_langpackage->m_current_position; ?><A
        ...
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_order_info; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        <div class="title_uc">
            <h3><span class="tr_op"><a
                        href="modules.php?app=shop_my_order"><?php echo $m_langpackage->m_recver_order; ?></a>&nbsp;&nbsp;</span><?php echo $m_langpackage->m_order_info; ?>
            </h3>
            <hr/>
        </div>
        <div id="reg_step">
            <ol>
                ...
                <?php } elseif ($info['pay_status'] == 1) { ?>
                    ...
                    <li class=""><span>5、<?php echo $m_langpackage->m_com_deal; ?></span></li>
                <?php } else { ?>
                    <li class="current"><strong class="first">1、<?php echo $m_langpackage->m_buy_mk_order; ?></strong>
                    </li>
                    <li class=""><span>2、<?php echo $m_langpackage->m_buyer_pay; ?></span></li>
                    <li class=""><span>3、<?php echo $m_langpackage->m_check_put_goods; ?></span></li>
                    <li class=""><span>4、<?php echo $m_langpackage->m_buyer_checkget_goods; ?></span></li>
        ...
        <table width="100%" border="0" cellspacing="0">
            ...
            <?php $num = count($info['order_goods']);
            foreach ($info['order_goods'] as $k => $v) { ?>
                <tr>
                    <td><a href="goods.php?id=<?php echo $v['goods_id']; ?>"
                           target="_blank"><?php echo $v['goods_name']; ?></a></td>
                    ...
                    <?php if ($k == 0) { ?>
                        <td class="border_l " style="text-align:center;"
                            rowspan="<?php echo $num; ?>"><?php echo $info['transport_price']; ?><?php echo $m_langpackage->m_yuan; ?></td>
                    <?php } ?> </tr>
            <?php } ?>
            <tr>
                <td class="border_l" colspan="4">&nbsp;&nbsp;<?php echo $m_langpackage->m_order_thisbuyprice; ?>
                    :<span><?php echo $info['order_value']; ?></span><?php echo $m_langpackage->m_yuan; ?>
                    <?php if ($info['order_status'] == 1 && $info['pay_status'] == 0) { ?>
                        <form action="do.php?act=shop_order_priceedit" method="post" onsubmit="return checkForm();">
                            &nbsp;&nbsp;<?php echo $m_langpackage->m_order_editprice; ?><input id="price" name="price"
                                                                                               value="<?php echo $info['order_value']; ?>"
                                                                                               style="width:70px;"/>
                            <input type="hidden" name="order_id" value="<?php echo $order_id; ?>"/> <input type="submit"
                                                                                                           name="btn"
                                                                                                           value="<?php echo $m_langpackage->m_order_editprice; ?>"/>
                        </form>
                    <?php } ?> </td>
            </tr>
        </table>
        ...
        <table class="form_table_02" width="100%" border="0" cellspacing="0">
            ...
            <tr>
                ...
                <td> <?php echo $info['mobile']; ?> , <?php echo $info['telphone']; ?>
                    , <?php echo $areas[$info['province']]; ?> <?php echo $areas[$info['city']]; ?> <?php echo $areas[$info['district']]; ?>
                    , <?php echo $info['address']; ?> , <?php echo $info['zipcode']; ?></td>
            </tr>
            <tr>
        ...
        <table class="form_table_02" width="100%" border="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><span class="tr_op">
					<?php if ($info['order_status'] == 1 && $info['pay_status'] == 0) { ?>
                        <a href="do.php?act=shop_order_del&id=<?php echo $info['order_id']; ?>"
                    ...
                    <?php } ?>
                        <?php if ($info['transport_status'] == 0 && $info['order_status'] == 1 && $info['pay_status'] == 1) { ?>
                            <?php if ($payment_info[$info['pay_id']]['pay_code'] == 'alipay') { ?>
                                <a href="plugins/alipay/comput.php?id=<?php echo $info['order_id']; ?>"
                                   target="_blank"><?php echo $m_langpackage->m_sure_shippingnow; ?></a>
                            <?php } else { ?>
                                <a href="modules.php?app=shop_delivery_add&order_id=<?php echo $info['order_id']; ?>"
                        ...
                        <?php if ($info['protect_status'] == 1 || $info['protect_status'] == 2) { ?>
                            <a href="modules.php?app=shop_protect_rights&id=<?php echo $info['order_id']; ?>"><font
                                    color='red'>查看维权</font></a>
                        <?php } ?>
                        <a href="modules.php?app=shop_order_view&order_id=<?php echo $info['order_id']; ?>"
