        ...
        <form action="do.php?act=shop_payment_update" method="post" name="form_shop_pay" onsubmit="return checkForm();">
            <table width="100%" class="form_table">
                <tr>
                    ...
                    <th class="textleft"><?php echo $payment['pay_name']; ?><input type="hidden" name="pay_id"
                                                                                   value="<?php echo $payment['pay_id']; ?>"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_payment_desc; ?>：</td>
                    <td class="textleft"><textarea name="pay_desc" rows="5"
                                                   cols="40"><?php echo strip_tags($payment['pay_desc']); ?></textarea>
                        <span class="red">*</span><?php echo $m_langpackage->m_payment_showuser_pay; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_payment_enable; ?>：</td>
                    <td class="textleft"><input type="radio" name="enabled" value="1"
                                                checked><?php echo $m_langpackage->m_yes; ?> <input type="radio"
                                                                                                    name="enabled"
                                                                                                    value="0"><?php echo $m_langpackage->m_no; ?>
                    </td>
                </tr>
                <?php foreach ($config_arr as $k => $v) { ?>
                    <tr>
                        ...
                        <td class="textleft">
                            ...
                            <?php } else { ?>
                                <input type="text" name="pay_config[<?php echo $k; ?>]" value="" maxlength="40"
                                       style="width:200px;"/>
                            <?php } ?>
                        </td>
                    </tr>
                ...
                <tr>
                    <td colspan="2" class="center"><input type="submit"
                                                          value="<?php echo $m_langpackage->m_payment_install; ?>"/>
                    </td>
                </tr>
            </table>
        </form>
