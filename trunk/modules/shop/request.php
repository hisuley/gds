...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_hiserver_member; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <div id="stepTip">
            <ul class="list_step clearfix">
                <li class="now"><?php echo $m_langpackage->m_u_first; ?>:<br/><?php echo $m_langpackage->m_a_info; ?>
                </li>
                <li><?php echo $m_langpackage->m_u_secound; ?>:<br/><?php echo $m_langpackage->m_a_shop_info; ?></li>
                <li><?php echo $m_langpackage->m_u_third; ?>:<br/><?php echo $m_langpackage->m_a_manager_info; ?></li>
                <li style="padding-right:0"><?php echo $m_langpackage->m_u_fore; ?>
                    :<br/><?php echo $m_langpackage->m_accomplish; ?></li>
            </ul>
        </div>
        <hr/>
        <form action="do.php?act=shop_request" method="post" name="form_shop_request" onsubmit="return check_form(this)"
              enctype="multipart/form-data">
            <table width="100%" border="0" cellspacing="0">

                <?php if ($request_info['status'] == '1') { ?>
                    <tr>
                        <td align="center"><?php echo $m_langpackage->m_hiserver_member_suc; ?></td>
                    </tr>
                <?php } else { ?>
                    <?php if ($request_info['status'] == '2') { ?>
                        <tr>
                            <td align="center" colspan="2"><font
                                    color="red"><B><?php echo $m_langpackage->m_hiserver_member_fail; ?></B></font></td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td class="textright" width="40%"><?php echo $m_langpackage->m_request_compayname; ?>：</td>
                        <td><input type="text" name="company_name" value="<?php echo $request_info['company_name']; ?>"
                                   style="width:200px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_personname; ?>：</td>
                        <td><input type="text" name="person_name" value="<?php echo $request_info['person_name']; ?>"
                                   style="width:100px"/> <input type="hidden" name="request_id"
                                                                value="<?php echo $request_info['request_id']; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_criedtype; ?>：</td>
                        <td>
                            <select name="credit_type">
                                <option
                                    value="<?php echo $m_langpackage->m_request_sfz; ?>"><?php echo $m_langpackage->m_request_sfz; ?></option>
                                <option
                                    value="<?php echo $m_langpackage->m_request_jgz; ?>"><?php echo $m_langpackage->m_request_jgz; ?></option>
                                <option
                                    value="<?php echo $m_langpackage->m_request_operatenum; ?>"><?php echo $m_langpackage->m_request_jgz; ?></option>
                            </select> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_criednum; ?>：</td>
                        <td><input type="text" name="credit_num" value="<?php echo $request_info['credit_num']; ?>"
                                   maxlength="200" style="width:200px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_paper_upload; ?>：</td>
                        <td><input type="file" name="attach[]"/> <span
                                class="red">*</span><?php echo $m_langpackage->m_request_supporttype; ?>（jpg,gif,png）
                        </td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_comaddress; ?>：</td>
                        <td><input type="text" name="company_area" maxlength="200" style="width:200px"
                                   value="<?php echo $request_info['company_area']; ?>"/></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_moraddress; ?>：</td>
                        <td><input type="text" name="company_address"
                                   value="<?php echo $request_info['company_address']; ?>" maxlength="200"
                                   style="width:300px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_zip; ?>：</td>
                        <td><input type="text" name="zipcode" value="<?php echo $request_info['zipcode']; ?>"
                                   maxlength="10" style="width:100px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_mobile; ?>：</td>
                        <td><input type="text" name="mobile" value="<?php echo $request_info['mobile']; ?>"
                                   maxlength="20" style="width:200px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_request_phone; ?>：</td>
                        <td><input type="text" name="telphone" value="<?php echo $request_info['telphone']; ?>"
                                   maxlength="20" style="width:200px"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><input type="hidden" name="user_id"
                                                              value="<?php echo $user_id; ?>"/>
                            <input type="submit" name="submit" value="<?php echo $m_langpackage->m_post_app; ?>"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center"><?php echo $m_langpackage->m_request_suc_correctnum; ?></td>
                    </tr>
                <?php } ?>
            </table>
        </form>
