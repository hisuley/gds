...
<body>
<div class="header"><?php  require("shop/index_header.php");?></div>
<div class="main">
	<div class="left_menu">
	...
	<div class="bigpart">
		...
		<table width="98%" class="form_table">
			...
			<div id="honor_<?php echo  $value['honor_id'];?>">
				...
				<br />
				<a href="<?php echo  $value['honor_original'];?>" target="_blank" class="imga"><img src="<?php echo  $value['honor_thumb'];?>" class="img" onerror="this.src='skin/default/images/nopic.gif'"/></a>
...
<div class="main">
    ...
    <div class="bigpart">
        <div class="title_uc"><h3><?php echo $m_langpackage->m_shop_honor; ?></h3></div>
        <form action="do.php?act=shop_honor_update" method="post" name="form_shop_honor_update"
                    ...
                    <td class="center">
                        <?php  if (!empty($honor_list)) {
                            foreach ($honor_list as $value) {
                                ...
                                <div id="honor_<?php echo $value['honor_id']; ?>">
                                    <a href="javascript:;"
                                       onclick="if (confirm('<?php echo $m_langpackage->m_suredel_honor; ?>')) dropImg('<?php echo $value['honor_id']; ?>')">[<?php echo $m_langpackage->m_del; ?>
                                        ]</a>
                                    <br/>
                                    <a href="<?php echo $value['honor_original']; ?>" target="_blank" class="imga"><img
                                            src="<?php echo $value['honor_thumb']; ?>" class="img"
                                            onerror="this.src='skin/default/images/nopic.gif'"/></a>
                                    <input type="text" value="<?php echo $value['honor_desc']; ?>" size="15"
                                           name="old_img_desc[<?php echo $value['honor_id']; ?>]" maxlength="50"/>
                                </div>
                            <?php }
                        } else { ?>
                            echo "<?php echo $m_langpackage->m_not_uploadimg; ?>";
                    ...
                    <td id="upload_img">
                        <span><a href="javascript:addNewUploadSpan();">[+]</a> <?php echo $m_langpackage->m_img_desc; ?>
                            ：<input type="text" name="img_desc[]"
                                    maxlength="50"/> <?php echo $m_langpackage->m_upload_file; ?>：<input type="file"
                                                                                                         name="attach[]"/></span>
                    </td>
                </tr>
                <tr>
                    <td class="center"><input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/>
                        <input type="submit" name="submit" value="<?php echo $m_langpackage->m_update_image; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
