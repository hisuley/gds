...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;发货单
</div>
<div class="clear"></div>
    ...
    <div class="cont">
        ...
        <div class="search">
            <form action="modules.php" method="get" name="search_form" style="float:left;">
                ...
                <p>发货时间：<input class="Wdate" type="text" name="start_time" id="start_time"
        ...
        <table width="100%" class="">
            ...
            if (!empty($result['result'])) {
                ...
                <?php } ?>
                <tr>
                    <td colspan="7" class="page"><?php require("modules/page.php"); ?></td>
                </tr>
            <?php } else { ?>
                <tr>
                    <td colspan="7" class="center">没有收货单！</td>
                </tr>
            <?php } ?>
        </table>
    </div>
