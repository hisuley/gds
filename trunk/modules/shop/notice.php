...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_shop_notice; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <form action="do.php?act=shop_notice" method="post" name="shop_notice_form" onsubmit="return checkForm();">
            <table width="100%" style="border:0">
                <tr>
                    <td style="width:90px; text-align:center; vertical-align:top; font-weight:bold"><?php echo $m_langpackage->m_shop_notice; ?>
                        :
                    </td>
                    <td>
                        <textarea name="shop_notice" id="shopnotice" cols="65"
                                  rows="15"><?php echo $shop_info['shop_notice']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/>
                        <input class="submit" type="submit" name="submit" style="font-weight:normal"
                               value="<?php echo $m_langpackage->m_edit_shopnotice; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
