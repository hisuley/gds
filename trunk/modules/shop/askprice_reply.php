 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/shop/askprice_reply.html
 * 如果您的模型要进行修改，请修改 models/modules/shop/askprice_reply.php
 *
...
if(filemtime("templates/default/modules/shop/askprice_reply.html") > filemtime(__file__) || (file_exists("models/modules/shop/askprice_reply.php") && filemtime("models/modules/shop/askprice_reply.php") > filemtime(__file__)) ) {
    tpl_engine("default", "modules/shop/askprice_reply.html", 1);
    include(__file__);
} else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_addseller_write_back; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=shop_reply_add&id=<?php echo $gid; ?>" name="form1" method="post"
            ...
            <table width="100%" style="border:0" cellspacing="0">
                ...
                <tr class="center">
                    ...
                    <td class="textleft"><?php echo $result['mobile']; ?></td>
                </tr>
                <tr class="center">
                    <td class="textright"><?php echo $m_langpackage->m_telphone; ?>:</td>
                    <td class="textleft"><?php echo $result['telphone']; ?></td>
                </tr>
                <tr class="center">
