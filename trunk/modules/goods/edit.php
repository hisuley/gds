...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_edit_goods; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=goods_edit" method="post" name="form_goods_edit" onsubmit="return checkForm();"
              enctype="multipart/form-data">
            <table width="100%" style="border:0" cellspacing="0">
                <tr>
                    <td width="100" class="textright"><?php echo $m_langpackage->m_goods_category; ?>：</td>
                    <td align="left">&nbsp;<span id="show_cat_name"><?php echo $select_category_name; ?></span> &nbsp;&nbsp;<a
                            href="javascript:;" onclick="showbgdiv();"
                            style="color:#F1A24C; font-weight:bold;text-decoration:underline;"><?php echo $m_langpackage->m_edit_cateogry; ?></a>
                ...
                <tr>
                    ...
                    <td align="left"><input type="radio" name="type_id" value="1"
                                            <?php if ($goods_info['type_id'] == '1'){ ?>checked<?php } ?> /><?php echo $m_langpackage->m_goods_new; ?>
                        &nbsp;&nbsp;
                        <input type="radio" name="type_id" value="2"
                               <?php if ($goods_info['type_id'] == '2'){ ?>checked<?php } ?> /><?php echo $m_langpackage->m_goods_notnew; ?>
                        &nbsp;&nbsp;
                        <input type="radio" name="type_id" value="3"
                               <?php if ($goods_info['type_id'] == '3'){ ?>checked<?php } ?> /><?php echo $m_langpackage->m_goods_isnull; ?> </span>
                    </td>
                </tr>
                <tr id="goods_attr_tr">
                ...
                <tr>
                    ...
                    <td align="left"><input type="text" name="goods_name"
                                            value="<?php echo $goods_info['goods_name']; ?>" style="width:395px;"
                                            maxlength="200"/> <span class="red">*</span></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_shop_category; ?>：</td>
                    <td align="left"><select name="ucat_id">
                        ...
                        <span id="ucate_add"><a href="javascript:;"
                                                onclick="showinput();"><?php echo $m_langpackage->m_add_cat; ?></a></span>
                        <span id="ucate_span" style="display:none;"><input type="text" value=""
                                                                           style="width:115px; margin-right:10px"
                                                                           id="ucat_input"/><input class="submit"
                                                                                                   type="button"
                                                                                                   value="<?php echo $m_langpackage->m_add; ?>"
                                                                                                   onclick="addnewucat();"/></span>
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_goods_price; ?>：</td>
                    <td align="left"><input type="type" name="goods_price" id="goods_price"
                                            value="<?php echo $goods_info['goods_price']; ?>" style="width:80px;
							text-align:right;" maxlength="8"/> <?php echo $m_langpackage->m_yuan; ?>
                        (<?php echo $m_langpackage->m_goods_pricezero; ?>)
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stort_type; ?>：</td>
                    <td class="">
                        <input type="radio" value="1" id="is_transport_template"
                               onclick="chostransporttype(1)" <?php if ($goods_info['is_transport_template']) { ?> checked  <?php } ?>
                               name="is_transport_template"/> <?php echo $m_langpackage->m_is_transport_template; ?>
                        &nbsp;&nbsp;
                        <input type="radio" onclick="chostransporttype(0)"
                               value="0" <?php if (!$goods_info['is_transport_template']) { ?> checked  <?php } ?>
                               name="is_transport_template"/><?php echo $m_langpackage->m_transport_price; ?>
                    </td>
                </tr>
            ...
            <?php } else{ ?>
                    ...
                    <td align="left">
                        <?php if (is_array($transport_template_list)) { ?>
                            <?php foreach ($transport_template_list as $value) { ?>
                                <input type="radio" name="transport_template_id"
                                       value="<?php echo $value['id']; ?>" <?php if ($goods_info['transport_template_id'] == $value['id']) { ?> checked <?php } ?> /><?php echo $value['transport_name']; ?>&nbsp;
                                <a href="modules.php?app=edit_transport_template&id=<?php echo $value['id']; ?>"
                                   target="_blank"><?php echo $m_langpackage->m_eidt_transport_template; ?></a><br/>
                            <?php } ?>
                        <?php } ?>
                        <br/>
                        <a href="modules.php?app=add_transport_template"
                           target="_blank"><?php echo $m_langpackage->m_add_transport_template; ?></a>
                    </td>
                </tr>
                <?php if (!$goods_info['is_transport_template']){ ?>
                ...
                <tr id="transport2" style="display:none;">
                    ...
                    <td align="left"><input type="type" name="transport_price" id="transport_price"
                                            value="<?php echo $goods_info['transport_price']; ?>"
                                            style="width:80px; text-align:right;"
                                            maxlength="8"/> <?php echo $m_langpackage->m_yuan; ?></td>
                </tr>
                <tr>
                    <td class="textright"><span id="picspan"><?php if ($goods_info['goods_thumb']) { ?><img
                                src="<?php echo $goods_info['goods_thumb']; ?>"
                                onerror="this.src='skin/default/images/nopic.gif'"/><?php } else { ?><?php echo $m_langpackage->m_showgoods_photo; ?><?php } ?></span>
                    </td>
                    <td align="left"><input type="file" name="attach[]" onchange="showimg(this)"/>
                        <!-- <input type="button" value="使用已上传图片" onclick="get_img_list('img_select1','1','img_list1',this)"> <span class="red">*</span> -->
                        <br/>
                        <?php echo $m_langpackage->m_goods_picinfo; ?><?php echo $SYSINFO['height2']; ?></
                    >x<?php echo $SYSINFO['width2']; ?><?php echo $m_langpackage->m_px; ?>
                ...
                <tr>
                    <td valign="top" class="textright"><?php echo $m_langpackage->m_goods_intro; ?>：</td>
                    <td style=" line-height:18px">
                        <div class="index_tab">
                            <ul>
                                <li><a id="style1"
                                       style="font-size:12px;color:#333;font-weight:normal; text-decoration:none"
                                       class="current" href="javascript:;"
                                       onclick="change_style('style1')"><?php echo $m_langpackage->m_goods_intro; ?></a>
                                </li>
                                <li><a id="style2"
                                       style="font-size:12px;color:#333;font-weight:normal; text-decoration:none"
                                       href="javascript:;"
                                       onclick="change_style('style2');get_img_list('img_select3','2','img_list3',this)"><?php echo $m_langpackage->m_user_upload_pic; ?></a>
                                </li>
                            </ul>
                        </div>
                        <div id="display_order" class="tab_box">
                            <textarea name="goods_intro" id="goods_intro" cols="65"
                                      rows="15"><?php echo $goods_info['goods_intro']; ?></textarea>
                                ...
                                <div id="img_list2" class="imgPan">
                                    <ul id="introimage" class="clearfix">
                                        <?php foreach ($result['result'] as $v) { ?>
                                            <li>
                                                <p class="photo"><img src="<?php echo $v['img_url']; ?>" width="100"
                                                                      height="100"
                                                                      onerror="this.src='skin/default/images/nopic.gif'"/>
                                                </p>

                                                <p><a href='javascript:;' onclick='return addIntroImg(this)'>插入</a><a
                                                        href='javascript:;' name='<?php echo $v["id"]; ?>'
                                                        onclick='return delIntroImg(this)'>删除</a></p>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            ...
                            <div>
                                ...
                                <input id="btnCancel" type="button" value="取消" onclick="swfu.cancelQueue();"
                                       disabled="disabled" style="display:none"/>
                                <input type="hidden" id="image_size_id" name="image_size_id"
                                       value="<?php echo $imagelistid; ?>"/>
                            </div>
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_wholesale; ?>：</td>
                    <td align="left">
                        <textarea name="goods_wholesale" cols="45"
                                  rows="3"><?php echo $goods_info['goods_wholesale']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_goods_number; ?>：</td>
                    <td align="left"><input type="type" name="goods_number" id="goods_number"
                                            value="<?php echo $goods_info['goods_number']; ?>"
                                            style="width:80px; text-align:right;"
                                            maxlength="5"/> <?php echo $m_langpackage->m_jian; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_keyword; ?>：</td>
                    <td align="left"><input type="type" name="keyword" value="<?php echo $goods_info['keyword']; ?>"
                                            style="width:250px;"
                                            maxlength="200"/> <?php echo $m_langpackage->m_more_keyword_exp; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_on_sale; ?>：</td>
                    <td align="left"><input type="checkbox" name="is_on_sale"
                                            value="1" <?php if ($goods_info['is_on_sale']) {
                            echo "checked";
                        } ?>/> <?php echo $m_langpackage->m_view_status; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_add_recommend; ?>：</td>
                    <td align="left"><input type="checkbox" name="is_best" value="1" <?php if ($goods_info['is_best']) {
                            echo "checked";
                        } ?> />
                        <?php echo $m_langpackage->m_best; ?>&nbsp;
                        <input type="checkbox" name="is_promote" value="1" <?php if ($goods_info['is_promote']) {
                            echo "checked";
                        } ?> />
                        <?php echo $m_langpackage->m_promote; ?>&nbsp;
                        <input type="checkbox" name="is_new" value="1" <?php if ($goods_info['is_new']) {
                            echo "checked";
                        } ?> />
                        <?php echo $m_langpackage->m_new; ?>&nbsp;
                        <input type="checkbox" name="is_hot" value="1" <?php if ($goods_info['is_hot']) {
                            echo "checked";
                        } ?> />
                        <?php echo $m_langpackage->m_hot; ?>&nbsp;
                        <?php echo $m_langpackage->m_set_num; ?><?php echo $user_privilege['4']; ?><?php echo $m_langpackage->m_best; ?>
                        ，<?php echo $user_privilege['5']; ?><?php echo $m_langpackage->m_promote; ?>
                        ，<?php echo $user_privilege['6']; ?><?php echo $m_langpackage->m_new; ?>
                        ，<?php echo $user_privilege['7']; ?><?php echo $m_langpackage->m_hot; ?>
                        ，<?php echo $m_langpackage->m_num_much; ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="center"><input type="hidden" name="goods_id"
                                                          value="<?php echo $goods_info['goods_id']; ?>"/>
                        <input class="submit" type="submit" name="submit"
                               value="<?php echo $m_langpackage->m_edit_goods; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
...
<div id="category_select" style="display:none;">
    ...
    <ul id="select_first" class="ulselect">
        <?php foreach ($category_info as $k => $v) { ?>
            <?php if ($v['parent_id'] == 0) { ?>
                <li title="<?php echo $v['cat_id']; ?>" <?php if ($test1 == $v['cat_id']) {
                    echo "class='select'";
    ...
    <div class="category_com"><input type="button" value="<?php echo $m_langpackage->m_post; ?>"
                                     onclick="postcatid();"/></div>
    <?php } else { ?>
    <span onclick="hidebgdiv();"><?php echo $m_langpackage->m_close; ?></span>
    <?php echo $m_langpackage->m_plss_select_cateogry; ?></div>
	...
	foreach($goods_attr as $v) {
		...
		if(substr($v['attr_values'],'-1') == '|') {
			$v['attr_values'] = substr($v['attr_values'],'0','-1');
                ...
                $v['price'] = preg_replace("/[\r\n]+/",'|',$v['price']);
		if(substr($v['price'],'-1') == '|') {
			$v['price'] = substr($v['price'],'0','-1');
		}
		echo "goodsAttr['".$v['attr_id']."'] = '".$v['attr_values']."'; \r\n";
                echo "goodsAttr_price['".$v['attr_id']."'] = '".$v['price']."'; \r\n";
	}
}?>
...
function formatFormElement(id, type, name, value, price) {
    var optionValue;
    var cValue = cPrice = str = '';
    if (goodsAttr[id]) {
        cValue = goodsAttr[id];
        cPrice = goodsAttr_price[id];
    }
    if (type == 0) {
        str = '<input type="text" name="attr[' + id + ']" value="' + cValue + '" maxlength="200" />';
        if (price == 1) {
            price0 = name;
            str += '<input type="text" name="price[' + id + ']" value="' + price + '" onfocus="focusPrice(this)" onblur="blurPrice(this)" style="width:70px;" />';
        }
        ...
        var attrValue = cValue.split("|");
        var attrPrice = cPrice.split("|");
        if (regv) {
        ...
        if (price == 1) {
            if (attrPrice != '') {
                price3 = value;
                for (var j = 0; j < attrPrice.length; j++) {
                    if (attrPrice[j] != undefined && attrValue[j] != undefined) {
                        str += "<input type='checkbox' name='attr[" + id + "][]' value=" + attrValue[j] + " checked />" + attrValue[j] + "<input type='text' name='price[" + id + "][]' value=" + attrPrice[j] + " onfocus='focusPrice(this)' onblur='blurPrice(this)' style='width:70px;' />";
                    }
                }
            } else {
                var str = value.replace(re, "<input type='checkbox' name='attr[" + id + "][]' value='$1' checked$3 />$1<input type='text' name='price[" + id + "][]' value='请输入价格' onfocus='focusPrice(this)' onblur='blurPrice(this)' style='width:70px;' />");
            }
            //var str = value.replace(re,"<input type='checkbox' name='attr[" + id + "][]' value='$1' checked$3 />$1<input type='text' name='price["+id+"][]' value='请输入价格' onfocus='focusPrice(this)' onblur='blurPrice(this)' style='width:70px;' />");
        } else {
