...
<div class="container">
    ...
    <div class="site_map">
        <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
            href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_csv_import; ?>
    </div>
    <div class="clear"></div>
    <?php require("modules/left_menu.php"); ?>
    <div class="main_right">
        ...
        <div class="cont">
            <div class="cont_title"><?php echo $m_langpackage->m_csv_import; ?></div>
            <hr/>
            <form action="do.php?act=csv_import" method="post" id="cvsform" name='cvsform'
                  onsubmit="return checkform(this)" enctype="multipart/form-data">
                <input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>"/>
                <table width="100%" style="border:0" cellspacing="0">
                    <tr>
                        <td align="right" width="120px;"><?php echo $m_langpackage->m_no_csv_import; ?></td>
                    ...
                    <tr>
                        ...
                        <td align="left"><input class="submit" type="submit" name="submit"
                                                value="<?php echo $m_langpackage->m_csv_import; ?>"/></td>
                    </tr>
                </table>
            </form>
        </div>
