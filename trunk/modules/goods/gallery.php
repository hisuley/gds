...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_goods_image; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=goods_gallery_update" method="post" name="form_goods_gallery_update"
            ...
            <table style="border:0" width="100%">
                        ...
                        <?php  if (!empty($gallery_list)) {
                            foreach ($gallery_list as $value) {
                                ...
                                <div id="gallery_<?php echo $value['img_id']; ?>">
                                    <a href="javascript:;"
                                       onclick="if (confirm('<?php echo $m_langpackage->m_sure_delimg; ?>'))
                                           dropImg('<?php echo $value['img_id']; ?>')">[<?php echo $m_langpackage->m_del; ?>
                                        ]</a>
                                    <?php  if ($value['is_set']) {
                                    ...
                                    <?php } ?><br/>
                                    <input type="hidden" name="imgid_<?php echo $value['img_id']; ?>"
                                           value="<?php echo $value['img_id']; ?>"/>
                                    <a href="<?php echo $value['img_original']; ?>" target="_blank" class="imga">
                                        <img src="<?php echo $value['thumb_url']; ?>" class="img"
                ...
                <tr>
                    <td class="textleft">
                        <a href="javascript:addNewUploadSpan();"
                           style=" text-decoration:none">[+]</a> <?php echo $m_langpackage->m_img_desc; ?>:
                        <input type="text" name="img_desc[]"
                               maxlength="50"/> <?php echo $m_langpackage->m_upload_file; ?>:
                ...
                <tfoot>
                <tr>
                    <td class="left"><input type="hidden" name="goods_id" value="<?php echo $goods_id; ?>"/>
                        <input class="submit" type="submit" name="submit"
                               value="<?php echo $m_langpackage->m_update_goodsimg; ?>"/></td>
                </tr>
                </tfoot>
            </table>
        </form>
