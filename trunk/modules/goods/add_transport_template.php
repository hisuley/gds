...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_add_transport_template; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=add_transport_template" method="post" name="form_transport_template"
              onsubmit="return checkForm(this);">
            <table id="boxtable" width="100%" style="border:0" cellspacing="0">
                <tr>
                    <td width="100" align="right"><?php echo $m_langpackage->m_transport_name; ?>:</td>
                    <td width="150"><input type="text" name="transport_name" value="" maxlength="30"/></td>
                    <td align="left"><?php echo $m_langpackage->m_transport_name_message; ?></td>
                </tr>
                <tr>
                    <td align="right"><?php echo $m_langpackage->m_transport_description; ?>:</td>
                    <td><input type="text" name="description" value="" maxlength="50"/></td>
                    <td><?php echo $m_langpackage->m_transport_description_message; ?></td>
                </tr>
                <tr>
                ...
                <?php if (is_array($arr_list)) { ?>
                    <?php foreach ($arr_list as $k => $value) { ?>
                        <tr>
                            <td></td>
                            <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="transport_type[]"
                ...
                <tr>
                    <td></td>
                    <td colspan="2"><input class="submit" type="submit" name="sub"
