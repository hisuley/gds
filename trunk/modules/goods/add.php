...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_add_newgoods; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=goods_add" method="post" name="form_goods_add" onsubmit="return checkForm();"
              enctype="multipart/form-data">
            <table width="100%" style="border:0" cellspacing="0">
                <tr>
                    <td class="textright" width="130"><?php echo $m_langpackage->m_goods_category; ?>:</td>
                    <td>&nbsp;<span id="show_cat_name"><?php echo $m_langpackage->m_pls_select_cateogry; ?></span>
                        &nbsp;&nbsp;<a href="javascript:;" onclick="showbgdiv();"
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_goods_name; ?>：</td>
                    <td><input type="text" name="goods_name" value="<?php echo $goods_info['goods_name']; ?>"
                               style="width:395px;" maxlength="200"/> <span class="red">*</span></td>
                </tr>
                <tr>
                    ...
                    <td><select name="ucat_id" id="ucat_id">
                        ...
                        <span class="red">*</span> <span id="ucate_add"><a href="javascript:;"
                                                                           onclick="showinput();"><?php echo $m_langpackage->m_add_cat; ?></a></span>
                        <span id="ucate_span" style="display:none;"><input type="text" value="" style="width:115px;"
                                                                           id="ucat_input"/><input type="button"
                ...
                <tr>
                    ...
                    <td><input type="text" id="goods_price" name="goods_price"
                               value="<?php echo $goods_info['goods_price']; ?>" style="width:80px;text-align:right;"
                               maxlength="8"/> <label><?php echo $m_langpackage->m_yuan; ?>
                            (<?php echo $m_langpackage->m_goods_pricezero; ?>)</label></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stort_type; ?>：</td>
                    <td class="">
                        <input type="radio" value="1" id="is_transport_template" onclick="chostransporttype(1)"
                               name="is_transport_template"/>
                        <label><?php echo $m_langpackage->m_is_transport_template; ?>&nbsp;&nbsp;</label>
                        <input type="radio" onclick="chostransporttype(0)" value="0"
                               name="is_transport_template"/><label><?php echo $m_langpackage->m_transport_price; ?></label>
                    </td>
                </tr>
                ...
                <tr id="transport1" style="display:none;">
                    ...
                    <td>
                        <?php if (is_array($transport_template_list)) { ?>
                            <?php foreach ($transport_template_list as $value) { ?>
                                <input type="radio" name="transport_template_id" onclick="chostransporttype(1)"
                                       value="<?php echo $value['id']; ?>"  /><?php echo $value['transport_name']; ?>&nbsp;
                ...
                <tr id="transport2" style="display:none;">
                    <td class="textright"><?php echo $m_langpackage->m_stort_expense; ?>：</td>
                    <td><input type="text" name="transport_price" id="transport_price"
                               value="<?php echo $goods_info['transport_price']; ?>"
                               style="width:80px; text-align:right;" maxlength="8"/>
                        <label><?php echo $m_langpackage->m_yuan; ?></label></td>
                </tr>

                <tr>
                    <td class="textright"><span id="picspan"><?php echo $m_langpackage->m_showgoods_photo; ?></span>
                    </td>
                    <td><input type="file" name="attach[]" id="www" value="asfsadf" onchange="showimg(this)"/>
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_wholesale_price; ?>：</td>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="goods_number" id="goods_number"
                               value="<?php echo $goods_info['goods_number']; ?>" style="width:80px; text-align:right;"
                               maxlength="5"/> <label><?php echo $m_langpackage->m_jian; ?></label></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_keyword; ?>：</td>
                    <td><input type="text" name="keyword" value="<?php echo $goods_info['keyword']; ?>"
                               style="width:250px;" maxlength="200"/>
                        <label><?php echo $m_langpackage->m_more_keyword_exp; ?></label></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_on_sale; ?>：</td>
                    <td><input type="checkbox" name="is_on_sale" value="1" <?php if ($goods_info['is_on_sale']) {
                            echo "checked"; ?><?php } ?> /><label>
                            <?php echo $m_langpackage->m_view_status; ?></label></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_add_recommend; ?>：</td>
                    <td>
                        <input type="checkbox" name="is_best" value="1" <?php if ($goods_info['is_best']) {
                            echo "checked";
                        } ?> />
                        <label><?php echo $m_langpackage->m_best; ?>&nbsp;</label>
                ...
                <tr>
                    <td colspan="2" class="center"><input class="submit" type="submit" name="submit"
                                                          value="<?php echo $m_langpackage->m_add_goods; ?>"/></td>
                </tr>
            </table>
        </form>
>>>>>>> remotes/origin/master
...
<div id="category_select" style="display:none;">
    ...
    <div class="category_com"><input class="submit" type="button" value="<?php echo $m_langpackage->m_post; ?>"
                                     onclick="postcatid();"/></div>
    <?php } else { ?>
    <span onclick="hidebgdiv();"><?php echo $m_langpackage->m_close; ?></span>
    <?php echo $m_langpackage->m_plss_select_cateogry; ?></div>
    <div align="center"
         style="margin-top:60px;font-weight:bolder;font-size:14px;color:#333"><?php echo $m_langpackage->m_isset_payment; ?></div>
<br/>
<br/>
<br/>
<br/>
    <div class="category_com"><input class="submit" type="button" value="<?php echo $m_langpackage->m_post; ?>"
                                     onclick="postcatid1();"/></div>
<?php } ?>
</div>
...
function formatFormElement(id, type, name, value, price) {
    ...
    if (type == 0) {
        ...
        if (price == 1) {
            price0 = name;
            str += '<input type="text" name="price[' + id + ']" value="请输入价格" onfocus="focusPrice(this)" onblur="blurPrice(this)" style="width:70px;" />';
        }
