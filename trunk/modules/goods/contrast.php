            ...
            <ul class="clearfix">
                <li>
                    <h3><img src="skin/default/images/part/ttl_channel_all.gif"
                             alt="<?php echo $m_langpackage->m_all_category; ?>"/></h3>
                </li>
        ...
        <table cellspacing="0" cellpadding="0" id="CompareTable">
            ...
            <tr class="toolbar">
                ...
                <?php foreach ($goods_list as $k => $value) { ?>
                    <th scope="col"><a onclick="move_pk(<?php echo $value['goods_id']; ?>);"
                                       href="javascript:;"><?php echo $m_langpackage->m_remove; ?></a> / <a
                            onclick="add_shopFavorite(<?php echo $value['goods_id']; ?>,<?php echo $value['shop_id']; ?>,<?php echo $k; ?>)"
                            href="javascript:;"><?php echo $m_langpackage->m_collect; ?></a></th>
                <?php } ?>
            </tr>
            ...
            <tr>
                ...
                <?php if (is_array($goods_list)) { ?>
                    <?php foreach ($goods_list as $value) { ?>
                        <td class="picName"><a href="goods.php?id=<?php echo $value['goods_id']; ?>"><img height="80"
                                                                                                          width="80"
                                                                                                          alt=""
                                                                                                          src="<?php echo $value['goods_thumb']; ?>"
            ...
            <tr>
                ...
                <?php if (is_array($goods_list)) { ?>
                    <?php foreach ($goods_list as $value) { ?>
                        <td class="picName"><a target="_blank"
                                               href="goods.php?id=<?php echo $value['goods_id']; ?>"><?php echo $value['goods_name']; ?></a>
                        </td> <?php } ?>
                <?php } ?>
            </tr>
            <tr>
                ...
                <?php if (is_array($goods_list)) { ?>
                    <?php foreach ($goods_list as $value) { ?>
                        <td class="picName"><a
                                onclick="addCart(<?php echo $value['goods_id']; ?>,<?php echo $value['shop_id']; ?>);"
            ...
            <tr>
                ...
                <?php if (is_array($goods_list)) { ?>
                    <?php foreach ($goods_list as $value) { ?>
                        <td><a target="_blank"
                               href="shop.php?shopid=<?php echo $value['shop_id']; ?>&app=index"><?php echo $value['shop_name']; ?></a>
                        </td><?php } ?>
                <?php } ?>
            </tr>
            <tr>
            ...
            <tr class="toolbar">
                ...
                <?php foreach ($goods_list as $k => $value) { ?>
                    <th scope="col">
                        <a onclick="move_pk(<?php echo $value['goods_id']; ?>);"
                           href="javascript:;"><?php echo $m_langpackage->m_remove; ?></a> / <a
                            onclick="add_shopFavorite(<?php echo $value['goods_id']; ?>,<?php echo $value['shop_id']; ?>,<?php echo $k; ?>)"
                            href="javascript:;"><?php echo $m_langpackage->m_collect; ?></a>
                    </th>
                <?php } ?>
            </tr>
        </table>
