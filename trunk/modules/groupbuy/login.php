...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_order_status; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    <div class="right_top"></div>
    <div class="cont">
        <div class="title_uc"><h3><?php echo $m_langpackage->m_order_status; ?></h3>
            <hr/>
        </div>
        <form action="do.php?act=goods_list" method="post" onsubmit="return submitform();">
            <table width="100%" class="form_table">
                <tr>
                    <td colspan="4" style="font-weight:bold; color:#F67A06;">
                        &nbsp;&nbsp;<?php echo $m_langpackage->m_event_title; ?>
                        - <?php echo $group_row['group_name']; ?></td>
                </tr>
                <tr class="center">
                    <th width="100"><?php echo $m_langpackage->m_group_user_name; ?></th>
                    <th width="100"><?php echo $m_langpackage->m_group_contact; ?></th>
