...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_add_groupbuy; ?>
</div>
<div class="clear"></div>
    ...
    <div class="main_right">
        ...
        <div class="cont">
            <div class="cont_title"><span class="tr_op"><a href="modules.php?app=groupbuy_list">
                        <?php echo $m_langpackage->m_group_list; ?></a></span><?php echo $m_langpackage->m_add_groupbuy; ?>
            </div>
            <hr/>
            ...
            <form action="do.php?act=groupbuy_add" method="post" name="from1" enctype="multipart/form-data">
                <table width="100%" style="border:0;" cellspacing="0">
                    <tr>
                        ...
                        <td align="left"><input type="text" name="groupbuy_name" value="" style="width:350px;"
                    ...
                    <tr style="line-height:18px;">
                        ...
                        <td align="left">
                            ...
                            <?php echo $m_langpackage->m_end_time; ?>：<input class="Wdate" type="text" name="end_time"
                                                                             id="end_time"
                                                                             onFocus="WdatePicker({isShowClear:false,readOnly:true})"/>
                    ...
                    <tr>
                        ...
                        <td align="left"><textarea name="groupbuy_explain" style="width:350px; height:80px;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="textright" valign="top"><?php echo $m_langpackage->m_select_products; ?>：</td>
                        <td align="left">
                            <input type="text" onclick="discontrol('goods_select',this)" id="goods_name"
                                   name="goods_name" value="" style="width:350px;" maxlength="200"/> <span
                                class="red">*</span><br/>
                            ...
                            <div id="goods_select" style="width:585px; display:none;">
                                <table width="100%" cellspacing="0">
                                    <tr>
                                        ...
                                        <td><input type="text" id="goodsselect_name" name="goodsselect_name" value=""
                                                   style="width:255px;" maxlength="200"/></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $m_langpackage->m_products_sort; ?>：</td>
                                        <td><select id="shop_category" name="shop_category">
                                                <option
                                                    value=""><?php echo $m_langpackage->m_select_pl; ?></option><?php echo $html_shop_category; ?>
                                            </select></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td><input class="submit" type="button"
                                                   value="<?php echo $m_langpackage->m_select; ?>"
                                                   onclick="get_goods_list()"></td>
                                    </tr>
                                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="min_quantity" value="" style="width:150px;"
                                                maxlength="200"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_group_price; ?>：</td>
                        <td align="left"><input type="text" name="spec_price" value="" style="width:150px;"
                                                maxlength="200"/> <span class="red">*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_group_one_num; ?>：</td>
                        <td align="left"><input type="text" name="one_num" id="one_num" value="0" style="width:50px;"
                                                maxlength="5"/> <span
                                class="red">*</span><?php echo $m_langpackage->m_group_no_purchase; ?></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_group_all_num; ?>：</td>
                        <td align="left"><input type="text" name="all_num" id="all_num" value="0" style="width:50px;"
                                                maxlength="5"/> <span
                                class="red">*</span><?php echo $m_langpackage->m_group_purchase; ?></td>
                    </tr>
                    <tr>
                        <td class="textright" style="border:0"></td>
                        <td style="border:0"><input class="submit" type="button" name="" onclick="checknum();"
                                                    value="<?php echo $m_langpackage->m_group_submit; ?>"/></td>
                    </tr>
                </table>
            </form>
        </div>
