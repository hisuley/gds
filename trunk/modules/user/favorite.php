...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_my_favorite; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <div class="index_tab">
            <ul>
                <li><a id="style1" class="current" href="javascript:;"
                       onclick="change_style('style1')"><?php echo $m_langpackage->m_goods_store; ?></a></li>
                <li><a id="style2" href="javascript:;"
                       onclick="change_style('style2')"><?php echo $m_langpackage->m_shop_store; ?></a></li>
            </ul>
        </div>
                ...
                <table width="98%" border="0" cellspacing="0">
                    ...
                    if (!empty($my_favorite['result'])) {
                        foreach ($my_favorite['result'] as $v) {
                            ?>
                            <tr class="trcolor">
                                <td><input type="checkbox" name="favorite[]" value="<?php echo $v['favorite_id']; ?>"/>
                                </td>
                                <td align="center"><a href="<?php echo goods_url($v['goods_id']); ?>"
                                                      target="_blank"><img src="<?php echo $v['goods_thumb']; ?>"
                                                                           width="80" height="80"
                                                                           onerror="this.src='skin/default/images/nopic.gif'"></a>
                                </td>
                                <td class="name"><a href="<?php echo goods_url($v['goods_id']); ?>"
                                                    target="_blank"><?php echo $v['goods_name']; ?></a>
                                    <br/> <?php echo $m_langpackage->m_order_shops; ?>：<a
                                        href="<?php echo shop_url($v['shop_id']); ?>"
                                        target="_blank"><?php echo $v['shop_name']; ?></a>
                                    &nbsp;&nbsp; <?php echo $m_langpackage->m_price; ?>：￥<span
                                        style="color:#FF6600; font-weight:bold;"><?php echo $v['goods_price']; ?></span><?php echo $m_langpackage->m_yuan; ?>
                                    <br/> <?php echo $m_langpackage->m_collect_num; ?>
                                    ：<span><?php echo $v['favpv']; ?></span>
                                    &nbsp;&nbsp; <?php echo $m_langpackage->m_add_time; ?>
                                    ：<?php echo substr($v['add_time'], 0, 16); ?> &nbsp;&nbsp;
                                    <script src="imshow.php?u=<?php echo $v['user_id']; ?>"></script>
                                </td>
                                <td align="center">
                                    ...
                                    <?php } ?><br/>
                                    <a href="do.php?act=user_favorite_del&id=<?php echo $v['favorite_id']; ?>"
                                       onclick="return confirm('<?php echo $m_langpackage->m_suredel_favorite; ?>');"><?php echo $m_langpackage->m_del; ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <td colspan="4" class="textleft"><INPUT class="submit" type="submit"
                                                                    value="<?php echo $m_langpackage->m_pl_del; ?>"
                    ...
                    <?php } else { ?>
                        <tr>
                            <td colspan="4" class="center"><?php echo $m_langpackage->m_nolist_record; ?></td>
                        </tr>
                    <?php } ?>
                </table>
            </form>
        ...
        <div id="display_favorite" class="tab_box" style="display:none;">
            <form action="do.php?act=user_shopfavorite_del" name="form_shop" method="post"
                  onsubmit="return submitform_shop();">
                <table width="98%" border="0" cellspacing="0">
                    <tr>
                    ...
                    if (!empty($shop_favorite['result'])) {
                        foreach ($shop_favorite['result'] as $v) {
                            ?>
                            <tr class="trcolor">
                                <td><input type="checkbox" name="favorite_shop[]"
                                           value="<?php echo $v['favorite_id']; ?>"/></td>
                                <td align="center">
                                    <?php if ($v['shop_logo']) { ?>
                                        <a href="<?php echo shop_url($v['shop_id']); ?>" target="_blank">
                                            <img src="<?php echo $v['shop_logo']; ?>" width="80" height="80"
                                ...
                                <td class="name">
                                    <a href="<?php echo shop_url($v['shop_id']); ?>"
                                       target="_blank"><?php echo $v['shop_name']; ?></a>
                                    <br/><?php echo $m_langpackage->m_shop_intro; ?>
                                    ：&nbsp;&nbsp;<?php echo $v['shop_intro']; ?>
                                </td>
                                <td align="center">
                                    <?php if ($v['lock_flg'] == '1') {
                                        ; ?>
                                    ...
                                    <?php } ?>
                                    <a href="do.php?act=user_shopfavorite_del&id=<?php echo $v['favorite_id']; ?>"
                                       onclick="return confirm('<?php echo $m_langpackage->m_suredel_favorite; ?>');"><?php echo $m_langpackage->m_del; ?></a><br/>
                                </td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <td colspan="4" class="textleft">
                                ...
                                <INPUT class="submit" type="submit" value="<?php echo $m_langpackage->m_pl_del; ?>"
                                       name="deletesubmit"/>
                            </td>
                        </tr>
                        <tr>
