...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_order_success; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    <div class="right_top"></div>
    <div class="cont">
        <div class="title_uc"><h3><?php echo $m_langpackage->m_order_success; ?></h3>
            <hr/>
        </div>
        <div id="stepTip" class="clearfix">
            <ul class="list_step1 clearfix">
                <li><?php echo $m_langpackage->m_u_first; ?>:<br/><?php echo $m_langpackage->m_ordernow_add; ?></li>
                <li><?php echo $m_langpackage->m_u_secound; ?>:<br/><?php echo $m_langpackage->m_sure_ordernow; ?></li>
                <li class="now" style="padding-right:0"><?php echo $m_langpackage->m_u_third; ?>
        ...
        <form action="do.php?act=user_order" method="post" name="form_profile">
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    <td colspan="4"><?php echo $m_langpackage->m_postsuccess_rempayid; ?>: <?php echo $payid; ?></td>
                </tr>
                <tr>
                    <td colspan="4"><input class="submit" style="font-weight:normal" type="button"
                                           value="<?php echo $m_langpackage->m_back_myorder; ?>" onclick="a()"/> <a
                            href="modules.php?app=user_payment_message&id=<?php echo $order_id; ?>"><input
                                class="submit" style="font-weight:normal" type="button"
                                value="<?php echo $m_langpackage->m_pay; ?>"/></a></td>
                </tr>
            </table>
        </form>
    </div>
