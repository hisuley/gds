...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_my_guestbook; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
            ...
            <table width="100%" border="0" cellspacing="0">
                ...
                <?php if (!empty($result['result'])) {
                    foreach ($result['result'] as $v) {
                        ...
                        <tr class="trcolor">
                            <td><input type="checkbox" name="gid[]" value="<?php echo $v['gid']; ?>"/></td>
                            <td class="name"><a href="<?php echo shop_url($v['shop_id']); ?>"
                                                target="_blank"><?php echo $v['shop_name']; ?></a></td>
                            <td class="name"><?php echo $v['content']; ?></td>
                            <td class="name"><?php echo $v['reply']; ?></td>
                            <td class="name"><?php echo substr($v['add_time'], 0, 16); ?></td>
                            <td class="name"><a href="do.php?act=user_guestbook_del&id=<?php echo $v['gid']; ?>"
                    ...
                    <tr>
                        ...
                        <th align="left" colspan="6">
                            <input type="button" onclick="select_all()" class="submit"
                                   value="<?php echo $m_langpackage->m_all_select; ?>">
                            <input type="button" class="submit" onclick="select_last()"
                                   value="<?php echo $m_langpackage->m_reverse; ?>">
                            <INPUT class="submit" type="submit" value="<?php echo $m_langpackage->m_pl_del; ?>"
                                   name="deletesubmit"></th>
                    </tr>
                <?php } else { ?>
                    <tr>
