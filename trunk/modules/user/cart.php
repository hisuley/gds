...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_my_cart; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<form action="do.php?act=user_cart_del" name="form" id="form1" method="get" onsubmit="return submitform();">
    <div class="main_right">
        ...
        <div class="cont">
            <div class="cont_title">
					<span class="tr_op">
					<a href="javascript:;" onclick="return go_to_buy()"><?php echo $m_langpackage->m_check_out; ?></a><a
                            href="index.php" target="_blank"><?php echo $m_langpackage->m_go_buy; ?></a>
					</span>
                <?php echo $m_langpackage->m_my_cart; ?>
            </div>
            <hr/>
            <table class="commodityCart" width="100%" border="0" cellspacing="0">
                    ...
                    foreach ($result['result'] as $k => $v) {
                        foreach ($shoparray as $ke => $va) {
                            if ($v['shop_id'] == $va) {
                                ...
                                <tr class="shopInfo">
                                    <td colspan="5"><?php echo $m_langpackage->m_order_shops; ?>：<a
                                            href="<?php echo shop_url($v['shop_id']); ?>"
                                            target="_blank"><?php echo $v['shop_name']; ?></a></td>
                                </tr>
                            <?php }
                        } ?>
                        <tr class="commodity">
                            <td align="center"><input type="checkbox" id="good_check" name="goods[]"
                                                      onclick="add_buy(<?php echo $v['goods_id']; ?>,<?php echo $v['shop_id']; ?>,<?php echo $v['goods_number']; ?>,this,this.checked)"
                                                      value="<?php echo $v['cart_id']; ?>"/></td>
                            <td align="center"><a href="<?php echo goods_url($v['goods_id']); ?>" target="_blank"><img
                            ...
                            <td class="name"><a href="<?php echo goods_url($v['goods_id']); ?>"
                                ...
                                <br/> <?php echo $m_langpackage->m_order_shops; ?>：<a
                                    href="<?php echo shop_url($v['shop_id'], 'index'); ?>"
                                    target="_blank"><?php echo $v['shop_name']; ?></a>
                                <br/>  <?php echo $m_langpackage->m_price; ?>
                                ：<?php echo $m_langpackage->m_money_sign; ?>
                                <span><?php echo $v['goods_price']; ?></span><?php echo $m_langpackage->m_yuan; ?>
                                <br/> <?php echo $m_langpackage->m_add_time; ?>
                            ...
                            <td align="center" id="goodssortid_<?php echo $v['cart_id']; ?>">
                                <span
                                    onclick="edit_sort(this,<?php echo $v['cart_id']; ?>)">&nbsp;<?php echo $v['goods_number']; ?>
                                    &nbsp;</span></td>
                            <td align="center">
                                <?php if ($v['lock_flg'] == '1') {
                                    ; ?>
                                ...
                                <?php } else if ($v['open_flg'] == '1') { ?>
                                    <font color='red'><?php echo $m_langpackage->m_other_shop_close; ?></font>
                                <?php } else { ?>
                                    <input type="hidden" id="shop_id_<?php echo $v['goods_id']; ?>"
                                           value="<?php echo $v['shop_id']; ?>"/>
                                    <a href="javascript:addFavorite(<?php echo $v['goods_id']; ?>);">收藏</a>
                                    <br/>
                                    <a id="num_<?php echo $v['cart_id']; ?>"
                                       href="modules.php?app=user_order_adress&gid=<?php echo $v['goods_id']; ?>&v=<?php echo $v['goods_number']; ?>"><?php echo $m_langpackage->m_ccbuy; ?></a>
                                <?php } ?><br/>
                                <a href="do.php?act=user_cart_del&id=<?php echo $v['cart_id']; ?><?php if ($v['cart_id'] == 0) { ?>&goods_id=<?php echo $v['goods_id']; ?><?php } ?>"
                                   onclick="return confirm('<?php echo $m_langpackage->m_sure_delcartgoods; ?>');"><?php echo $m_langpackage->m_del; ?></a>
                            </td>
                        </tr>
                    ...
                    <?php if (!empty($row['sumvalue'])) { ?>
                        <tr>
                            <td colspan="5" style="border-bottom:0">
                                <div><?php echo $m_langpackage->m_car_sum; ?><?php echo $row['sumvalue']; ?><?php echo $m_langpackage->m_yuan; ?></div>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                ...
                <?php } else { ?>
                    <tr>
                        <th colspan="5" class="center"><?php echo $m_langpackage->m_nolist_record; ?></td>
                    </tr>
                <?php } ?>
                <input type="hidden" name="app" value="user_order"/>
                <input type="hidden" id="shop_user" value="<?php echo $user_id; ?>"/>
