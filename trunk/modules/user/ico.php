...
<?php  require("shop/index_header.php");?>
	<div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;<?php echo  $m_langpackage->m_ico_set;?>
	</div>
    <div class="clear"></div>
    ...
    <div class="main_right">
		...
		<div class="cont">
			<div class="title_uc"><h3><?php echo  $m_langpackage->m_ico_set;?></h3><hr /></div>
				<form action="do.php?act=user_ico" method="post" name="form_profile" enctype="multipart/form-data">
				<table width="100%" class="form_table">
					<tr><td class="textright"><span id="picspan"><?php if($user_info['user_ico']){?><img src="<?php echo $user_info['user_ico'];?>" width="80" height="80" onerror="this.src='skin/default/images/nopic.gif'"/><?php  }else{?><?php echo $m_langpackage->m_user_ico;?><?php }?></span></td><td class="textleft"><input type="file" name="attach[]" onchange="showimg(this)" /><br /><?php echo $m_langpackage->m_img_limit;?></td></tr>
