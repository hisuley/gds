...
<body onload="menu_style_change('user_profile');changeMenu();">
	...
	<div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;<?php echo  $m_langpackage->m_profile;?>
	</div>
    <div class="clear"></div>
    <?php  require("modules/left_menu.php");?>
        <div class="main_right">
            ...
            <div class="cont">
                <div class="cont_title"><?php echo  $m_langpackage->m_edit_profile;?></div>
                <hr />
				<form action="do.php?act=user_profile" method="post" name="form_profile">
					<table width="100%" style="border:0" cellspacing="0">
						...
						<tr><td></td><td><input type="hidden" name="user_id" value="<?php echo  $user_id;?>" /><input class="submit" style=" font-weight:normal" type="submit" name="submit" value="<?php echo  $m_langpackage->m_edit_profile;?>" /></td></tr>
					</table>
				</form>
			</div>
			<div class="clear"></div>
...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_profile; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <form action="do.php?act=user_profile" method="post" name="form_profile">
            <table width="100%" style="border:0" cellspacing="0">
                <tr>
                    <td class="textright" width="40%">Email：</td>
                    <td><?php echo get_sess_user_email(); ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_user_integral; ?>：</td>
                    <td><?php echo $user_detail['user_integral']; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_user_integral_surplus; ?>：</td>
                    <td><?php echo $user_detail['user_integral_surplus']; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_user_money; ?>：</td>
                    <td><?php echo $user_detail['user_money']; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_truename; ?>：</td>
                    <td><input type="text" name="user_truename" value="<?php echo $user_info['user_truename']; ?>"
                               maxlength="12"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_birthday; ?>：</td>
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_gender; ?>：</td>
                    <td><input type="radio" name="user_gender"
                               value="0" <?php echo $user_gender0; ?> /><?php echo $m_langpackage->m_secret; ?> <input
                            type="radio" name="user_gender"
                            value="1" <?php echo $user_gender1; ?> /><?php echo $m_langpackage->m_man; ?> <input
                            type="radio" name="user_gender"
                            value="2" <?php echo $user_gender2; ?> /><?php echo $m_langpackage->m_woman; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_marry; ?>：</td>
                    <td><input type="radio" name="user_marry"
                               value="0" <?php echo $user_marry0; ?> /><?php echo $m_langpackage->m_secret; ?> <input
                            type="radio" name="user_marry"
                            value="1" <?php echo $user_marry1; ?> /><?php echo $m_langpackage->m_unmarried; ?> <input
                            type="radio" name="user_marry"
                            value="2" <?php echo $user_marry2; ?> /><?php echo $m_langpackage->m_married; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_mobile; ?>：</td>
                    <td><input type="text" name="user_mobile" value="<?php echo $user_info['user_mobile']; ?>"
                               maxlength="20"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_telphone; ?>：</td>
                    <td><input type="text" name="user_telphone" value="<?php echo $user_info['user_telphone']; ?>"
                               maxlength="20"/></td>
                </tr>
                <tr>
                    <td class="textright">MSN：</td>
                    <td><input type="text" name="user_msn" value="<?php echo $user_info['user_msn']; ?>"
                               maxlength="50"/></td>
                </tr>
                <tr>
                    <td class="textright">QQ：</td>
                    <td><input type="text" name="user_qq" value="<?php echo $user_info['user_qq']; ?>" maxlength="15"/>
                    </td>
                </tr>
                <tr>
                    <td class="textright">Skype：</td>
                    <td><input type="text" name="user_skype" value="<?php echo $user_info['user_skype']; ?>"
                               maxlength="50"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stayarea; ?>：</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="user_zipcode" value="<?php echo $user_info['user_zipcode']; ?>"
                               maxlength="6"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/><input class="submit"
                                                                                                    style=" font-weight:normal"
                                                                                                    type="submit"
                                                                                                    name="submit"
                                                                                                    value="<?php echo $m_langpackage->m_edit_profile; ?>"/>
                    </td>
                </tr>
            </table>
        </form>
