...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_iwant_pay; ?>
</div>
<div class="clear"></div>
    ...
    <div class="cont">
        ...
        <form action="do.php?act=user_order" method="post" name="form_profile">
            <table width="100%" style="border:0" cellspacing="0">
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_your_payid; ?>：</td>
                    <td class="textleft"><?php echo $order_info['payid']; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_order_amount; ?>：</td>
                    <td class="textleft"><?php echo $m_langpackage->m_money_sign; ?><?php echo $order_info['order_value']; ?><?php echo $m_langpackage->m_yuan; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_payment_cho; ?>：</td>
                    <td class="textleft">
                        <?php foreach ($payment_shop_info as $value) { ?>
                            <?php if (isset($payment_info[$value['pay_id']])) { ?>
                                <a href="pay.php?order_id=<?php echo $order_info['order_id']; ?>&pay_id=<?php echo $value['pay_id']; ?>&shop_id=<?php echo $order_info['shop_id']; ?>"><?php echo $payment_info[$value['pay_id']]['pay_name']; ?>
                                    <img
                                        src="plugins/<?php echo $payment_info[$value['pay_id']]['pay_code']; ?>/logo.gif"
                                        height="30" onerror="this.src='skin/default/images/nopic.gif'"/></a> <br/><br/>
                            <?php } ?>
                        <?php } ?>
                    </td>
                </tr>
