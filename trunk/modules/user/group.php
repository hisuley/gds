    ...
    <div class="cont">
        ...
        <form action="do.php?act=goods_list" method="post" onsubmit="return submitform();">
            <table width="100%" border="0" cellspacing="0">
                ...
                <?php if (!empty($result['result'])) {
                    foreach ($result['result'] as $v) {
                        ...
                        <tr class="trcolor">
                            ...
                            <td><h3><a href="goods.php?app=groupbuyinfo&id=<?php echo $v['group_id']; ?>"
                                       target="_blank"><?php echo $v['group_name']; ?></a></h3>

                                <p>[<?php echo $s_langpackage->s_groupbuy_shows; ?>
                                    ]&nbsp;&nbsp;&nbsp;<?php echo sub_str($v['group_desc'], 70, false); ?></p></td>
                            <td class="center"><?php if ($v['recommended'] == 0) {
                            ...
                            <td class="center"><?php echo $m_langpackage->m_from; ?><?php echo $v['start_time']; ?>
                ...
                <?php } else { ?>
                    <tr>
                        <td colspan="6" class="center"><?php echo $m_langpackage->m_nogoods_list; ?></td>
                    </tr>
                <?php } ?>
