 ...
 * 如果您的模板要进行修改，请修改 templates/default/modules/user/protect_rights.html
 * 如果您的模型要进行修改，请修改 models/modules/user/protect_rights.php
 *
...
if(filemtime("templates/default/modules/user/protect_rights.html") > filemtime(__file__) || (file_exists("models/modules/user/protect_rights.php") && filemtime("models/modules/user/protect_rights.php") > filemtime(__file__)) ) {
    tpl_engine("default", "modules/user/protect_rights.html", 1);
    include(__file__);
} else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="site_map"> <?php echo $m_langpackage->m_current_position; ?><A
        ...
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;维权信息
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        ...
        <hr/>
        <form action="do.php?act=user_protect_rights&id=<?php echo $order_id; ?>" method="post"
              onsubmit="return checkeck();">
            <table class="form_table_02">
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($is_allow_service) { ?>
                            <input type="submit" value="<?php echo $m_langpackage->m_ask_service; ?>"
                                   name="ask_service"/>
                        <?php } ?>
                    </td>
