...
<div class="site_map"> <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;维权信息 </div>
<div class="clear"></div>
...
<div class="main_right">
   ...
   <hr />
		<form action="do.php?act=user_protect_rights&id=<?php echo $order_id;?>" method="post" onsubmit="return checkeck();">
		<table class="form_table_02">
			...
			<tr>
				...
				<?php if($is_allow_service) {?>
					<input type="submit" value="<?php echo  $m_langpackage->m_ask_service;?>" name="ask_service" />
				<?php }?>
				</td>
