...
>>>>>>> remotes/origin/master
        ...
        <form action="do.php?act=user_order" method="post" name="for<?php echo $m_langpackage->m_profile; ?>"
            ...
            <table width="100%" border="0" cellspacing="0">
                <input type="hidden" value="<?php echo $goods_info[0]['shop_id']; ?>" name="sshop_id"/>
                <tr>
                    <th colspan="2"><?php echo $m_langpackage->m_goods_name; ?></th>
                    <th><?php echo $m_langpackage->m_goods_price; ?></th>
                    <th><?php echo $m_langpackage->m_buy_num; ?></th>
                </tr>
                <?php foreach ($goods_info as $k => $v) { ?>
                    <tr>
                        <td class="name" colspan="2"><a href="<?php echo goods_url($v['goods_id']); ?>"
                                                        target="_blank"><?php echo $v['goods_name']; ?></a></td>
                        <td align="center"><?php echo $v['goods_price']; ?><?php echo $m_langpackage->m_yuan; ?></td>
                        <td align="center"><input type="text" value="<?php echo $buy_goods[$v['goods_id']]; ?>"
                                                  name="order_num[]" style="width:30px"></td>
                        <input type="hidden" value="<?php echo $v['goods_id']; ?>" name="goods_id[]"/>
                        <input type="hidden" value="<?php echo $v['goods_name']; ?>" name="goods_name[]"/>
                        <input type="hidden" value="<?php echo $v['goods_price']; ?>" name="goods_price[]"/>
                        <input type="hidden" value="<?php echo $v['goods_price'] * $buy_goods[$v['goods_id']]; ?>"
            ...
            <table id="transport_type" width="100%" border="0" cellspacing="0">
                <tr>
                <tr class="center">
                    <th colspan="7" align="left"><?php echo $m_langpackage->m_transport_price; ?></th>
                </tr>
                </tr>
                <tr>
                    <td colspan="7">
            ...
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    <th width="200" align="left">&nbsp;&nbsp;<?php echo $m_langpackage->m_sure_postorder; ?></th>
                    <th></th>
                </tr>
                <?php if ($grogshop_flag == true) { ?>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_order_checkin_time; ?>：</td>
                    ...
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_order_checkin_person; ?>：</td>
                        <td><input type="text" name="checkin_person"/>　<span>*</span></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_order_latest_toshop; ?>：</td>
                        <td><select name="latest_toshop">
                                <option value="12:00">12:00</option>
                                <option value="14:00">14:00</option>
                                <option value="16:00">16:00</option>
                ...
                <?php if ($scenic_flag == true) { ?>
                    <tr>
                        ...
                        <td><input class="column-10" type="text" id="departDateInput" name="travelDate"
                                   onblur="inputTxt2(this,'set', '请选择旅行日期');compareDate();"
                                   onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'%y-%M-{%d}'});inputTxt2(this,'clean', '请选择旅行日期');compareDate();"
                                   value="请选择旅行日期"/>　<span>*</span></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td class="textright" valign="top"><?php echo $m_langpackage->m_order_message; ?>：</td>
                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <input type="button" onclick="javacript:history.go(-1);" name="submit" class="submit"
                               value="<?php echo $m_langpackage->m_change_address; ?>"/>
