...
<?php  require("shop/index_header.php");?>
    <div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;<?php echo  $m_langpackage->m_complaints;?>
	</div>
    <div class="clear"></div>
        ...
        <div class="cont">
			...
			<form action="do.php?act=user_complaint_add" method="post" name="form_profile" onsubmit="return checkform1();">
				<table width="100%" style="border:0" cellspacing="0">
					<tr><td class="textright" width="100px;"><?php echo  $m_langpackage->m_by_complainant;?>：</td><td class="textleft"><a href="shop.php?shopid=<?php echo  $order_rs['shop_id'];?>&app=index" target="_blank"><?php echo $order_rs['shop_name'];?></a><input type="hidden" name="shopid" value="<?php echo $order_rs['shop_id'];?>"><input type="hidden" name="shop_name" value="<?php echo $order_rs['shop_name'];?>"></td></tr>
					...
					<td class="textleft"><select name="complaints_title" id="complaints_title" require="true" datatype="Require" msg="<?php echo  $m_langpackage->m_select_complaints_reason;?>"  >
					...
					<tr><td class="textright" valign="top"><?php echo  $m_langpackage->m_complaints_content;?>：</td><td class="textleft"><textarea name="complaints_content" id="complaints_content" cols="60" rows="10" require="true" datatype="Require" msg="<?php echo  $m_langpackage->m_please_enter_complaints;?>" class="inputmain" onblur="cutSize(this,500);countShow2(this.value,'count');" onkeyup="cutSize(this,500);countShow2(this.value,'count');"></textarea>
					<br />(<?php echo  $m_langpackage->m_current;?><span id="count">0</span><?php echo  $m_langpackage->m_upto_bytes;?>)<br /><span style="padding:10px; "><?php echo  $m_langpackage->m_real_evidence_dispute;?></span></td></tr>
					 <tr>
		          	...
		          	<img border="0" src="servtools/veriCodes.php" width="80" height="40" align="absmiddle"  id="verCodePic"><a style="display:inline-block;*margin:0 0 13px 10px" href="javascript:;" onclick="return getVerCode();"><?php echo $i_langpackage->i_change_img;?></a></td>
		              </tr>
					<tr><td colspan="2" align="center"><input class="submit" type="submit" name="submit" value="<?php echo  $m_langpackage->m_send;?>" /></td></tr>
				</table>
