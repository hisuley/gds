...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_my_group_buy_orders; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
<div class="main_right">
    ...
    <div class="cont">
        ...
        <div id="stepTip" class="clearfix">
            <ul class="list_step1 clearfix">
                <li><?php echo $m_langpackage->m_u_first; ?>:<br/><?php echo $m_langpackage->m_ordernow_add; ?></li>
                <li class="now"><?php echo $m_langpackage->m_u_secound; ?>
        ...
        <form action="do.php?act=user_order" method="post" name="for<?php echo $m_langpackage->m_profile; ?>"
            ...
            <table width="100%" border="0" cellspacing="0">
                ...
                <input type="hidden" value="<?php echo $goods_info['quantity']; ?>" name="quantity"/>
                <input type="hidden"
                       value="<?php echo $goods_info['spec_price'] * $goods_info['quantity'] + $goods_info['quantity'] * $goods_info['transport_price']; ?>"
                       name="order_amount"/>
                <tr>
                    <td colspan="4"><?php echo $m_langpackage->m_order_thisbuyprice; ?>
                        :<span><?php echo $goods_info['spec_price'] * $goods_info['quantity'] + $goods_info['quantity'] * $goods_info['transport_price']; ?></span><?php echo $m_langpackage->m_yuan; ?>
                    </td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr>
                    <td class="textright" align="left"><?php echo $m_langpackage->m_contact; ?>:</td>
                    <td><?php echo $user_info['to_user_name']; ?></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stayarea; ?>:</td>
                    <td>
                ...
                <tr>
                    <td colspan="2">&nbsp;&nbsp;<span><?php echo $m_langpackage->m_sureaddress_rcgoods; ?></span></td>
                </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" style="display:none">
                <tr>
                ...
                <tr>
                    <td class="textright" align="left"><?php echo $m_langpackage->m_contact; ?>:</td>
                    <td><input type="text" name="to_user_name" value="<?php echo $goods_info['linkman']; ?>"
                               maxlength="12"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stayarea; ?>:</td>
            ...
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_order_message; ?>:</td>
                    <td><textarea name="message" style="width:280px;height:60px"></textarea></td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <input type="hidden" name="pay_name"
                               value="<?php echo $payment[$payment_info['pay_id']]['pay_name']; ?>"/>
                        <input type="submit" class="submit" name="submit"
                               value="<?php echo $m_langpackage->m_post_order; ?>"/></td>
                </tr>
            </table>
        </form>
    </div>
