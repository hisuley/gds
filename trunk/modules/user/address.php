...
<body onload="menu_style_change('user_address');changeMenu();">
	...
	<div class="site_map">
	  <?php echo $m_langpackage->m_current_position;?><A href="index.php"><?php echo $SYSINFO['sys_name'];?></A>/<a href="modules.php"><?php echo $m_langpackage->m_u_center;?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_getgoods_address;?>
	</div>
    <div class="clear"></div>
        ...
        <div class="main_right">
            ...
            <div class="cont">
                <div class="cont_title"><?php echo  $m_langpackage->m_getgoods_address;?></div>
                <hr />

			<table width="100%" border="0" cellspacing="0">
				<tr>
                    <th style="width:;"><?php echo $m_langpackage->m_getpackage_pop;?></th>
                    <th style="width:150px;"><?php echo $m_langpackage->m_getpackage_area;?></th>
                    <th style="width:;"><?php echo $m_langpackage->m_address;?></th>
                    <th style="width:60px;"><?php echo $m_langpackage->m_zipcode;?></th>
                    <th style="width:160px;"><?php echo $m_langpackage->m_mobile;?>/<?php echo $m_langpackage->m_telphone;?></th>
                    <th style="width:120px;"><?php echo $m_langpackage->m_email;?></th>
                    <th style="width:60px;"><?php echo $m_langpackage->m_manage;?></th>
                </tr>
				<?php if(empty($address_rs)){?>
					<tr><td class="name" colspan="7"><?php echo $m_langpackage->m_dontsave_getgoods_addresslist;?></td></tr>
				<?php }else{?>
				<?php foreach($address_rs as $val){?>
				<tr class="trcolor">
					<td class="name center"><?php echo $val['to_user_name'];?></td>
                    <td class="name"><?php echo $areas_info[0][$val['user_country']]['area_name'];?> <?php echo $areas_info[1][$val['user_province']]['area_name'];?> <?php echo $areas_info[2][$val['user_city']]['area_name'];?> <?php echo $areas_info[3][$val['user_district']]['area_name'];?></td>
                    <td><?php echo $val['full_address'];?></td>
                    <td class="name"><?php echo $val['zipcode'];?></td>
                    <td class="name"><?php echo $val['mobile'];?>/<?php echo $val['telphone'];?></td>
                    <td class="name"><?php echo $val['email'];?></td>
                    <td class="name"><a href="modules.php?app=user_address&address_id=<?php echo $val['address_id'];?>"><?php echo $m_langpackage->m_edit;?></a><br /><a href="do.php?act=user_address_del&address_id=<?php echo $val['address_id'];?>"><?php echo $m_langpackage->m_del;?></a>
                    </td>
				</tr>
				<?php }?>
				<?php }?>
			...
			<form action="do.php?act=user_address_add" method="post" name="form_profile" onsubmit="return checkform();">
				<table width="100%" border="0" cellspacing="0">
					<input type="hidden" name="address_id" value="<?php echo  isset($user_info['address_id'])?$user_info['address_id']:'';?>" />
					<tr><th align="left" width="200"><?php echo $m_langpackage->m_addnew_getpackage_address;?></th><th></th></tr>
					<tr>
                        <td class="textright"><?php echo $m_langpackage->m_getpackage_name;?>：</td>
                        <td class="textleft"><input type="text" name="to_user_name" value="<?php echo  $user_info['to_user_name'];?>" maxlength="12" /></td></tr>
					<tr>
					...
					<tr><td></td><td><input type="hidden" name="user_id" value="<?php echo  $user_id;?>" /><input type="submit" class="submit" name="submit" value="<?php echo $m_langpackage->m_send;?>" /></td></tr>
				</table>
			</form>
            </div>
            <div class="clear"></div>
...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_getgoods_address; ?>
</div>
<div class="clear"></div>
    ...
    <div class="cont">
        ...
        <table width="100%" border="0" cellspacing="0">
            <tr>
                ...
                <th style="width:;"><?php echo $m_langpackage->m_address; ?></th>
                <th style="width:60px;"><?php echo $m_langpackage->m_zipcode; ?></th>
                <th style="width:160px;"><?php echo $m_langpackage->m_mobile; ?>
                    /<?php echo $m_langpackage->m_telphone; ?></th>
                <th style="width:120px;"><?php echo $m_langpackage->m_email; ?></th>
                <th style="width:60px;"><?php echo $m_langpackage->m_manage; ?></th>
            </tr>
            <?php if (empty($address_rs)) { ?>
                <tr>
                    <td class="name" colspan="7"><?php echo $m_langpackage->m_dontsave_getgoods_addresslist; ?></td>
                </tr>
            <?php } else { ?>
                <?php foreach ($address_rs as $val) { ?>
                    <tr class="trcolor">
                        ...
                        <td class="name"><?php echo $val['email']; ?></td>
                        <td class="name"><a
                                href="modules.php?app=user_address&address_id=<?php echo $val['address_id']; ?>"><?php echo $m_langpackage->m_edit; ?></a><br/><a
                                href="do.php?act=user_address_del&address_id=<?php echo $val['address_id']; ?>"><?php echo $m_langpackage->m_del; ?></a>
                        </td>
                    </tr>
                <?php } ?>
            <?php } ?>
        ...
        <form action="do.php?act=user_address_add" method="post" name="form_profile" onsubmit="return checkform();">
            <table width="100%" border="0" cellspacing="0">
                <input type="hidden" name="address_id"
                       value="<?php echo isset($user_info['address_id']) ? $user_info['address_id'] : ''; ?>"/>
                <tr>
                    <th align="left" width="200"><?php echo $m_langpackage->m_addnew_getpackage_address; ?></th>
                    <th></th>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_getpackage_name; ?>：</td>
                    <td class="textleft"><input type="text" name="to_user_name"
                                                value="<?php echo $user_info['to_user_name']; ?>" maxlength="12"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_stayarea; ?>：</td>
                    <td class="textleft">
							<span id="user_country"><select name="country" onchange="areachanged(this.value,0);">
                                    ...
                                    <?php foreach ($areas_info[0] as $v) { ?>
                                        <option
                                            value="<?php echo $v['area_id']; ?>" <?php if ($v['area_id'] == $user_info['user_country']) {
                                            echo 'selected';
                                    ...
                                    <select name="province" onchange="areachanged(this.value,1);">
                                        ...
                                        <?php foreach ($areas_info[1] as $v) {
                                            if ($v['parent_id'] == $user_info['user_country']) {
                                                ?>
                                                <option
                                                    value="<?php echo $v['area_id']; ?>" <?php if ($v['area_id'] == $user_info['user_province']) {
                                                    echo 'selected';
                                                } ?>><?php echo $v['area_name']; ?></option>
                                            <?php
                                            }
                                    ...
                                    <select name="city" onchange="areachanged(this.value,2);">
                                        ...
                                        <?php     foreach ($areas_info[2] as $v) {
                                            if ($v['parent_id'] == $user_info['user_province']) {
                                                ?>
                                                <option
                                                    value="<?php echo $v['area_id']; ?>" <?php if ($v['area_id'] == $user_info['user_city']) {
                                                    echo 'selected';
                                                } ?>><?php echo $v['area_name']; ?></option>
                                            <?php
                                            }
                                    ...
                                    <select name="district">
                                        ...
                                        <?php foreach ($areas_info[3] as $v) {
                                            if ($v['parent_id'] == $user_info['user_city']) {
                                                ?>
                                                <option
                                                    value="<?php echo $v['area_id']; ?>" <?php if ($v['area_id'] == $user_info['user_district']) {
                                                    echo 'selected';
                                                } ?>><?php echo $v['area_name']; ?></option>
                                            <?php
                                            }
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_address; ?>：</td>
                    <td class="textleft"><input type="text" name="full_address"
                                                value="<?php echo $user_info['full_address']; ?>" style="width:250px;"
                                                maxlength="200"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_zipcode; ?>：</td>
                    <td class="textleft"><input type="text" name="zipcode" value="<?php echo $user_info['zipcode']; ?>"
                                                maxlength="6"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_mobile; ?>：</td>
                    <td class="textleft"><input type="text" name="mobile" value="<?php echo $user_info['mobile']; ?>"
                                                maxlength="20"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_telphone; ?>：</td>
                    <td class="textleft"><input type="text" name="telphone"
                                                value="<?php echo $user_info['telphone']; ?>" maxlength="20"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_email; ?>：</td>
                    <td class="textleft"><input type="text" name="email" value="<?php echo $user_info['email']; ?>"
                                                maxlength="20"/></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/><input type="submit"
                                                                                                    class="submit"
                                                                                                    name="submit"
                                                                                                    value="<?php echo $m_langpackage->m_send; ?>"/>
                    </td>
                </tr>
            </table>
        </form>
