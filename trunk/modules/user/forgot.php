...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_find_password; ?>
</div>
<div class="clear"></div>
...
<div class="main_right">
    ...
    <div class="cont">
        <div class="title_uc"><h3><?php echo $m_langpackage->m_find_password; ?></h3>
            <hr/>
        </div>
        <form action="do.php?act=forgot" method="post" name="form_passwd" onsubmit="return checkForm();">
            <table width="100%" border="0" cellspacing="0">
                <tr>
                    <th class="textright"><?php echo $m_langpackage->m_new_password; ?>：</td>
                    <th class="textleft"><input type="password" name="user_new_passwd" value="" maxlength="20"/></td>
                </tr>
                <tr>
                    <th class="textright"><?php echo $m_langpackage->m_re_password; ?>：</td>
                ...
                <tr>
                    <td colspan="2" align="center"><input type="hidden" name="user_id"
                                                          value="<?php echo $userpwd_id; ?>"/>
                        <input type="hidden" name="code" value="<?php echo $code; ?>"/><input type="submit"
                                                                                              class="submit "
                                                                                              name="submit"
                                                                                              value="<?php echo $m_langpackage->m_edit; ?>"/>
                    </td>
                </tr>
            </table>
        </form>
