...
<div class="site_map">
    <?php echo $m_langpackage->m_current_position; ?><A href="index.php"><?php echo $SYSINFO['sys_name']; ?></A>/<a
        href="modules.php"><?php echo $m_langpackage->m_u_center; ?></a>/&nbsp;&nbsp;<?php echo $m_langpackage->m_my_order; ?>
</div>
<div class="clear"></div>
<?php require("modules/left_menu.php"); ?>
...
<div class="main_right">
    <div class="cont">
        ...
        <div id="stepTip" class="clearfix">
            <ul class="list_step1 clearfix">
                <li class="now"><?php echo $m_langpackage->m_u_first; ?>
                    :<br/><?php echo $m_langpackage->m_sure_ordernow; ?></li>
                <li><?php echo $m_langpackage->m_u_secound; ?>:<br/><?php echo $m_langpackage->m_sure_ordernow; ?></li>
                <li style="padding-right:0"><?php echo $m_langpackage->m_u_third; ?>
                    :<br/><?php echo $m_langpackage->m_accomplish; ?></li>
            </ul>
        </div>

        <form action="modules.php?app=user_order_groupbuy&gid=<?php echo $group_id; ?>" method="post"
              name="for<?php echo $m_langpackage->m_profile; ?>" onsubmit="return checkform();">


            <table width="100%" class="form_table">
                <tr class="center">
                    <th colspan="7"><?php echo $m_langpackage->m_getgoods_addresslist; ?></th>
                </tr>
                <?php if (empty($address_rs)) { ?>
                    <tr>
                        <td class="center"
                            colspan="7"><?php echo $m_langpackage->m_dontsave_getgoods_addresslist; ?></td>
                    </tr>
                <?php } ?>
                <?php foreach ($address_rs as $val) { ?>
                    <tr>
                        <td class="center"><input type="radio" name="address_id"
                                                  value="<?php echo $val['address_id']; ?>"
                                                  onclick="changeurl(this.value);" <?php if ($val['address_id'] == $address_id) { ?> checked <?php } ?> />
                        </td>
                        <td class="center"><?php echo $val['to_user_name']; ?></td>
                        <td><?php echo $areas_info[0][$val['user_country']]['area_name']; ?> <?php echo $areas_info[1][$val['user_province']]['area_name']; ?> <?php echo $areas_info[2][$val['user_city']]['area_name']; ?> <?php echo $areas_info[3][$val['user_district']]['area_name']; ?></td>
                        <td><?php echo $val['full_address']; ?></td>
                        <td class="center"><?php echo $val['zipcode']; ?></td>
                        <td class="center"><?php echo $val['mobile']; ?>/<?php echo $val['telphone']; ?></td>
                        <td class="center"><?php echo $val['email']; ?></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td class="center"><input type="radio" name="address_id" value=""
                                              onclick="newAddress();" <?php if (empty($address_rs)) { ?> checked <?php } ?>/>
                    </td>
                    <td class="left" colspan="4"><?php echo $m_langpackage->m_userother_address; ?></td>
                    <td></td>
                    <td class="center"></td>
                </tr>
            </table>
            <?php if (!empty($address_rs)) { ?>
                <table id="oldAddress" width="100%" border="0" cellspacing="0">
                    <tr>
                        <th align="left" width="200">&nbsp;&nbsp;<?php echo $m_langpackage->m_order_getsting; ?></th>
                        <th align="right"><span></span></th>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_contact; ?>：</td>
                        <td align="left"><?php echo $user_info['to_user_name']; ?></td>
                    </tr>
                    <tr>
                        <td class="textright"><?php echo $m_langpackage->m_stayarea; ?>：</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><?php echo $user_info['full_address']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td><span><?php echo $m_langpackage->m_sureaddress_rcgoods; ?></span></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <input type="submit" name="submit" value="<?php echo $m_langpackage->m_post_order; ?>"/>
                        </td>
                    </tr>
                </table>
            <?php } ?>
            <table id="newAddress" width="100%" border="0" cellspacing="0" style="<?php echo $newaddress; ?>">
                <tr>
                    <th align="left" width="30%">&nbsp;&nbsp;<?php echo $m_langpackage->m_order_getsting; ?></th>
                    <th width="70%"><span></span></th>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_contact; ?>：</td>
                    <td align="left"><input type="text" name="to_user_name"
                ...
                <tr>
                    ...
                    <td>
							<span id="user_country"><select name="country" onchange="areachanged(this.value,0);">
                                    ...
                                    <?php foreach ($areas_info[0] as $v) { ?>
                                        <option value="<?php echo $v['area_id']; ?>"
                                            <?php if ($v['area_id'] == $user_info['user_country']) {
                                                echo 'selected';
                                    ...
                                    <select name="province" id="province" onchange="areachanged(this.value,1);">
                                        ...
                                        <?php  foreach ($areas_info[1] as $v) {
                                            if ($v['parent_id'] == $user_info['user_country']) {
                                                ?>
                                                <option value="<?php echo $v['area_id']; ?>"
                                                    <?php if ($v['area_id'] == $user_info['user_province']) {
                                                        echo 'selected';
                                                    } ?>><?php echo $v['area_name']; ?></option>
                                            <?php } ?>
                                        <?php } ?>
                                    ...
                                    <select name="city" onchange="areachanged(this.value,2);">
                                        ...
                                        <?php  foreach ($areas_info[2] as $v) {
                                            if ($v['parent_id'] == $user_info['user_province']) {
                                                ?>
                                                <option value="<?php echo $v['area_id']; ?>"
                                                    <?php if ($v['area_id'] == $user_info['user_city']) {
                                                        echo 'selected';
                                                    } ?>><?php echo $v['area_name']; ?></option>
                                            <?php } ?>
                                        <?php } ?></select>
                                    ...
                                    <select name="district">
                                        ...
                                        <?php  foreach ($areas_info[3] as $v) {
                                            if ($v['parent_id'] == $user_info['user_city']) {
                                                ?>
                                                <option value="<?php echo $v['area_id']; ?>"
                                                    <?php if ($v['area_id'] == $user_info['user_district']) {
                                                        echo 'selected';
                                                    } ?>><?php echo $v['area_name']; ?></option>
                                            <?php } ?>
                                        <?php } ?></select>
                ...
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_address; ?>：</td>
                    <td><input type="text" name="full_address" value="<?php echo $user_info['full_address']; ?>"
                               style="width:250px;" maxlength="200"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_zipcode; ?>：</td>
                    <td><input type="text" name="zipcode" value="<?php echo $user_info['zipcode']; ?>" maxlength="6"/>
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_mobile; ?>：</td>
                    <td><input type="text" name="mobile" value="<?php echo $user_info['mobile']; ?>" maxlength="20"/>
                    </td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_telphone; ?>：</td>
                    <td><input type="text" name="telphone" value="<?php echo $user_info['telphone']; ?>"
                               maxlength="20"/></td>
                </tr>
                <tr>
                    <td class="textright"><?php echo $m_langpackage->m_email; ?>：</td>
                    <td><input type="text" name="email" value="<?php echo $user_info['email']; ?>" maxlength="20"/></td>
                </tr>

                <tr>
                    <td class="textright"></td>
                    <td align="left"><input type="checkbox" name="issave"
                                            value="1"/><?php echo $m_langpackage->m_add_list; ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td><span><?php echo $m_langpackage->m_sureaddress_rcgoods; ?></span><input type=hidden
                                                                                                name="newadd"
                                                                                                id="newadd" <?php if (empty($address_rs)) { ?>  value="1" <?php } ?> />
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td><span><input type="submit" name="submit"
                                     value="<?php echo $m_langpackage->m_post_order; ?>"/></span></td>
                </tr>
            </table>
