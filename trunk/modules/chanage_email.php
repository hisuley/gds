        ...
        <div class="findpsw">
            <form action="" method="post" name="form1">
                <table class="tab_findpsw">
                    <tr align="center">
                        <td width="100px;"><?php echo $m_langpackage->m_register_username; ?>：</td>
                        <td><input type="text" name="user_name" value=""/></td>
                    </tr>
                    <tr>
                        <td><?php echo $m_langpackage->m_register_password; ?>：</td>
                        <td><input type="password" name="user_password" value=""/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $m_langpackage->m_new_email; ?>：</td>
                        <td><input type="text" name="user_email" value=""/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;<?php echo $m_langpackage->m_fill_code; ?>：</td>
                        <td><input type="text" name="veriCode" id="veriCode" style="width:100px" maxlength="4"/>
                            <img border="0" hight="10px" align="absmiddle" src="servtools/veriCodes.php"
                                 id="verCodePic"><a href="javascript:;"
                                                    onclick="return getVerCode();"><?php echo $i_langpackage->i_change_img; ?></a><SPAN
                                id="veriCode_message"></SPAN></td>
                    </tr>
                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>"/>
                    <tr>
                        <td></td>
                        <td align="center"><input type="button" name="asd" value="<?php echo $m_langpackage->m_send; ?>"
                                                  class="btn_02" onclick="chanage_mail();"/></td>
                    </tr>
                </table>
            </form>
        </div>
