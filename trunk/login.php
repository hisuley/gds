...
<div id="wrapper">
    ...
    <div id="contents" class="clearfix">
        ...
        <form action="do.php?act=login" method="post" name="reg_form">
            <input type="hidden" name="url"
                   value="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : 'index.php'; ?>">
            ...
            <div id="login_leftColumn" class="w_480">
                ...
                <p class="mg12b"><input name="user_email" class="txt_230" type="text" value="<?php echo $iweb_shop; ?>"
                                        maxlength="200"/></p>
                ...
                <?php if ($verifycode['1'] == 1) { ?>
                    ...
                    <p class="vali mg12b">
                        <input type="text" class="txt_230" name="veriCode" id="veriCode" style="width:100px"
                               maxlength="4"/>
                ...
                <div class="login_submit">
                    <INPUT class="btn_02" type="button" value="<?php echo $i_langpackage->i_login; ?>"
                           name=<?php echo $i_langpackage->i_login; ?> onclick='checkcode()'>
                    <span class="go_register"><a
                            href="modules.php?app=forgot"><?php echo $i_langpackage->i_getback_pw; ?>？</a></span>
                </div>
            </div>
        ...
        <div id="login_rightColumn" class="w_475">
            <div class="right_inner">
                <p class="ttlms_tip"><img src="skin/<?php echo $SYSINFO['templates']; ?>/images/login_tip.gif"
                                          alt="<?php echo $i_langpackage->i_login_info; ?>"/></p>
                ...
                <div class="login_submit">
                    <INPUT class="btn_02" type="button" value="<?php echo $i_langpackage->i_register_now; ?>"
                           name=<?php echo $i_langpackage->i_login; ?> onclick="javascript:window.location.href='modules.php?app=reg'"/>
                </div>
            </div>
        </div>
        <!-- /contents -->
    ...
    <script language="JavaScript">
        ...
        function checkForm() {
            ...
            //alert('
            <?php echo  $i_langpackage->i_password_notnone;?>');
            //user_passwd.focus();
            //return false;
            //}
