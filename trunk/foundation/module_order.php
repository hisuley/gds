...
function get_myoder_list(&$dbo, $t_order_info, $t_order_goods, $t_goods, $t_shop_info, $id, $page, $type, $state, $t_users)
{
    ...
    if ($type == 'shop') {
        ...
        if (!empty($state)) {
            switch ($state) {
                case 1:
                    $str .= " and order_status=1 ";
                    break;
                case 2:
                    $str .= " and order_status=2 ";
                    break;
                case 3:
                    $str .= " and pay_status=0 ";
                    break;
                case 4:
                    $str .= " and pay_status=1 ";
                    break;
                case 5:
                    $str .= " and transport_status=0 ";
                    break;
                case 6:
                    $str .= " and transport_status=1 ";
                    break;
                case 7:
                    $str .= " and order_status=3 ";
                    break;
                case 8:
                    $str .= " and transport_status=0 and pay_status=1 ";
                    break;
                case 9:
                    $str .= " and order_status=3 and seller_reply='0' ";
                    break;
            }
        }
...
/* 收到的订单 */
function get_myoder_list_with_search(&$dbo, $t_order_info, $t_order_goods, $t_goods, $t_shop_info, $id, $page, $type, $state, $t_users, $start_time = '', $end_time = '', $order_id = '')
{
    $list = array();
    if ($type == 'shop') {
        $str = "";
