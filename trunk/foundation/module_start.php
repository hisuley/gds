...
/* 我的订单 */
function get_myorder_info_with_search(&$dbo, $t_order_info, $t_shop_info, $t_goods, $t_order_goods, $user_id, $state, $page, $start_time = '', $end_time = '', $order_id = '')
{
    $str = "";
    ...
    if (!empty($end_time)) {
        $str .= " and order_time  <= '$end_time' ";
    }
    if (!empty($state)) {
        switch ($state) {
            case 1:
                $str .= " and o.order_status=1 ";
                break;
            case 2:
                $str .= " and o.order_status=2 ";
                break;
            case 3:
                $str .= " and o.pay_status=0 ";
                break;
            case 4:
                $str .= " and o.pay_status=1 ";
                break;
            case 5:
                $str .= " and o.transport_status=0 ";
                break;
            case 6:
                $str .= " and o.transport_status=1 ";
                break;
            case 7:
                $str .= " and o.order_status=3 ";
                break;
            case 8:
                $str .= " and o.transport_status=1 and o.order_status<>3 ";
                break;
            case 9:
                $str .= " and o.buyer_reply='0' and o.order_status=3 ";
                break;
        }
    }
