...
<div id="leftColumn">
    ...
    <div class="left_top">
        <div class="slide_container" id="idTransformView">
            <ul class="slider" id="idSlider">
                <?php foreach ($images_info as $key => $value) { ?>
                    <li><a href="<?php echo $value['images_link']; ?>" target="_blank"><img
                                src="<?php echo $value['images_url']; ?>" width="664" height="400" alt=""
                                onerror="this.src='skin/default/images/nopic.gif'"/></a></li>
                <?php } ?>
            </ul>
            <ul class="slide_num2" id="idNum2">
                <?php foreach ($images_info as $key => $value) { ?>
        ...
        <ul class="list_adv clearfix">
            <li>
                <script language="JavaScript" src="uploadfiles/asd/1.js"></script>
            </li>
            <li>
                <script language="JavaScript" src="uploadfiles/asd/2.js"></script>
            </li>
            <li>
                <script language="JavaScript" src="uploadfiles/asd/3.js"></script>
            </li>
            <li class="lst">
                <script language="JavaScript" src="uploadfiles/asd/4.js"></script>
            </li>
        </ul>
    </div>
    <div class="content-common-box content-left-big-box content-blue">
        ...
        <div class="content" style="height:70px;">
            ...
            <form class="pretty-form ticket-form" method="POST" action="ticket.php"
                ...
                <div class="column-3">
                    ...
                    <div class="column-8">
                        <input class="column-10 cityinput" id="startCity" type="text" name="DepartCity"
                               onblur="inputTxt2(this,'set', '请输入城市名称');" onfocus="inputTxt2(this,'clean', '请输入城市名称');"
                               value="请输入城市名称">
                        <input class="column-10 cityinput" id="endCity" type="text" name="ArriveCity" value="桂林"
                               readonly/>
                    </div>
                </div>
                <div class="column-1" style="height:1px;width:5%;"></div>
                <div class="column-3">
                    ...
                    <div class="column-8">
                        <input class="column-10" type="text" id="departDateInput" name="DepartDate"
                               onblur="inputTxt2(this,'set', '请选择出发日期');compareDate();"
                               onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'%y-%M-{%d}'});inputTxt2(this,'clean', '请选择出发日期');compareDate();"
                               value="请选择出发日期"/>
                        <input class="column-10" type="text" id="arriveDateInput" name="ArriveDate"
                               onblur="inputTxt2(this,'set', '请选择回程日期');"
                               onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:document.getElementById('departDateInput').value});inputTxt2(this,'clean', '请选择回程日期');"
                               value="请选择回程日期"/>
                    </div>
                </div>
                <div class="column-2">
...
<div id="rightColumn">
    <div class="slide-nav">
        <ul id="idNum">
            <?php foreach ($images_info as $key => $value) { ?>
                <li>
                    <a href="<?php echo $value['images_link']; ?>"><?php echo $value['name']; ?></a><b><?php echo $value['images_desc']; ?></b>
                </li>
            <?php } ?>
            <script type="text/javascript">slide(400);</script>
        </ul>
    ...
    <div class="rules">
        <ul>
            <li><a class="groupbuy" href="article.php?id=33"><?php echo $i_langpackage->i_group_buy_small_shops; ?></a>
            </li>
            <li><a class="credit" href="article.php?id=34"><?php echo $i_langpackage->i_credit_evaluation_system; ?></a>
            </li>
        </ul>
    </div>
    <div class="user_service mg12b">
        <div class="top">
            <div class="line"></div>
            <ul id="tab0">
                <li id="tab0_title0" class="active" onmouseover="nTabs('tab0',this);"><a href=""
                                                                                         hidefocus="true"><?php echo $i_langpackage->i_ammall; ?></a>
                </li>
                <li id="tab0_title1" onmouseover="nTabs('tab0',this);"><a href=""
                                                                          hidefocus="true"><?php echo $i_langpackage->i_amsell; ?></a>
                </li>
            </ul>
        </div>
        <div id="tab0_content0" class="content">
            <ul>
                <?php foreach ($maller as $key => $value) { ?>
                    <li><a href="article.php?id=<?php echo $value['article_id']; ?>"><?php echo $value['title']; ?></a>
                    </li>
                <?php } ?>
            </ul>
        </div>
        ...
        <div class="tags">
            <?php foreach ($tag_list as $value) { ?>
                <a href="<?php echo $value['url']; ?>"
                   style="color:<?php echo $value['tag_color']; ?>;<?php if ($value['is_blod']) { ?>font-weight:800;<?php } ?>"><?php echo $value['tag_name']; ?></a>
            <?php } ?>
        </div>
    </div>
    <div class="popularity bg_gary mg12b content-common-box content-right-middle-box">
        ...
        <div class="content">
            <ul id="promote_goods" class="cls">
                ...
                <?php foreach ($goods_hot as $value) { ?>
                    <li onmouseover="promote_change(this)" <?php if ($i == 1) { ?> class="selected"<?php } ?> >
                        <span class="num"><?php echo $i; ?></span><a title="<?php echo $value['goods_name']; ?>"
                                                                     target="_blank"
                                                                     href="<?php echo goods_url($value['goods_id']); ?>"><img
                                src="<?php echo $value['is_set_image'] ? $value['goods_thumb'] : 'skin/default/images/nopic.gif'; ?>"
                                height="60" width="60"
                                onerror="this.src='skin/default/images/nopic.gif'"><?php echo sub_str($value['goods_name'], 20, false); ?>
                        </a>

                        <div class="price clearfix">
                            <label><b><?php echo $i_langpackage->i_money_sign; ?><?php echo $value['goods_price']; ?><?php echo $i_langpackage->i_yan; ?></b></label>
                        </div>
                    </li>
                    <?php $i++; ?>
                <?php } ?>
    ...
    <div class="shopLogo bg_gary content-common-box content-right-middle-box">
        ...
        <ul class="list_logos clearfix">
            <?php foreach ($brand_rs as $value) { ?>
                <li><a href="brand_info.php?brand_id=<?php echo $value['brand_id']; ?>"><img
                            src="<?php echo $value['brand_logo']; ?>" alt="<?php echo $value['brand_name']; ?>"
                            width="110" height="42" onerror="this.src='skin/default/images/no_page.jpg'"/></a></li>
            <?php } ?>
        </ul>
    </div>
    <!-- /rightColumn -->
...
<div class="shopRecom bg content-common-box">
    ...
    <ul class="clearfix">
        <?php foreach ($shop_info as $value) { ?>
            <li>
                <p class="pic"><a href="<?php echo shop_url($value['shop_id'], 'index', $value['shop_domain']); ?>"><img
                            src="<?php echo $value['shop_logo'] ? $value['shop_logo'] : 'skin/default/images/shop_nologo.gif'; ?>"
                            alt="<?php echo $value['shop_name']; ?>" width="112" height="55"
                            onerror="this.src='skin/default/images/shop_nologo.gif'"/></a></p>

                <p class="shopname"><a
                        href="<?php echo shop_url($value['shop_id'], 'index', $value['shop_domain']); ?>"><?php echo $value['shop_name']; ?></a>
                </p>

                <p class="shopower"><?php echo $i_langpackage->i_seller; ?>：<a
                        href="<?php echo shop_url($value['shop_id'], 'index'); ?>"><?php echo $value['user_name']; ?></a>
                </p>
            </li>
        <?php } ?>
    </ul>
