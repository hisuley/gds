...
<div class="main">
    <form method="post" action="<?php echo $PHP_SELF; ?>">
        ...
        <div class="center">
            ...
            <?php } else { ?>
                <div class="agree"><input type="submit" class="button" value="下一步"/><span>请先认真阅读我们的<a
                            href="protocol.html">《软件使用授权协议》</a></span></div>
            <?php } ?>
            <div class="clear"></div>
        </div>
...
<?php
    ...
    <div class="center">
        ...
        if (!$check) {
            ...
            <input onclick='window.location="<?php echo $PHP_SELF; ?>"' type='button' value='重新检查'>
        <?php } else { ?>
            <div class="agree"><input type="submit" class="button" value="接受授权协议，开始安装"/><span>请先认真阅读我们的<a
                        href="protocol.html">《软件使用授权协议》</a></span></div>
        <?php } ?>
        <div class="clear"></div>
    </div>
    ...
    <div class="center">
        ...
        <table class="data_set">
            ...
            <tr>
                ...
                <td width="38%"><input type="text" class="setup_input" name="isnsurl" value="<?php echo $isnsURL ?>"/>
                </td>
...
//		    	$DATABASESQL=$dbcharset=='gbk'?"DEFAULT CHARACTER SET gbk COLLATE gbk_chinese_ci":"DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci";
    ...
    <div class="center">
        ...
        <div class="agree">
            <div class="btn">
                <div class="btn_right"><a href="../">进入首页</a></div>
            </div>
            <div class="btn">
                <div class="btn_right"><a href="../sysadmin/login.php">直接进入管理后台</a></div>
            </div>
        </div>
    </div>
    <div class="bottom"></div>
