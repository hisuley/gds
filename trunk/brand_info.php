...
//print_r($result);
    ...
    <div id="wrapper">
        ...
        <div id="contents" class="clearfix">
            <div id="sub_channel">
                <ul class="clearfix">
                    <li>
                        <h3><img src="skin/default/images/part/ttl_channel_all.gif"
                                 alt="<?php echo $i_langpackage->i_index; ?>"
                                 onerror="this.src='skin/default/images/nopic.gif'"/></h3>
                    </li>
                    <li><a href="brand_list.php"><?php echo $i_langpackage->i_brand_list; ?></a></li>
                    <li><a><?php echo $brand_info['brand_name']; ?></a></li>
                </ul>
            </div>
            <div class="pro_class brand_intro mg12b">
                <img alt="<?php echo $brand_info['brand_name']; ?>" src="<?php echo $brand_info['brand_logo']; ?>"
                     onerror="this.src='skin/default/images/no_page.jpg'">

                <p><span><?php echo $i_langpackage->i_service_tel; ?>
                        ：</span>400-880-0123<br><span><?php echo $i_langpackage->i_company_website; ?>
                        ：</span><?php echo $brand_info['site_url']; ?>
                </p>

                <p><?php echo $brand_info['brand_desc']; ?></p></div>
            ...
            <div id="leftColumn">
                <div class="SubCategoryBox mg12b">
                    ...
                    <ul>
                        <li><span><?php echo $i_langpackage->i_category; ?>：</span><a
                                class="active"> <?php echo $i_langpackage->i_all; ?></a>
                        ...
                        <ul class="toolbar">
                            <a id="list" class="selected" hidefocus="true" href="javascript:void(0);"
                               onclick="changeStyle2('list',this)"><?php echo $i_langpackage->i_list; ?></a><a
                                id="window" hidefocus="true" href="javascript:void(0);"
                            ...
                            <ul class="list_view">
                                ...
                                <li id="showli_<?php echo $v['goods_id']; ?>" class="clearfix">
                                    <div class="photo"><a target="_blank"
                                                          href="<?php echo goods_url($v['goods_id']); ?>"><img
                                                ...
                                                height="<?php echo $SYSINFO['height1']; ?>"
                                    ...
                                    <div class="operating"><a class="addfavorite"
                                                              ...
                                                              href="<?php echo goods_url($v['goods_id']); ?>"></a>
                                        <a class="itembuy" title="<?php echo $i_langpackage->i_buy; ?>"
                                           href="modules.php?app=user_order&gid=<?php echo $v['goods_id']; ?>&v=1"></a>
                                        <a class="compare" title="<?php echo $i_langpackage->i_contrast; ?>"
                                           href="javascript:;"
                                           onclick="initFloatTips('<?php echo $v['goods_id']; ?>','<?php echo sub_str($v['goods_name'], 10); ?>',1,'<?php echo $v['cat_id']; ?>')"></a>
                                    </div>
                                    <div style="display: none;" id="showbox_<?php echo $v['goods_id']; ?>"
                                         class="showbox">
                    ...
                    <ul>
                        <?php foreach ($goods_hot as $k => $value) { ?>
                            <li <?php if ($k % 2 != 0){ ?>class="doublenum"<?php } ?>>
                                <p class="photo"><a href="<?php echo goods_url($value['goods_id']); ?>" target="_blank"><img
                                            src="<?php echo $value['is_set_image'] ? $value['goods_thumb'] : 'skin/default/images/nopic.gif'; ?>"
                                            alt="<?php echo $value['goods_name']; ?>" width="58" height="58"
                                            onerror="this.src='skin/default/images/nopic.gif'"/></a></p>
                                <h4><a href="<?php echo goods_url($value['goods_id']); ?>"
                                       target="_blank"><?php echo sub_str($value['goods_name'], 14, false); ?></a></h4>
                            ...
                            <li <?php if ($k % 2 != 0){ ?>class="lst"<?php } ?>>
                                <p class="photo">
                                    <a href="<?php echo goods_url($value['goods_id']); ?>">
                                        <img
                                            src="<?php echo $value['is_set_image'] ? $value['goods_thumb'] : 'skin/default/images/nopic.gif'; ?>"
                                            width="58" height="58" onerror="this.src='skin/default/images/nopic.gif'"/>
                                    </a>
                                </p>
    ...
    <div id="contrastbox"
         style="z-index:999;position:absolute;right:0; border:1px solid #f1f1f1; background:#f8f8f8; display:none; width:188px;margin-right:10px;padding:10px 0 12px 13px; ">
        <form action="modules.php?app=contrast" method="post" target="_blank" id="contrastform">
            ...
            <a class="control" onclick="document.getElementById('contrastform').submit();return false;"
               href="javascript:;" class="button_4"><?php echo $i_langpackage->i_start_compare; ?></a>
        </form>
    </div>
