                ...
                <div class="groupShow clearfix">
                    <table class="tab_group " width="100%">
                            ...
                            foreach ($result['result'] as $v) {
                                ...
                                <tr>
                                    <td valign="middle" class="proName">
                                        <div class="photo"><a
                                                href="goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo"><img
                                                    src="<?php echo $v['is_set_image'] ? $v['goods_thumb'] : 'skin/default/images/nopic.gif'; ?>"
                                                    width="95" height="95" alt="<?php echo $v['goods_name']; ?>"
                                                    onerror="this.src='skin/default/images/nopic.gif'"/></a></div>
                                        <div class="proInfo">
                                            <h3 class="mg12b"><a
                                                    href="goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo"><?php echo sub_str($v['group_name'], 22, false); ?></a>
                                            </h3>

                                            <p>[<?php echo $i_langpackage->i_groupbuy_say; ?>
                                                ]<?php echo $v['group_desc']; ?></p>
                                        </div>
                                    </td>
                                    <td class="groupPic"><em
                                            class="pic"><?php echo $i_langpackage->i_money_sign; ?><?php echo $v['spec_price']; ?><?php echo $s_langpackage->s_yan; ?></em>
                                    </td>
                                    <td class="groupQut"><?php echo $v['min_quantity']; ?></td>
                                    <td class="groupName"><a
                                            href="goods.php?id=<?php echo $v['goods_id']; ?>"><?php echo sub_str($v['goods_name'], 22, false); ?></a>
                                    </td>
                        ...
                        <?php } else { ?>
                            ...
                            <td style='text-align:left' colspan="5">&nbsp;<?php echo $i_langpackage->i_no_groupbuy; ?>
                                ！
                            </td>
                            </tr>
                        <?php } ?>
