                        ...
                        <div class="column-3">
                            ...
                            <div class="column-8">
                                <input class="column-10 cityinput" style="background-position:200px 3px;" id="startCity"
                                       ...
                                       onfocus="inputTxt2(this,'clean', '请输入城市名称');" onchange="compareCity();"
                                       onpropertychange="compareCity()" oninput="compareCity()" value="请输入城市名称">
                ...
                <div id="listItems" class="c_m search_box" style="position:relative">
                    <ul class="list_view">
                        <?php if (!empty($ticket_list)) { ?>
                            <?php foreach ($ticket_list as $v) { ?>
                                <li id="showli_<?php echo (string)$v->AirlineCode; ?>" class="clearfix"
                                    style="padding:0px;">
                                    <table class="search_table_header">
                                        ...
                                        <tr>
                                            <td class="logo">
                                                <div class="clearfix">
                                                    <span
                                                        class="pubFlights_<?php echo strtolower((string)$v->AirlineCode); ?> flight_logo"><?php echo translateAirline((string)$v->AirlineCode); ?></span>
				    ...
				    <span class="model">计划机型：<span><?php echo translateCraft((string)$v->CraftType); ?></span>
                                            ...
                                            <td class="right">
                                                <div>
                                                    <strong
                                                        class="time"><?php echo date('H:i', strtotime((string)$v->TakeOffTime)); ?></strong>
                                                </div>
                                                <div>
                                            ...
                                            <td class="left">
                                                <div>
                                                    <strong
                                                        class="time"><?php echo date('H:i', strtotime((string)$v->ArriveTime)); ?></strong>
                                                </div>
                                                <div>
                                            ...
                                            <td>
                                                <div class="low_text">
                                                    <label>燃油+机建：</label><?php echo (string)$v->AdultOilFee; ?>
                                                    元+<?php echo (string)$v->AdultTax; ?>元
                                                </div>
                                                <div class="low_text">
                                                    <label>历史准点率：</label>97%
                                                </div>
                                            </td>
                                            <td class="price" style="padding-top:0px;">
                                                <span
                                                    class="base_price02 flightLowestPrice"><dfn>¥</dfn><?php echo intval((string)$v->StandardPrice); ?></span><i>起</i>
                                            </td>
                                            <td class="special">
                                                <a class="itembuy common-button"
                                                   title="<?php echo $i_langpackage->i_buy; ?>" style="width:60px;"
                                                   href="">购买</a>
                                            </td>
                                        </tr>
                                        </tbody>
