...
function users_read_base($fields = "*", $condition = "", $by_col = "", $order = "", $num = "", $cache = "", $cache_key = "")
{
    global $tablePreStr;
    ...
    $sql = " select $fields from $t_users ";
    $sql .= " where locked=0 ";
    if ($condition != '') {
        $sql .= " $condition ";
    }
...
//用户基本信息
function users_by_uid($fields = "*", $user_id, $by_col = "", $order = "")
{
    ...
    return users_read_base($fields, $condition, $by_col, $order);
}
