 ...
 * 如果您的模板要进行修改，请修改 templates/default/succes.html
 * 如果您的模型要进行修改，请修改 models/succes.php
 *
...
if(filemtime("templates/default/succes.html") > filemtime(__file__) || (file_exists("models/succes.php") && filemtime("models/succes.php") > filemtime(__file__)) ) {
	tpl_engine("default","succes.html",1);
	include(__file__);
} else {
/* debug模式运行生成代码 结束 */
?><?php
...
<head>
<title><?php echo $i_langpackage->i_notice_title;?></title>
