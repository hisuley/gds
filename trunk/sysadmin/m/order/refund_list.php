...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <a
                ...
                href=""><?php echo $a_langpackage->a_refund_list; ?></a></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><?php echo $a_langpackage->a_orderID; ?>：
                                <input class="small-text" type="text" name="order_id" value="<?php echo $order_id; ?>"
                                       style="width:120px"/>
        ...
        <div class="infobox">
            <h3><?php echo $a_langpackage->a_refund_list; ?><span class="right" style="margin-right:15px;"><a
                        href="m.php?app=order_refund_export"><?php echo $a_langpackage->a_refund_export; ?></a></span>
            </h3>
            ...
            <div class="content2">
                <table class="list_table">
                    ...
                    <tr style=" text-align:center">
                        <th width="40px">ID <a href="m.php?app=order_refund_list&orderby=refund_id&orderway=asc">↑</a><a
                                href="m.php?app=order_refund_list&orderby=refund_id&orderway=desc">↓</a></th>
                        <th width="100px"><?php echo $a_langpackage->a_orderID; ?> <a
                                href="m.php?app=order_refund_list&orderby=order_id&orderway=asc">↑</a><a
                                href="m.php?app=order_refund_list&orderby=order_id&orderway=desc">↓</a></th>
                        <th width="90px"><?php echo $a_langpackage->a_refund_way; ?> <a
                                href="m.php?app=order_refund_list&orderby=refund_way&orderway=asc">↑</a><a
                                href="m.php?app=order_refund_list&orderby=refund_way&orderway=desc">↓</a></th>
                    ...
                    <?php if ($result['result']) {
                        foreach ($result['result'] as $value) {
                            ...
                            <tr style=" text-align:center">
                                ...
                                <td><?php echo $value['refund_account']; ?></td>
                                </td>
