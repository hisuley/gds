...
<div id="maincontent">
    <div class="wrap">
        ...
        <div class="infobox">
            <h3><span
                    class="left"><?php echo $a_langpackage->a_order; ?><?php echo $a_langpackage->a_look; ?></span><span
	...
	<span style="text-align:center;" align="middle">
        ...
        <?php } ?>
                ...
                <form action="a.php?act=order_payment_edit" method="post" onsubmit="return checkform();"
                    ...
                    <table class="list_table">
                        ...
                        ?>
                        <tr>
                            <td align="left" colspan="4">&nbsp;&nbsp;<?php echo $a_langpackage->a_fact_pay; ?>
                                ：<?php echo $info['order_amount']; ?></span><?php echo $a_langpackage->a_yuan; ?>&nbsp;&nbsp;<?php echo $a_langpackage->a_should_pay; ?>
                                ：<?php echo $info['order_value']; ?><?php echo $a_langpackage->a_yuan; ?></td>
                        </tr>
                        </tbody>
                    </table>
                    <table class="list_table">
                        ...
                        <tr>
                            <td>&nbsp;&nbsp;<?php echo $a_langpackage->a_shop_area; ?>：</td>
