...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <a
                ...
                href=""><?php echo $a_langpackage->a_account_list; ?></a></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
            ...
            <div class="content2">
                <table class="list_table">
                    ...
                    <tr style=" text-align:center">
                        ...
                        <th width="100"><?php echo $a_langpackage->a_memeber_name; ?>
                            /<?php echo $a_langpackage->a_words_beizhu; ?></th>
                        <th width="100px"><?php echo $a_langpackage->a_admin_name; ?>
                            /<?php echo $a_langpackage->a_words_beizhu; ?></th>
                        <th width="30px"><?php echo $a_langpackage->a_amount; ?></th>
                        <th width="80px"><?php echo $a_langpackage->a_account_addtime; ?>
                            /<?php echo $a_langpackage->a_account_edittime; ?></th>
