...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_pay_port; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                <table class="list_table">
                    ...
                    <tr style="text-align:center;">
                        <th width="30px"><?php echo $a_langpackage->a_payment_id; ?> <a
                                href="m.php?app=order_payment&orderby=pay_id&orderway=asc">↑</a><a
                                href="m.php?app=order_payment&orderby=pay_id&orderway=desc">↓</a></th>
                        <th width="90px" align="left"><?php echo $a_langpackage->a_port_name; ?>  <a
                                href="m.php?app=order_payment&orderby=pay_name&orderway=asc">↑</a><a
                                href="m.php?app=order_payment&orderby=pay_name&orderway=desc">↓</a></th>
                        ...
                        <th style="width:70px;"><?php echo $a_langpackage->a_now_status; ?>  <a
                                href="m.php?app=order_payment&orderby=enabled&orderway=asc">↑</a><a
                                href="m.php?app=order_payment&orderby=enabled&orderway=desc">↓</a></th>
                    ...
                    <?php foreach ($payment as $value) { ?>
                        <tr style="text-align:center;">
                            ...
                            <td id="now_status_<?php echo $value['pay_id']; ?>"><?php if ($value['enabled']) {
                                    echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                                } else {
                                    echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                                } ?></td>
                            <td onclick="toggle(this,<?php echo $value['pay_id']; ?>)"
                                style="cursor:pointer;text-decoration:underline;"><?php if ($value['enabled']) {
                    ...
                    <tbody>
                    <tr>
                        <td colspan="7"><?php echo $a_langpackage->a_notice1; ?>
                            <br/>　　　<?php echo $a_langpackage->a_notice2; ?>
                            <br/>　　　<?php echo $a_langpackage->a_notice3; ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
