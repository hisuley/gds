...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_protect_rights; ?>&gt;&gt; 维权查看
        </div>
        <hr/>
        <div class="infobox">
            <h3><span class="left">维权查看</span><span class="right" style="margin-right:15px;"><a
                        href="m.php?app=protect_rights" style="float: right;">返回维权列表</a></span></h3>
                        ...
                        foreach ($result as $v) {
                            ...
                            <tr style="text-align:center;">
                                <td align="left" width="270px">
                                    &nbsp;&nbsp;<?php echo str_replace("<img src=\"", "<img src=\"../", $v['content']); ?></td>
                            </tr>
                            </tbody>
                        <?php }
                    } ?>
