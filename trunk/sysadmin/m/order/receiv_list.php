...
<div id="maincontent">
 <?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_m_order_mengament;?></a> &gt;&gt; <a href=""><?php echo $a_langpackage->a_receiv_list;?></a></div>
        <hr />
	<div class="seachbox">
        <div class="content2">
	...
	<div class="infobox">
	<h3><?php echo $a_langpackage->a_receiv_list;?><span class="right" style="margin-right:15px;"><a href="m.php?app=order_receiv_export"><?php echo $a_langpackage->a_receiv_export;?></a></span></h3>
    <div class="content2">
		<table class="list_table">
			<thead>
			<tr style=" text-align:center">
				<th width="100px"><?php echo $a_langpackage->a_orderID;?></th>
				<th width="100px"><?php echo $a_langpackage->a_receiv_payid;?></th>
				<th width="90px"><?php echo $a_langpackage->a_payment_type;?></th>
				<th width="120px"><?php echo $a_langpackage->a_pay_date;?></th>
				<th width="40px"><?php echo $a_langpackage->a_receiver;?></th>
				<th width="120px"><?php echo $a_langpackage->a_receiv_date;?></th>
				<th width="150px"><?php echo $a_langpackage->a_receiv_account;?></th>
                                <th width="45px"><?php echo $a_langpackage->a_receiv_money;?></th>
			...
			<tr style=" text-align:center">
				...
				<td><?php echo $value['pay_date'];?></td></td>
