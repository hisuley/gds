...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <a
                ...
                href=""><?php echo $a_langpackage->a_alllist; ?></a></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                            ...
                            <td><?php echo $a_langpackage->a_orderID; ?>：
                                ...
                                <select name="pay_id">
                                    ...
                                    <?php foreach ($payment as $value) { ?>
                                        <option
                                            value="<?php echo $value['pay_id']; ?>" <?php if ($pay_id == $value['pay_id']) {
                                            echo "selected";
                                        } ?> ><?php echo $value['pay_name']; ?></option>
                                    <?php } ?>
                                </select>
                                <?php echo $a_langpackage->a_order_status; ?>：
                                <select name="order_status">
                                    <option value="99"><?php echo $a_langpackage->a_all; ?></option>
                                    <option value="1" <?php if ($order_status == 1) {
                                        echo "selected";
                                    } ?> >下单成功
                                    </option>
                                    <option value="2" <?php if ($order_status == 2) {
                                        echo "selected";
                                    } ?> >处理中
                                    </option>
                                    <option value="3" <?php if ($order_status == 3) {
                                        echo "selected";
                                    } ?> >已完成
                                    </option>
                                    <option value="0" <?php if ($order_status == 0) {
                                        echo "selected";
                                    } ?> ><?php echo $a_langpackage->a_order_cancelled; ?></option>

                                </select>
                                <?php echo $a_langpackage->a_pay; ?><input type="checkbox" name="pay_status"
                                                                           value="1" <?php if ($pay_status) echo "checked"; ?> />
                                <?php echo $a_langpackage->a_send_goods; ?><input type="checkbox"
                                                                                  name="transport_status"
                                                                                  value="1" <?php if ($transport_status) echo "checked"; ?> />
                        ...
                        <tr>
                            ...
                            <td><?php echo $a_langpackage->a_shop_time; ?>：
                                ...
                                <input class="Wdate" type="text" name="end_time" id="end_time"
                                       onFocus="WdatePicker({isShowClear:false,readOnly:true})"
                                       value="<?php echo $end_time; ?>"/>　<input class="regular-button" type="submit"
    ...
    <div class="content2">
		...
		<table class="list_table">
			...
			<tr style=" text-align:center">
				<th width="5px"><input type="checkbox" onclick="checkall(this,'order_id[]');" /></th>
			...
			<tr style=" text-align:center">
				...
				<td align="left">
					<?php echo $a_langpackage->a_shop_name2;?>:<a href="../shop.php?shopid=<?php echo $value['shop_id'];?>" target="_blank"><?php echo $value['shop_name'];?>
				</td>
				<td><?php echo $value['transport_price'];?></td>
				...
				<td>
				 ...
				 <?php 
	            	if($value['order_status']==0){
						...
						} elseif($value['protect_status']==1) {
							echo "<span class='red'>维权中</span><br />";
						}elseif($value['protect_status']==2) {
							echo "<span class='red'>同意维权</span><br />";
						} elseif($value['protect_status']==3) {
							...
							if($value['pay_status']==0) {
								...
								if($value['transport_status']) {
									echo "<span class='red'>".$a_langpackage->a_send_goods."</span><br /> ";
								} else {
									echo "<span class='red'>".$a_langpackage->a_not_send_goods."</span><br />";
								}
							}	
					}
                ...
                <form action="a.php?act=order_set_status" name="postForm" method="post" onsubmit="return submitform();">
                    <table class="list_table">
                        ...
                        <tr style=" text-align:center">
                            <th width="5px"><input type="checkbox" onclick="checkall(this,'order_id[]');"/></th>
                            <th width="115px"><?php echo $a_langpackage->a_orderID; ?></th>
                            <th width="" align="left"><?php echo $a_langpackage->a_goods; ?>
                                /<?php echo $a_langpackage->a_shop_name2; ?></th>
                            <th width="90px"><?php echo $a_langpackage->a_goods_price; ?>
                                /<?php echo $a_langpackage->a_trans_price; ?></th>
                            <th width="120px"><?php echo $a_langpackage->a_order_num; ?>
                                /<?php echo $a_langpackage->a_order_count; ?></th>
                            <th width="115px"><?php echo $a_langpackage->a_gather_mode; ?>
                                /<?php echo $a_langpackage->a_order_time; ?></th>
                            <th width="60px"><?php echo $a_langpackage->a_status; ?></th>
                            <th width="60px">二维码</th>
                            <th width="45px"><?php echo $a_langpackage->a_operate; ?></th>
                        </tr>
                            ...
                            foreach ($result['result'] as $value) {
                                ...
                                <tr style=" text-align:center">
                                    <td><input type="checkbox" name="order_id[]"
                                               value="<?php echo $value['order_id']; ?>"/></td>
                                    <td><font size="-6"><?php echo $value['payid']; ?></font></td>
                                    <td align="left">
                                        <?php echo $a_langpackage->a_shop_name2; ?>:<a
                                            href="../shop.php?shopid=<?php echo $value['shop_id']; ?>"
                                            target="_blank"><?php echo $value['shop_name']; ?>
                                    </td>
                                    <td><?php echo $value['transport_price']; ?></td>
                                    <td><?php echo $value['order_amount']; ?></td>
                                    <td><?php echo $value['pay_name']; ?>
                                        <br/><?php echo substr($value['order_time'], 0, 16); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if ($value['order_status'] != 0 && $value['order_status'] != 3) { ?>
                                            <a href="m.php?app=order_update&id=<?php echo $value['order_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                                            <br/>
                                        <?php } ?>
                                        <a href="m.php?app=order_view&id=<?php echo $value['order_id']; ?>"><?php echo $a_langpackage->a_look; ?>
                                            <br/>
                                            <a target="_blank"
                                               href="<?php echo $SYSINFO['web']; ?>/do.php?act=user_getbarcode&order_id=<?php echo $value['order_id']; ?>">二维码
                                            </a>
                                    </td>
                                </tr>
                            <?php }
...
>>>>>>> remotes/origin/master
					<select name="status">
                        <option
                            value="0"><?php echo $a_langpackage->a_select; ?><?php echo $a_langpackage->a_status; ?></option>
                        ...
                        <option value="notransport"><?php echo $a_langpackage->a_not_send_goods; ?></option>
                                ...
                                <span class="button-container"><input class="regular-button" type="submit" name="pay"
                                                                      value="<?php echo $a_langpackage->a_set; ?><?php echo $a_langpackage->a_status; ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<script language="JavaScript">
    ...
    function submitform() {
        ...
        var checknum = 0;
        if (status.value == 0) {
            ShowMessageBox("<?php echo $a_langpackage->a_select_status;?>", '0');
            return false;
        } else {
            ...
            if (checknum == 0) {
                ShowMessageBox("<?php echo $a_langpackage->a_select_at_least;?>", '0');
                return false;
            }
        }
        return true;
