...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_receiv_export; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_receiv_export; ?></span><span class="right"
                                                                                              style="margin-right:15px;"><a
                        href="m.php?app=order_receiv_list"><?php echo $a_langpackage->a_receiv_list; ?></a></span></h3>

            <div class="content2">
                <form method="post" action="a.php?act=order_receiv_export" name="cvsform"
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_receiv_export; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
