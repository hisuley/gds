...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;<?php echo $u_langpackage->u_temp_admin; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                ...
                <table class="list_table">
                    <tbody>
                    <tr>
                        <td><?php echo $u_langpackage->u_prompt_inf; ?>：</td>
                    </tr>
                    <tr>
                        <td>
                            &nbsp;<?php echo $u_langpackage->u_prompt_1; ?><br/>
                            &nbsp;<?php echo str_replace('{default}', $templ['value'], $u_langpackage->u_prompt_2); ?>
                            <br/>
                ...
                <table>
                    <tbody>
                    <tr>
                        <td colspan="3"><?php echo $u_langpackage->u_runing; ?><span style="color:red;"
                                                                                     id="now_mode"><?php if ($template_mode['value'] == 'service') { ?><?php echo $u_langpackage->u_service; ?><?php } else { ?><?php echo $u_langpackage->u_debug; ?><?php } ?></span><?php echo $u_langpackage->u_run; ?>
                            ) &nbsp;&nbsp; <span id="ajax_loading"></span></td>
                    </tr>
                    <tr>
                        <td><?php echo $u_langpackage->u_debug; ?>:</td>
                        <td><?php echo $u_langpackage->u_debug_caution; ?></td>
                        <td><span class="button-container"><input class="regular-button" type="button"
                                                                  value="<?php echo $u_langpackage->u_app; ?>"
                                                                  onclick="template_mode('debug');"/></span></td>
                    </tr>
                    <tr>
                        ...
                        <td><span class="button-container"><input class="regular-button" type="button"
                                                                  value="<?php echo $u_langpackage->u_app; ?>"
                                                                  onclick="template_mode('service');"/></span></td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
<script language="JavaScript">
    ...
    function template_mode(v) {
        if (v == t_mode) {
            ShowMessageBox("<?php echo $u_langpackage->u_present; ?>" + v + "<?php echo $u_langpackage->u_mode_run; ?>", '0');
            return;
        } else {
