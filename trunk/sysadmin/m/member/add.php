...
<div class="title"><span class="more"><a href="m.php?app=member_list"><?php echo $a_langpackage->a_memeber_list; ?></a>&nbsp;&nbsp;</span>
    &nbsp;&nbsp;<?php echo $a_langpackage->a_mana_center; ?>
    <span> - <?php echo $a_langpackage->a_memeber_info_update; ?></span></div>
<form action="a.php?act=member_info_edit" method="post">
    <table class="content">
        <tr>
            <td width="40%" class="right"><?php echo $a_langpackage->a_memeber_name; ?>：</td>
            <td><input type="text" name="user_name" value="<?php echo $user_info['user_name']; ?>"/> <span
                    id="user_email_message"></span></td>
        </tr>
        <tr>
            <td width="40%" class="right"><?php echo $a_langpackage->a_memeber_email; ?>：</td>
            <td><input type="text" name="user_email" value="<?php echo $user_info['user_email']; ?>"/> <span
                    id="user_email_message"></span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2" class="center"><input type="submit" name="submit"
                                                  value="<?php echo $a_langpackage->a_update_user_info; ?>"/></td>
        </tr>
    </table>
</form>
