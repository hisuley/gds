...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_memeber_info_update; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_memeber_info_update; ?></span> <span class="right"
                                                                                                     style="margin-right:15px;"><a
                        href="m.php?app=member_list"
                        style="float: right;"><?php echo $a_langpackage->a_memeber_list; ?></a></span></h3>
                ...
                <form action="a.php?act=member_info_edit" method="post">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="user_email"
                                       value="<?php echo $user_info['user_email']; ?>"/> <span
                                    id="user_email_message"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="small-text" type="password"
                                       name="password"/> <?php echo $a_langpackage->a_user_notupdate; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_email_check; ?>：</td>
                            <td><input type="checkbox" name="email_check"
                                       value="1" <?php if ($user_info['email_check']) {
                                    echo 'checked';
