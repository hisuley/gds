...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_member_oprate;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_m_member_points_set;?></a></div>
        <hr />
	<div class="infobox">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><input class="small-text" type="text" name="sysinfo[reg_points]" value="<?php echo $SYSINFO['reg_points']; ?>" style="width:200px;" /><?php echo $a_langpackage->a_give_specified_points;?></td>
			</tr>
			<tr>
				<th><?php echo $a_langpackage->a_perfect_information_presented_integral;?>：</th>
				<td><input class="small-text" type="text" name="sysinfo[info_points]" value="<?php echo $SYSINFO['info_points']; ?>" style="width:200px;" /><?php echo $a_langpackage->a_give_specified_points;?></td>
			</tr>
			<tr>
				<th><?php echo $a_langpackage->a_binding_email_presented_integral;?>：</th>
				<td><input class="small-text" type="text" name="sysinfo[email_points]" value="<?php echo $SYSINFO['email_points']; ?>" style="width:200px;" /><?php echo $a_langpackage->a_give_specified_points;?></td>
			</tr>
			<tr>
				<th><?php echo $a_langpackage->a_binding_phone_presented_integral;?>：</th>
				<td><input class="small-text" type="text" name="sysinfo[phone_points]" value="<?php echo $SYSINFO['phone_points']; ?>" style="width:200px;" /><?php echo $a_langpackage->a_give_specified_points;?></td>
			</tr>
			<tr>
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th></th>
	                <td><span class="button-container"><input type="submit" class="regular-button" name="submit" value="<?php echo $a_langpackage->a_update_points_set;?>" /></span></td>
				</tr>
			</tbody>
		</table>
	</form>
