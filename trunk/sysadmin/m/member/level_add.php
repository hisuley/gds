...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_user_level_add ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_user_level_add ?></span> <span class="right"
                                                                                               style="margin-right:15px;"><a
                        href="m.php?app=member_level_list"
                        style="float: right;"><?php echo $a_langpackage->a_m_user_level_list ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=member_level_add" method="post" onsubmit="return checkForm();"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="small-text" type="text" name="pointBegin" style="width:40px"> ～ <input
                                    class="small-text" type="text" name="pointEnd" style="width:40px"> <span>*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                                      value="<?php echo $a_langpackage->a_user_level_add ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
