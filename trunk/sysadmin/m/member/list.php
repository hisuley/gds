...
=======
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_memeber_list; ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                <form action="m.php?app=member_list" name="searchForm" method="get">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><?php echo $a_langpackage->a_memeber_name; ?>： <input type="text" class="small-text"
                                                                                      name="name"
                                                                                      value="<?php echo $name; ?>"
                                                                                      style="width:100px"/> <?php echo $a_langpackage->a_memeber_email; ?>
                                ：<input type="text" class="small-text" name="email" value="<?php echo $email; ?>"
                                        style="width:100px"/> &nbsp;&nbsp;会员状态：
                                <select name='user_status'>
                                    <option value="2">全部</option>
                                    <option value="0" <?php if ($user_status == '0') echo "selected" ?>>正常</option>
                                    <option value="1" <?php if ($user_status == '1') echo "selected" ?>>锁定</option>
                                ...
                                <select name='user_rank_id'>
                                    ...
                                    foreach ($userrank as $value) {
                                        ?>
                                        <option
                                            value="<?php echo $value['rank_id']; ?>" <?php if ($user_rank_id == $value['rank_id']) echo "selected" ?>><?php echo $value['rank_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td> 创建时间： <input class="Wdate" type="text" name="start_time" id="start_time"
                        ...
                        <tr>
                            <td></td>
                            <td>联系人： <input type="text" class="small-text" name="user_truename"
                                            value="<?php echo $user_truename; ?>" style="width:100px"/>
                                手机号： <input type="text" class="small-text" name="user_mobile"
                                            value="<?php echo $user_mobile; ?>" style="width:100px"/>
                                地 址： <input type="text" class="small-text" name="user_address"
                                            value="<?php echo $user_address; ?>" style="width:100px"/>
                                用户等级： <select name='user_level_id'>
                                    <option value="0">选择等级</option>
                                    <?php
                                    foreach ($userlevel as $value) {
                                        ?>
                                        <option
                                            value="<?php echo $value['level_id']; ?>" <?php if ($user_level_id == $value['level_id']) echo "selected" ?>><?php echo $value['level_name']; ?></option>
                                    <?php } ?>
                                </select>
                                备 注： <input type="text" class="small-text" name="user_notes"
                                            value="<?php echo $user_notes; ?>" style="width:100px"/>
                                &nbsp;&nbsp;<input type="hidden" name="app" value="member_list"/> <input type="submit"
            ...
            <div class="content2">
                <form action="m.php?app=member_list" id="form1" method="get">
                    <table class="list_table">
                        ...
                        <tr style="text-align:center;">
                            <th width="2x"><input type="checkbox" onclick="checkall(this,'user_id[]');" value=''/></th>
                            <th width="160px" align="left"><?php echo $a_langpackage->a_memeber_name; ?>
                                /<?php echo $a_langpackage->a_memeber_email; ?> <a
                                    href="m.php?app=member_list&orderby=user_name&orderway=asc">↑</a><a
                                    href="m.php?app=member_list&orderby=user_name&orderway=desc">↓</a></th>
                            <th width="275px"><?php echo $a_langpackage->a_register_time; ?>
                                / <?php echo $a_langpackage->a_last_login_time; ?> <a
                                    href="m.php?app=member_list&orderby=last_login_time&orderway=asc">↑</a><a
                                    href="m.php?app=member_list&orderby=last_login_time&orderway=desc">↓</a></th>
                            <th width="110px"><?php echo $a_langpackage->a_last_login_IP; ?> <a
                                    href="m.php?app=member_list&orderby=last_ip&orderway=asc">↑</a><a
                                    href="m.php?app=member_list&orderby=last_ip&orderway=desc">↓</a></th>
                            <th width="276px"><?php echo $a_langpackage->a_email_check; ?>
                                / <?php echo $a_langpackage->a_user_rank; ?> <a
                                    href="m.php?app=member_list&orderby=rank_id&orderway=asc">↑</a><a
                                    href="m.php?app=member_list&orderby=rank_id&orderway=desc">↓</a></th>
                            <th width="45px"><?php echo $a_langpackage->a_status; ?></a> <a
                                    href="m.php?app=member_list&orderby=u.locked&orderway=asc">↑</a><a
                                    href="m.php?app=member_list&orderby=u.locked&orderway=desc">↓</a></th>
                            <th width="80px"><?php echo $a_langpackage->a_operate; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if ($result['result']) {
                                ...
                                <tr style=" text-align:center;">
                                    ...
                                    <?php } else { ?>
                                        <td class="red center"><?php echo $a_langpackage->a_unverify; ?><br/>
                                            <?php echo $userrank[$value['rank_id']]['rank_name']; ?></td>
                                    <?php } ?>
                                    <td class="center"><?php if (@$value['locked'] == 1) {
                                            echo "<span style='color:red;'>" . $a_langpackage->a_lock . "</span>";
                                        } else {
                                            echo "<span style='color:green;'>" . $a_langpackage->a_normal . "</span>";
                                        } ?></td>
                                    <td class="center"><a
                                            href="m.php?app=member_reinfo&id=<?php echo $value['user_id']; ?>"><?php echo $a_langpackage->a_update; ?></a><br/>
                                        <?php if (@$value['locked'] == 1) { ?>
                                            <a href="a.php?act=member_unlock&id=<?php echo $value['user_id']; ?>"
                                               onclick="return confirm('<?php echo $a_langpackage->a_sure_member_unlock; ?>');"><?php echo $a_langpackage->a_unlock; ?></a>
                                        <?php } else { ?>
                                            <a href="a.php?act=member_locked&id=<?php echo $value['user_id']; ?>"
                                               onclick="return confirm('<?php echo $a_langpackage->a_sure_member_lock; ?>');"><?php echo $a_langpackage->a_lock; ?></a>
                                        <?php } ?><br/>
                                        <a href="m.php?app=member_view&id=<?php echo $value['user_id']; ?>"><?php echo $a_langpackage->a_view; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
                                <td colspan="10"><span class="button-container"><input class="regular-button"
                                                                                       type='button'
                                                                                       onclick='jump_diff("a.php?act=member_locked");'
                                                                                       name=""
                                                                                       value="<?php echo $a_langpackage->a_batch_lock; ?>"/></span>
                                    <span class="button-container"><input class="regular-button" type='button'
                                                                          onclick='jump_diff("a.php?act=member_unlock");'
                                                                          name=""
                                                                          value="<?php echo $a_langpackage->a_batch_unlock; ?>"/></span>
                                </td>
                            </tr>
                        <?php } else { ?>
                            <tr>
