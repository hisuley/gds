		...
		<table class="list_table">
		 ...
		 <tbody>
			...
			<tr style="text-align:center;">
				...
				<td align="left">
				<div onclick="edit(this,<?php echo $value['rank_id'];?>,'divlink<?php echo $value['rank_id'];?>','a.php?act=updateAjax','tablename=user_rank&colname=rank_name&idname=rank_id&idvalue=<?php echo $value['rank_id'];?>&logcontent=修改用户等级名称&colvalue=',20);"><?php echo $value['rank_name'];?></div>
			...
			<?php }?>
			<tr>
				<td colspan="5"><span class="button-container"><input class="regular-button" type="submit" name=""  onclick="return delcheck();" value="<?php echo $a_langpackage->a_batch_del?>" /></span></td>
			</tr>
			<?php } else { ?>
			<tr>
				<td colspan="7"></td>
