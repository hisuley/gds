...
if ($user_info['user_gender'] == 0) {
    $user_gender0 = 'checked';
} else {
    $user_gender0 = '';
}
if ($user_info['user_gender'] == 1) {
    $user_gender1 = 'checked';
} else {
    $user_gender1 = '';
}
if ($user_info['user_gender'] == 2) {
    $user_gender2 = 'checked';
} else {
    $user_gender2 = '';
}

if ($user_info['user_marry'] == 0) {
    $user_marry0 = 'checked';
} else {
    $user_marry0 = '';
}
if ($user_info['user_marry'] == 1) {
    $user_marry1 = 'checked';
} else {
    $user_marry1 = '';
}
if ($user_info['user_marry'] == 2) {
    $user_marry2 = 'checked';
} else {
    $user_marry2 = '';
}
...
<div id="maincontent">
<div class="wrap">
<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_member_oprate; ?>
    &gt;&gt; <?php echo $a_langpackage->a_memeber_view; ?></div>
<hr/>
<div class="infobox">
<h3><span class="left"><?php echo $a_langpackage->a_memeber_view; ?></span> <span class="right"
                                                                                  style="margin-right:15px;"><a
            href="m.php?app=member_list" style="float: right;"><?php echo $a_langpackage->a_memeber_list; ?></a></span>
</h3>
...
<table class="list_table" style="float:left; width:32%; margin-right:2%">
    ...
    <tr>
        ...
        <td><input class="small-text" type="text" name="user_email" value="<?php echo $user_info['user_email']; ?>"/>
            <span id="user_email_message"></span></td>
    </tr>
    <tr>
        ...
        <td><select name="rank_id">
                <?php foreach ($userrank as $value) { ?>
                    <option
                        value="<?php echo $value['rank_id']; ?>" <?php if ($value['rank_id'] == $user_info['rank_id']) echo "selected"; ?>><?php echo $value['rank_name']; ?></option>
                <?php } ?>
            </select></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_user_password; ?>：</td>
        <td><input class="small-text" type="password" name="password"/> <?php echo $a_langpackage->a_user_notupdate; ?>
        </td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_integral; ?>：</td>
        <td><input class="small-text" type="text" name="user_integral"
                   value="<?php echo $user_info['user_integral']; ?>"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_integral_surplus; ?>：</td>
        <td><input class="small-text" type="text" name="user_integral_surplus"
                   value="<?php echo $user_info['user_integral_surplus']; ?>"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_money; ?>：</td>
        <td><input class="small-text" type="text" name="user_money" value="<?php echo $user_info['user_money']; ?>"/>
        </td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_email_check; ?>：</td>
        <td><input type="checkbox" name="email_check" value="1" <?php if ($user_info['email_check']) {
                echo 'checked';
            } ?> /><?php echo $a_langpackage->a_user_pass_verify; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="locked_status" value="1" <?php if ($user_info['locked']) {
                echo 'checked';
            } ?> /><?php echo $a_langpackage->a_lock; ?></td>
    </tr>
    </tbody>
</table>
<table class="list_table" style="float:left; width:32%;">
    ...
    <tr>
        ...
        <td><input class="small-text" type="text" name="user_truename"
                   value="<?php echo $user_info['user_truename']; ?>"/></td>
    </tr>
    <tr>
        ...
        <td>
            <select name="Y">
                ...
                <?php for ($i = 1950; $i <= date("Y"); $i++) { ?>
                    <option value="<?php echo $i; ?>" <?php if ($Y == $i) {
                        echo 'selected';
                    } ?>><?php echo $i; ?></option>
                <?php } ?>
            </select>
            <select name="M">
                ...
                <?php for ($i = 1; $i <= 12; $i++) { ?>
                    <option value="<?php echo $i; ?>" <?php if ($M == $i) {
                        echo 'selected';
                    } ?>><?php echo $i; ?></option>
                <?php } ?>
            </select>
            <select name="D">
                ...
                <?php for ($i = 1; $i <= 31; $i++) { ?>
                    <option value="<?php echo $i; ?>" <?php if ($D == $i) {
                        echo 'selected';
                    } ?>><?php echo $i; ?></option>
                <?php } ?>
            </select>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="user_gender"
                   value="0" <?php echo $user_gender0; ?> /> <?php echo $a_langpackage->a_memeber_secret; ?>
            <input type="radio" name="user_gender"
                   value="1" <?php echo $user_gender1; ?> /> <?php echo $a_langpackage->a_memeber_man; ?>
            <input type="radio" name="user_gender"
                   value="2" <?php echo $user_gender2; ?> /> <?php echo $a_langpackage->a_memeber_woman; ?>
        </td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_marry; ?>：</td>
        <td>
            <input type="radio" name="user_marry"
                   value="0" <?php echo $user_marry0; ?> /><?php echo $a_langpackage->a_memeber_secret; ?>
            <input type="radio" name="user_marry"
                   value="1" <?php echo $user_marry1; ?> /><?php echo $a_langpackage->a_memeber_unmarried; ?>
            <input type="radio" name="user_marry"
                   value="2" <?php echo $user_marry2; ?> /><?php echo $a_langpackage->a_memeber_married; ?></td>

    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_mobile; ?>：</td>
        <td><input class="small-text" type="text" name="user_mobile" value="<?php echo $user_info['user_mobile']; ?>"
                   maxlength="20"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_tel; ?>：</td>
        <td><input class="small-text" type="text" name="user_telphone"
                   value="<?php echo $user_info['user_telphone']; ?>" maxlength="20"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="user_address" value="<?php echo $user_info['user_address']; ?>"
                   style="width:250px;" maxlength="200"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_zipcode; ?>：</td>
        <td><input type="text" name="user_zipcode" value="<?php echo $user_info['user_zipcode']; ?>" maxlength="6"/>
        </td>
    </tr>
    <tr>
        <input type="hidden" name="user_id" value="<?php echo $user_info['user_id']; ?>">
        <td colspan="2"><span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                              value="<?php echo $a_langpackage->a_update_user_info; ?>"/></span>
        </td>
    </tr>
    </tbody>
</table>
<table class="list_table" style="float:left; width:32%; margin-right:2%">
    ...
    <tr>
        <td colspan="2"><a
                href="m.php?app=order_alllist&user_id=<?php echo $user_info['user_id']; ?>"><?php echo $a_langpackage->a_memeber_orderinfo; ?></a>
        </td>
        <td></td>
    </tr>
    <tr>
        <td colspan="2"><a
                href="m.php?app=order_account&user_id=<?php echo $user_info['user_id']; ?>"><?php echo $a_langpackage->a_memeber_account; ?></a>
        </td>
        <td></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" class="small-text" name="user_notes" value="<?php echo $user_info['user_notes']; ?>"/>
        </td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_do_amount_note; ?>：</td>
        <td><input class="small-text" type="text" name="amount_notes"
                   values="<?php echo $user_info['amount_notes']; ?>"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_do_point_note; ?>：</td>
        <td><input class="small-text" type="text" name="point_notes" values="<?php echo $user_info['point_notes']; ?>"/>
        </td>
    </tr>
    </tbody>
</table>
