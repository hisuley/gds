...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_user_level_edit ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_user_level_edit ?></span> <span class="right"
                                                                                                style="margin-right:15px;"><a
                        href="m.php?app=member_level_list"
                        style="float: right;"><?php echo $a_langpackage->a_m_user_level_list ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=member_level_edit" method="post" onsubmit="return checkForm();"
                      enctype="multipart/form-data">
                    <table class="form-table">
                        <tbody>
                        <tr>
                            <td style="width:85px;"><?php echo $a_langpackage->a_user_level_name ?>：</td>
                            <td><input class="small-text" type="text" name="level_name"
                                       value="<?php echo $level_info['level_name']; ?>"> <span>*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_user_level_points ?>：</td>
                            <td>
                                <input class="small-text" type="text" name="pointBegin" style="width:40px"
                                       value="<?php echo $level_info['pointBegin']; ?>"/> ～ <input class="small-text"
                                                                                                   type="text"
                                                                                                   name="pointEnd"
                                                                                                   style="width:40px"
                                                                                                   value="<?php echo $level_info['pointEnd']; ?>"/>
                                <span>*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><input type="hidden" name="level_id"
                                                   value="<?php echo $level_info['level_id']; ?>">
                                <span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                                      value="<?php echo $a_langpackage->a_user_level_edit ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
