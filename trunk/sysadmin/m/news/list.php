...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content; ?>
            &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_list; ?></a></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                <form action="m.php?app=news_list" name="searchForm" method="get">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td width="650px">
                                <?php echo $a_langpackage->a_news_title; ?>： <input type="text" class="small-text"
                                                                                    name="title"
                                ...
                                <select name="id">
                                    ...
                                    <?php foreach ($cat_dg as $value) { ?>
                                        <option
                                            value="<?php echo $value['cat_id']; ?>" <?php if ($cat_id == $value['cat_id']) {
                                            echo "selected";
                            ...
                            <td><input type="hidden" name="app" value="news_list"><input class="regular-button"
                                                                                         type="submit"
        ...
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_news_list; ?></span><span class="right"
                                                                                          style="margin-right:15px;"><a
                        href="m.php?app=news_add"><?php echo $a_langpackage->a_news_add; ?></a></span></h3>
                ...
                <form action="a.php?act=news_del" name="form1" id="form1" method="post">
                    ...
                    <table class="list_table" style="table-layout:fixed;">
                        ...
                        <tr style="text-align:center">
                            <th width="20px"><input type="checkbox" onclick="checkall(this,'article_id[]');" value=''/>
                            </th>
                            <th width="40px">ID <a href="m.php?app=news_list&orderby=article_id&orderway=asc">↑</a><a
                                    href="m.php?app=news_list&orderby=article_id&orderway=desc">↓</a></th>
                            <th align="left" width="150px"><?php echo $a_langpackage->a_news_title; ?> <a
                                    href="m.php?app=news_list&orderby=title&orderway=asc">↑</a><a
                                    href="m.php?app=news_list&orderby=title&orderway=desc">↓</a></th>
                            <th align="left" width="110px"><?php echo $a_langpackage->a_news_category; ?> <a
                                    href="m.php?app=news_list&orderby=cat_id&orderway=asc">↑</a><a
                                    href="m.php?app=news_list&orderby=cat_id&orderway=desc">↓</a></th>
                            ...
                            <th width="60px"><?php echo $a_langpackage->a_title_desc; ?> <a
                                    href="m.php?app=news_list&orderby=short_order&orderway=asc">↑</a><a
                                    href="m.php?app=news_list&orderby=short_order&orderway=desc">↓</a></th>
                        ...
                        ?>
                        <tr style="text-align:center">
                            <td><input type="checkbox" name="article_id[]" value="<?php echo $value['article_id']; ?>"/>
                            </td>
                            <td><?php echo $value['article_id']; ?></td>
                            <td class="limit" align="left">
                                <?php if ($value['is_blod'] && $value['tag_color']) { ?>
                                    <span><a href="m.php?app=news_edit&id=<?php echo $value['article_id']; ?>"
                                             style="color:<?php echo $value['tag_color']; ?>"><b><?php echo $value['title']; ?></b></a></span>
                                <?php } else if ($value['is_blod']) { ?>
                                    <span><a
                                            href="m.php?app=news_edit&id=<?php echo $value['article_id']; ?>"><b><?php echo $value['title']; ?></b></a></span>
                                <?php } else if ($value['tag_color']) { ?>
                                    <span><a href="m.php?app=news_edit&id=<?php echo $value['article_id']; ?>"
                                             style="color:<?php echo $value['tag_color']; ?>"><?php echo $value['title']; ?></a></span>
                                <?php } else { ?>
                                    <span><a
                                            href="m.php?app=news_edit&id=<?php echo $value['article_id']; ?>"><?php echo $value['title']; ?></a></span>
                                <?php } ?>
                            </td>
                            <td align="left"><a
                                    href="m.php?app=news_list&id=<?php echo $value['cat_id']; ?>"><?php echo $cat_info[$value['cat_id']]['cat_name']; ?></a>
                            </td>
                            ...
                            <td>
                                <?php if ($value['is_show']) { ?>
                                    <img src="../skin/default/images/yes.gif"
                                         onclick="toggle_show(this,'<?php echo $value['article_id']; ?>')"/>
                                <?php } else { ?>
                            ...
                            <td>
                                <div
                                    onclick="edit(this,<?php echo $value['article_id']; ?>,'divlink<?php echo $value['article_id']; ?>','a.php?act=updateAjax','tablename=article&colname=short_order&idname=article_id&idvalue=<?php echo $value['article_id']; ?>&logcontent=修改新闻标题排序&colvalue=',5);"><?php echo $value['short_order']; ?></div>
            ...
            <td>
                ...
                <a href="a.php?act=news_del&id=<?php echo $value['article_id']; ?>"
                   onclick="return confirm('<?php echo $a_langpackage->a_message_del; ?>');"><?php echo $a_langpackage->a_delete; ?></a><br/>
