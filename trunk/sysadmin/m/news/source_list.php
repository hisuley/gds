...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_source_management; ?></a></div>
        <hr />
    <div class="seachbox">
        <div class="content2">
        	<form action="m.php?app=news_source_list" name="searchForm" method="get">
            	<table class="form-table">
	            	...
	            	<tr>
	                   	...
	                   	<td><input type="hidden" name="app" value="news_source_list"><input class="regular-button" type="submit" value="<?php echo $a_langpackage->a_serach;?>" /></td>
	                </tr>
                </tbody>
            </table>
           </form>
	...
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_news_source_list; ?></span><span class="right" style="margin-right:15px;"><a href="m.php?app=news_source_add"><?php echo $a_langpackage->a_news_source_add; ?></a></span></h3>
    <div class="content2">
		...
		<table class="list_table"  style="table-layout:fixed;">
			...
			<tr style="text-align:center">
				<td><input type="checkbox" name="source_id[]" value="<?php echo $value['source_id'];?>" /></td>
