...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content; ?>
            &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_first_list; ?></a></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                <form action="m.php?app=news_first_list" name="searchForm" method="get">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" name="app" value="news_first_list"><input class="regular-button"
                                                                                               type="submit"
                ...
                <form action="a.php?act=news_del" name="form1" id="form1" method="post">
                    ...
                    <table class="list_table" style="table-layout:fixed;">
                        ...
                        <tr style="text-align:center">
                            <th width="40px">ID <a
                                    href="m.php?app=news_first_list&orderby=article_id&orderway=asc">↑</a><a
                                    href="m.php?app=news_first_list&orderby=article_id&orderway=desc">↓</a></th>
                            <th align="left" width="150px"><?php echo $a_langpackage->a_news_title; ?> <a
                                    href="m.php?app=news_first_list&orderby=title&orderway=asc">↑</a><a
                                    href="m.php?app=news_first_list&orderby=title&orderway=desc">↓</a></th>
                            <th align="left" width="110px"><?php echo $a_langpackage->a_news_category; ?> <a
                                    href="m.php?app=news_first_list&orderby=cat_id&orderway=asc">↑</a><a
                                    href="m.php?app=news_first_list&orderby=cat_id&orderway=desc">↓</a></th>
                            ...
                            <th width="60px"><?php echo $a_langpackage->a_title_desc; ?> <a
                                    href="m.php?app=news_first_list&orderby=short_order&orderway=asc">↑</a><a
                                    href="m.php?app=news_first_list&orderby=short_order&orderway=desc">↓</a></th>
