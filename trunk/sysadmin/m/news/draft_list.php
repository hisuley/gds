...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_draft_list; ?></a></div>
        <hr />
        <div class="seachbox">
        <div class="content2">
        	<form action="m.php?app=news_draft_list" name="searchForm" method="get">
            	<table class="form-table">
	            	...
	            	<tr>
	                   	...
	                   	<td><input type="hidden" name="app" value="news_draft_list"><input class="regular-button" type="submit" value="<?php echo $a_langpackage->a_serach;?>" /></td>
	                </tr>
                </tbody>
            </table>
           </form>
    ...
    <div class="content2">
		...
		<table class="list_table"  style="table-layout:fixed;">
			...
			<tr style="text-align:center">
				<th width="40px">ID <a href="m.php?app=news_draft_list&orderby=article_id">↑</a></th>
				<th align="left" width="200px"><?php echo $a_langpackage->a_news_title; ?> <a href="m.php?app=news_draft_list&orderby=title">↑</a></th>
				<th align="left" width="110px"><?php echo $a_langpackage->a_news_category; ?> <a href="m.php?app=news_draft_list&orderby=cat_id">↑</a></th>
				...
				<th width="189px"><?php echo $a_langpackage->a_add_time; ?></th>
                                <th width="60px"><?php echo $a_langpackage->a_title_desc; ?> <a href="m.php?app=news_draft_list&orderby=short_order">↑</a></th>
			</tr>
			</thead>
			<tbody>
