...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content; ?>
            &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_edit; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_news_edit; ?></span> <span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=news_list"><?php echo $a_langpackage->a_news_list; ?></a></span></h3>
                ...
                <form action="a.php?act=news_edit" method="post" onsubmit="return checkForm();"
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td><select name="cat_id" onchange="changeAttr(this.value);">
                                    ...
                                    <?php foreach ($cat_info as $value) { ?>
                                        <option
                                            value="<?php echo $value['cat_id']; ?>" <?php if ($value['cat_id'] == $news_info['cat_id']) {
                                            echo "selected";
                        ...
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="sub_title"
                                       value="<?php echo $news_info['sub_title']; ?>" style="width:200px;"/> <span
                                    id="asd_name_message">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_news_post_date; ?>：</td>
                            <td><input class="small-text" type="text" name="post_date"
                                       onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'%y-%M-{%d}'});"
                                       value="<?php echo $news_info['post_date']; ?>" style="width:200px;"/> <span
                                    id="asd_name_message">*</span></td>
                        </tr>
                        <tr>
                            ...
                            <td><select name="source_id">
                                    ...
                                    <?php foreach ($cat_source as $value) { ?>
                                        <option
                                            value="<?php echo $value['source_id']; ?>" <?php if ($value['source_id'] == $news_info['source_id']) {
                                            echo "selected";
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tag_color" style=" background-color:<?php echo $a_amend_lose
                                ['tag_color']?>;" value="<?php echo $news_info['tag_color'] ?>"
                                       onclick="coloropen(event)" id="inputcolor"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="is_blod" value="1" <?php if ($news_info['is_blod'] == 1) {
                                    echo "checked";
                                } ?>>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="small-text" name="short_order"
                                       value="<?php echo $news_info['short_order'] ?>"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" id="content" class="xheditor" cols="100"
                                          rows="15"><?php echo $news_info['content']; ?></textarea>
                                <iframe name="KindImageIframe" id="KindImageIframe" width="100%" height='30' align="top"
                                        allowTransparency="true" scrolling="no" src='m.php?app=upload_form'
                                        frameborder=0></iframe>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_news_links; ?>：</td>
                            <td><?php echo $a_langpackage->a_use_news_links; ?><input type="checkbox" name="is_link"
                                                                                      value="1" <?php if ($news_info['is_link']) {
                                    echo "checked";
                                } ?> /></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_news_links_url; ?>：</td>
                            <td><input type="text" name="link_url" value="<?php echo $news_info['link_url']; ?>"
                                       style="width:250px;" maxlength="200"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_news_isshow; ?>：</td>
                            <td><input type="checkbox" name="is_show" value="1" <?php if ($news_info['is_show']) {
                                    echo "checked";
                                } ?> /></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_news_edit; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
