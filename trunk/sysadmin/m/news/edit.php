...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_news_edit; ?></a></div>
        <hr />
	<div class="infobox">
    ...
    <div class="content2">
		...
		<table class="form-table">
            ...
            <tr>
                ...
                <td><input class="small-text" type="text" name="post_date" onFocus="WdatePicker({isShowClear:false,readOnly:true,minDate:'%y-%M-{%d}'});" value="<?php echo $news_info['post_date']; ?>" style="width:200px;" /> <span id="asd_name_message">*</span></td>
            </tr>
                        <tr>
			...
			<tr>
				...
				<td>
                    ...
                    ['tag_color']?>;" value="<?php echo $news_info['tag_color']?>" onclick="coloropen(event)" id="inputcolor" />
			...
			<tr>
				...
				<td><textarea name="content" id="content" class="xheditor" cols="100" rows="15"><?php echo $news_info['content'];?></textarea>
