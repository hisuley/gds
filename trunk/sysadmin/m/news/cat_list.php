...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content; ?>
            &gt;&gt; <?php echo $a_langpackage->a_news_category; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_news_category; ?></span> <span class="right"
                                                                                               style="margin-right:15px;"><a
                        href="m.php?app=news_catadd"><?php echo $a_langpackage->a_category_add; ?></a></span></h3>
                ...
                <form action="a.php?act=news_catdel" name="form1" id="form1" method="post">
                    <table class="list_table">
                        ...
                        <tr style=" text-align:center">
                            ...
                            <th width="60px">ID <a href="m.php?app=news_catlist&orderby=cat_id&orderway=asc">↑</a><a
                                    href="m.php?app=news_catlist&orderby=cat_id&orderway=desc">↓</a></th>
                            <th width="" align="left"><?php echo $a_langpackage->a_category_name; ?> <a
                                    href="m.php?app=news_catlist&orderby=cat_name&orderway=asc">↑</a><a
                                    href="m.php?app=news_catlist&orderby=cat_name&orderway=desc">↓</a></th>
                            <th width="80px"><?php echo $a_langpackage->a_type; ?></th>
                            <th width="60px"><?php echo $a_langpackage->a_sort; ?> <a
                                    href="m.php?app=news_catlist&orderby=sort_order&orderway=asc">↑</a><a
                                    href="m.php?app=news_catlist&orderby=sort_order&orderway=desc">↓</a></th>
                        ...
                        ?>
                        <tr style=" text-align:center">
                            <td width="30px"><input type="checkbox" name="cat_id[]"
                                                    value="<?php echo $value['cat_id']; ?>" <?php if ($value['parent_id'] == -1) {
                                    echo "disabled";
                                } ?>/></td>
                            <td width="30px"><?php echo $value['cat_id']; ?></td>
                            <td align="left" <?php if (in_array($value['parent_id'], array(0, -1))) {
                                echo 'style="font-weight:bold;"';
                            } ?>>
                                <div>
                                    <div id="divname"><?php echo $value['str_pad']; ?>&nbsp;</div>
                                    <div id="divname"
                                         onclick="edit(this,<?php echo $value['cat_id']; ?>,'divname<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=shop_categories&colname=cat_name&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=<?php echo $a_langpackage->a_edit_category; ?>：&colvalue=',5);">
                                        <a href="m.php?app=news_list&id=<?php echo $value['cat_id']; ?>"><?php echo $value['cat_name']; ?></a>
                                    </div>
                                    <div id="divname" style="display:none"></div>
                                </div>
                            </td>
                            <td width="80px"><?php if ($value['parent_id'] == -1) {
                                    echo $a_langpackage->a_sys_type;
                                } else {
                                    echo $a_langpackage->a_cus_type;
                                } ?></td>
                            <td width="60px">
                                <div
                                    onclick="edit(this,<?php echo $value['cat_id']; ?>,'divlink<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=article_cat&colname=sort_order&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=修改新闻分类排序&colvalue=',5);"><?php echo $value['sort_order']; ?></div>
            ...
            <td width="60px">
                ...
                <?php if ($value['parent_id'] != -1) { ?>
                    <a href="a.php?act=news_catdel&id=<?php echo $value['cat_id']; ?>"
                       onclick="return confirm('<?php echo $a_langpackage->a_del_all_catlist; ?>');"><?php echo $a_langpackage->a_delete; ?></a>
                <?php } ?>
            </td>
            </tr>
            <?php } ?>
