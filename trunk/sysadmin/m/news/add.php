...
<div id="maincontent">
    ...
    <div class="wrap">
        ...
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_news_add; ?></span><span class="right"
                ...
                <form action="a.php?act=news_add" method="post" onsubmit="return checkForm();"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="background:#" name="tilte_color" value=""
                        ...
                        <tr>
                            ...
                            <td style="line-height:18px;"><textarea name="content" id="content" class="xheditor"
                                                                    cols="90"
                                                                    rows="15"><?php echo $news_info['content']; ?></textarea>
                                <iframe name="KindImageIframe" id="KindImageIframe" width="90%" height='30' align="top"
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_news_draft_save; ?>"/> <input
