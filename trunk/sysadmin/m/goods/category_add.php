    ...
    <div class="wrap">
        ...
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_category_add; ?> </span><span class="right"
                        ...
                        href="m.php?app=goods_category_list"
                        style="float:right;"><?php echo $a_langpackage->a_category_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=goods_category_add" method="post" onsubmit="return checkform();"
