...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;  <?php echo $a_langpackage->a_m_goods_promotions_management ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                <form action="m.php?app=goods_promotions_list" name="searchForm" method="get">
                    <table class="form-table" style='font-size:14px;'>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $a_langpackage->a_goods_promotions_name; ?>: <input type="text"
                                                                                               class="small-text"
                                                                                               name="goods_name"
                                                                                               value="<?php echo $goods_name; ?>"
                                                                                               style="width:100px"/>
                                ...
                                <input type="hidden" name="app" value="goods_promotions_list"/><input
                                    class="regular-button" type="submit"
	...
	<a href="m.php?app=goods_promotions_add"
       style="float:right;"><?php echo $a_langpackage->a_goods_promotions_add; ?></a>
	</span></h3>
            ...
            <div class="content2">
                <table class="list_table" style='font-size:12px;'>
                    ...
                    <tr style=" text-align:center;">
                        <th width="50px">ID <a href="m.php?app=goods_promotions_list&orderby=a.id&orderway=asc">↑</a><a
                                href="m.php?app=goods_promotions_list&orderby=a.id&orderway=desc">↓</a></th>
                        <th align="left"><?php echo $a_langpackage->a_goods_name; ?></th>
                        <th width="50px">企业 <a
                                href="m.php?app=goods_promotions_list&orderby=a.shop_id&orderway=asc">↑</a><a
                                href="m.php?app=goods_promotions_list&orderby=a.shop_id&orderway=desc">↓</a></th>
                        <th width="125px"><?php echo $a_langpackage->a_goods_promotions_start_time; ?> <a
                                href="m.php?app=goods_promotions_list&orderby=a.start_time&orderway=asc">↑</a><a
                                href="m.php?app=goods_promotions_list&orderby=a.start_time&orderway=desc">↓</a></th>
                        <th width="125px"><?php echo $a_langpackage->a_goods_promotions_end_time; ?> <a
                                href="m.php?app=goods_promotions_list&orderby=a.end_time&orderway=asc">↑</a><a
                                href="m.php?app=goods_promotions_list&orderby=a.end_time&orderway=desc">↓</a></th>
                        <th width="65px"><?php echo $a_langpackage->a_goods_promotions_price; ?> <a
                                href="m.php?app=goods_promotions_list&orderby=a.promote_price&orderway=asc">↑</a><a
                                href="m.php?app=goods_promotions_list&orderby=a.promote_price&orderway=desc">↓</a></th>
                        <th width="40px">类型</th>
                        <th width="40px">启用</th>
                        <th width="40px">状态</th>
                    ...
                    <?php if ($result) {
                        foreach ($result as $value) {
                            ...
                            <tr style=" text-align:center;">
                                ...
                                <td>
                                    <div
                                        onclick="editnum(this,<?php echo $value['id']; ?>,'divorder<?php echo $value['id']; ?>','a.php?act=updateAjax','tablename=goods_promotions&colname=promote_price&idname=id&idvalue=<?php echo $value['id']; ?>&logcontent=<?php echo $a_langpackage->a_goods_promotions_price_edit; ?>：&colvalue=',8);"><?php echo $value['promote_price']; ?></div>
                                ...
                                <td>
                                    ...
                                    <a href="a.php?act=goods_promotions_del&id=<?php echo $value['id']; ?>"
                                       onclick="return confirm('<?php echo $a_langpackage->a_goods_promotions_del_mess; ?>');"><?php echo $a_langpackage->a_delete; ?></a>
                                </td>
                            </tr>
                        <?php }
                    } else { ?>
