...
$sql = "select attr_id,cat_id,attr_name,input_type,attr_values,sort_order, selectable, price from `$t_attribute` where attr_name = '天数' AND cat_id IN(".implode(',', $cat_ids).")";
        ...
        <div class="infobox">
            ...
            <div class="content2">
                ...
                <table class="content" id="attr_table">
                    <tbody id="attr_tbody">
                    <tr>
                        <th width="60px">ID <a href="m.php?app=travel_days&orderby=id&orderway=asc">↑</a><a href="m.php?app=travel_days&orderby=id&orderway=desc">↓</a></th>
                        <th width="100px"><?php echo $a_langpackage->a_attr_name; ?> <a href="m.php?app=travel_days&orderby=name&orderway=asc">↑</a><a href="m.php?app=travel_days&orderby=name&orderway=desc">↓</a></th>
                        ...
                        <th width="60px" align="center">启用 <a href="m.php?app=travel_days&orderby=enabled&orderway=asc">↑</a><a href="m.php?app=travel_days&orderby=enabled&orderway=desc">↓</a></th>
