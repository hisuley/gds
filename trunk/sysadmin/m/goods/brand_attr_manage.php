...
if (!$result_brand) {
    trigger_error($a_langpackage->a_add_brand_need . '!');
}
...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_brand_attr_list; ?></div>
        <hr/>
        <div class="infobox">
			...
			<input type="button" class="regular-button" value="<?php echo $a_langpackage->a_attr_add; ?>"
                   onclick="attr_info_add()"/>&nbsp;&nbsp;</span>&nbsp;&nbsp;<?php echo $a_langpackage->a_plselect_brand; ?>
                    ：
                    <select name="id" onchange="change_cat_id(this.value);">
                        ...
                        <?php foreach ($result_brand as $value) { ?>
                            <option
                                value="<?php echo $value['brand_id']; ?>" <?php if ($value['brand_id'] == $brand_id) echo "selected"; ?>><?php echo $value['brand_name']; ?></option>
                        <?php } ?>
                    </select>
                </div>
                        ...
                        foreach ($attr_info as $value) {
                            ...
                            <tr id="tr_<?php echo $value['brand_attr_id']; ?>">
                                ...
                                <td width="100px"><input type="text" class="small-text" style="width:50px;"
                                                         name="attr_name[<?php echo $value['brand_attr_id']; ?>]"
                                ...
                                <td width="500px">
                                    ...
                                    foreach ($inputtype_arr as $k => $v) {
                                        $i++; ?>
                                        <input type="radio" name="input_type[<?php echo $value['brand_attr_id']; ?>]"
                                ...
                                <td width="175px" align="center">
                                    <input type="button" class="regular-button"
                                           ...
                                           name="btn[<?php echo $value['brand_attr_id']; ?>]"
                                           onclick="attr_info_save(<?php echo $value['brand_attr_id']; ?>);"/>
                                    <input type="button" class="regular-button"
                                           value="<?php echo $a_langpackage->a_delete; ?>"
                                           name="delbtn[<?php echo $value['brand_attr_id']; ?>]"
                                           onclick="attr_info_del(<?php echo $value['brand_attr_id']; ?>)">
                                </td>
                            </tr>
                        <?php }
                    } else { ?>
