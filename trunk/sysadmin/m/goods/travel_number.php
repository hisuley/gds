        ...
        <div class="infobox">
            ...
            <div class="content2">
                ...
                <table class="content" id="attr_table">
                    <thead>
                        <tr>
                            <th width="60px"  align='center'>ID <a href="m.php?app=travel_number&orderby=a.goods_attr_id&orderway=asc">↑</a><a href="m.php?app=travel_number&orderby=a.goods_attr_id&orderway=desc">↓</a></th>
                            <th width="80px" align='center'>线路编号 <a href="m.php?app=travel_number&orderby=a.attr_values&orderway=asc">↑</a><a href="m.php?app=travel_number&orderby=a.attr_values&orderway=desc">↓</a></th>
