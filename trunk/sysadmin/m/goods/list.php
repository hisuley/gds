				  ...
				  <tbody>
				  	<tr>
				  		<td width="20px">
							...
							<input type="hidden" id="admin_promote" value="<?php echo $right_array['goods_admin_promote']?>">
		  ...
		  <thead>
			...
			<tr style="text-align: center;">
				...
				<td style=" text-align:center;" width="70px">
					<?php if($value['is_admin_promote']) { ?><img src="../skin/default/images/yes.gif" onclick="toggle_show(this,'admin_promote','<?php echo $value['goods_id']; ?>')" /><?php } else { ?><img src="../skin/default/images/no.gif" onclick="toggle_show(this,'admin_promote','<?php echo $value['goods_id']; ?>')" /><?php } ?>
				</td>
