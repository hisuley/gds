...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_goods_promotions_add; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_goods_promotions_add; ?> </span><span class="right"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><select name="goods_id">
                                    ...
                                    <?php foreach ($goods as $value) { ?>
                                        <option
                                            value="<?php echo $value['goods_id']; ?>"><?php echo $value['goods_name']; ?></option>
                                    <?php } ?>
                                </select></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="Wdate" type="text" name="start_time" id="start_time"
                                       onFocus="WdatePicker({isShowClear:false,readOnly:true})" value=""/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="is_enabled" value="1"
                                       checked><?php echo $a_langpackage->a_yes; ?> <input type="radio"
                                                                                           name="is_enabled"
                                                                                           value="0"><?php echo $a_langpackage->a_no; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                                      value="<?php echo $a_langpackage->a_goods_promotions_add; ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
