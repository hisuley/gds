...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_category_list; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_category_list; ?></span><span class="right"
                                                                                              style="margin-right:15px;"> <a
                        href="m.php?app=goods_category_add"
                        style="float:right;"><?php echo $a_langpackage->a_category_add; ?></a></span></h3>
                        ...
                        foreach ($category_dg as $value) {
                            ...
                            <tr style=" text-align:center;">
                                ...
                                <td align="left" <?php if ($value['parent_id'] == '0') {
                                    ...
                                    <div id="divname"
                                         onclick="edit(this,<?php echo $value['cat_id']; ?>,'divname<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=categorys&colname=cat_name&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=编辑分类：&colvalue=',5);"><?php echo $value['cat_name']; ?></div>
                                ...
                                <td>
                                    <div
                                        onclick="editnum(this,<?php echo $value['cat_id']; ?>,'divorder<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=category&colname=sort_order&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=编辑分类：&colvalue=',2);"><?php echo $value['sort_order']; ?></div>
                                ...
                                <td>
                                    ...
                                    <a href="a.php?act=goods_category_del&id=<?php echo $value['cat_id']; ?>"
                                       onclick="return confirm('<?php echo $a_langpackage->a_sure_del_category; ?>');"><?php echo $a_langpackage->a_delete; ?></a>
                                </td>
                            </tr>
                        <?php }
                    } else { ?>
