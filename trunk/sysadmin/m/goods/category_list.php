    ...
    <div class="content2">
		<table class="list_table" style="font-size:12px;">
			...
			<tr style=" text-align:center;">
				...
				<div id="divname" onclick="edit(this,<?php echo $value['cat_id'];?>,'divname<?php echo $value['cat_id'];?>','a.php?act=updateAjax','tablename=categorys&colname=cat_name&idname=cat_id&idvalue=<?php echo $value['cat_id'];?>&logcontent=编辑分类：&colvalue=',5);"><?php echo $value['cat_name'];?></div>
				<div id="divname" style="display:none"></div>
				
				</td>
				<td><?php echo $value['goods_num'];?></td>
				<td><div onclick="editnum(this,<?php echo $value['cat_id'];?>,'divorder<?php echo $value['cat_id'];?>','a.php?act=updateAjax','tablename=category&colname=sort_order&idname=cat_id&idvalue=<?php echo $value['cat_id'];?>&logcontent=编辑分类：&colvalue=',2);"><?php echo $value['sort_order'];?></div><div style="display:none"></div></td>
				<td>
