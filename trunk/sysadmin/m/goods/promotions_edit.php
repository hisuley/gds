...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_goods_promotions_edit; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_goods_promotions_edit; ?> </span><span class="right"
                                                                                                       style="margin-right:15px;"><a
                        href="m.php?app=goods_promotions_list"
                        style="float:right;"><?php echo $a_langpackage->a_goods_promotions_list; ?></a></span></h3>
                        ...
                        <tr>
                            ...
                            <td><select name="goods_id">
                                    ...
                                    <?php foreach ($goods as $value) { ?>
                                        <option
                                            value="<?php echo $value['goods_id']; ?>" <?php if ($value['goods_id'] == $info['goods_id']) {
                                            echo "selected";
                                        } ?>><?php echo $value['goods_name']; ?></option>
                                    <?php } ?>
                                </select></td>
                        </tr>
                        <tr>
                            <td width="100px;"><?php echo $a_langpackage->a_goods_promotions_price; ?>：</td>
                            <td><input class="small-text" type="text" name="promote_price"
                                       value="<?php echo $info['promote_price']; ?>"/> <span>*</span></td>
                        </tr>
                        <tr>
                            <td valign="top"><?php echo $a_langpackage->a_goods_promotions_detail; ?>：</td>
                            <td><textarea name="content" cols="45" rows="5"><?php echo $info['content']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_goods_promotions_start_time; ?>：</td>
                            <td><input class="Wdate" type="text" name="start_time" id="start_time"
                                       onFocus="WdatePicker({isShowClear:false,readOnly:true})"
                                       value="<?php echo $info['start_time']; ?>"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_goods_promotions_end_time; ?>：</td>
                            <td><input class="Wdate" type="text" name="end_time" id="end_time"
                                       onFocus="WdatePicker({isShowClear:false,readOnly:true})"
                                       value="<?php echo $info['end_time']; ?>"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_inspire; ?>：</td>
                            <td><input type="radio" name="is_enabled" value="1" <?php if ($info['is_enabled'] == 1) {
                                    echo 'checked';
                                } ?>><?php echo $a_langpackage->a_yes; ?> <input type="radio" name="is_enabled"
                                                                                 value="0" <?php if ($info['is_enabled'] == 0) {
                                    echo 'checked';
                                } ?>> <?php echo $a_langpackage->a_no; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"><input type="hidden" name="id" value="<?php echo $id; ?>">
                                <span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                                      value="<?php echo $a_langpackage->a_goods_promotions_edit; ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
