...
if (!$result_category) {
    trigger_error($a_langpackage->a_add_category_need . '!');
}
...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_attr_list; ?></div>
        <hr/>
        <div class="infobox">
            <h3><?php echo $a_langpackage->a_attr_list; ?></h3>

            <div class="content2">
                <div class="oprate" style="line-height:24px;">
                    &nbsp;&nbsp;<?php echo $a_langpackage->a_select_extended_category; ?></div>
