...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_hotel_landmark_management; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                ...
                <table class="content" id="attr_table">
                    <tbody id="attr_tbody">
                    <tr>
                        <th width="60px">ID <a href="m.php?app=hotel_landmark&orderby=id&orderway=asc">↑</a><a
                                href="m.php?app=hotel_landmark&orderby=id&orderway=desc">↓</a></th>
                        <th width="100px"><?php echo $a_langpackage->a_attr_name; ?> <a
                                href="m.php?app=hotel_landmark&orderby=name&orderway=asc">↑</a><a
                                href="m.php?app=hotel_landmark&orderby=name&orderway=desc">↓</a></th>
                        ...
                        <th width="60px" align="center">启用 <a
                                href="m.php?app=hotel_landmark&orderby=enabled&orderway=asc">↑</a><a
                                href="m.php?app=hotel_landmark&orderby=enabled&orderway=desc">↓</a></th>
