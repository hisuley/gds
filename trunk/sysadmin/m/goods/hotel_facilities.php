...
=======
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_hotel_facilities_management; ?></div>
        <hr/>
...
=======
                        <th width="60px">ID <a href="m.php?app=hotel_facilities&orderby=id&orderway=asc">↑</a><a
                                href="m.php?app=hotel_facilities&orderby=id&orderway=desc">↓</a></th>
                        <th width="100px"><?php echo $a_langpackage->a_attr_name; ?> <a
                                href="m.php?app=hotel_facilities&orderby=name&orderway=asc">↑</a><a
                                href="m.php?app=hotel_facilities&orderby=name&orderway=desc">↓</a></th>
>>>>>>> remotes/origin/master
...
=======
                        <th width="60px" align="center">启用 <a
                                href="m.php?app=hotel_facilities&orderby=enabled&orderway=asc">↑</a><a
                                href="m.php?app=hotel_facilities&orderby=enabled&orderway=desc">↓</a></th>
>>>>>>> remotes/origin/master
