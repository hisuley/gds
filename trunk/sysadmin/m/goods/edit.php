...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_good_xiu ?></div>
        <hr/>
        <div class="infobox">
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><select name="lock_flg">
                                    <option value="0" <?php if ($info['lock_flg'] == 0) {
                                        echo "selected";
                                    } ?>><?php echo $a_langpackage->a_flag_off; ?></option>
                                    <option value="1" <?php if ($info['lock_flg'] == 1) {
                                        echo "selected";
                                    } ?>><?php echo $a_langpackage->a_flag_on; ?></option>
                                </select></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_goods_name; ?>：</td>
                            <td><input class="small-text" type="text" name=goods_name
                                       value="<?php echo $info['goods_name']; ?>" style="width:200px;"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_good_intro; ?>：</td>
                            <td><textarea name="goods_intro" id="goods_intro" cols="100"
                                          rows="15"><?php echo $info['goods_intro']; ?></textarea></td>
                        </tr>
                        <tr>
                            <input type="hidden" name="good_id" value="<?php echo $goods_id; ?>"><input type="hidden"
                                                                                                        name="shop_id"
                                                                                                        value="<?php echo $info['shop_id']; ?>">
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_good_xiu ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
