...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_brand_edit; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_brand_edit; ?></span> <span class="right"
                                                                                            style="margin-right:15px;"><a
                        href="m.php?app=goods_brand_list"
                        style="float:right;"><?php echo $a_langpackage->a_brand_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=goods_brand_edit" method="post" onsubmit="return checkform();"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="type"
                                       value="<?php echo $info['brand_type']; ?>"/></td>
                        </tr>
                        <tr>
                            <td width="63px;"><?php echo $a_langpackage->a_scenic_rank; ?>：</td>
                            <td><input class="small-text" type="text" name="rank"
                                       value="<?php echo $info['brand_rank']; ?>"/></td>
                        </tr>
                        <tr>
                            <td width="63px;"><?php echo $a_langpackage->a_scenic_area; ?>：</td>
                            <td><input class="small-text" type="text" name="area"
                                       value="<?php echo $info['brand_area']; ?>"/></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="cat_id[]" id="cat_id" multiple
                                    ...
                                    <?php foreach ($category_dg as $value) { ?>
                                        <option
                                            value="<?php echo $value['cat_id']; ?>" <?php if (in_array($value['cat_id'], $category_brand_list)) {
                                            echo "selected";
                        ...
                        <tr>
                            ...
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_brand_edit; ?>"/>
                            </td>
                        </tr>
                    </table>
                </form>
