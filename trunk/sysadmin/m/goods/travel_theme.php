        ...
        <div class="infobox">
            ...
            <div class="content2">
                ...
                <table class="content" id="attr_table">
                    <tbody id="attr_tbody">
                    <tr>
                        <th width="60px">ID <a href="m.php?app=travel_theme&orderby=id&orderway=asc">↑</a><a href="m.php?app=travel_theme&orderby=id&orderway=desc">↓</a></th>
                        <th width="100px"><?php echo $a_langpackage->a_attr_name; ?> <a href="m.php?app=travel_theme&orderby=name&orderway=asc">↑</a><a href="m.php?app=travel_theme&orderby=name&orderway=desc">↓</a></th>
                        ...
                        <th width="60px" align="center">启用 <a href="m.php?app=travel_theme&orderby=enabled&orderway=asc">↑</a><a href="m.php?app=travel_theme&orderby=enabled&orderway=desc">↓</a></th>
