    ...
    <div class="wrap">
        ...
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_category_edit; ?></span><span class="right"
                        ...
                        href="m.php?app=goods_category_list"><?php echo $a_langpackage->a_category_list; ?></a></span>
            </h3>

            <div class="content2">
                <form action="a.php?act=goods_category_edit" method="post" onsubmit="return checkform();"
                                ...
                                <select name="brand_id[]" id="brand_id" multiple style="width:190px;">
                                    ...
                                    if (is_array($brand_list)) {
                                        foreach ($brand_list as $value) {
                                            ?>
                                            <option
                                                value="<?php echo $value['brand_id']; ?>"<?php if (in_array($value['brand_id'], $category_brand_list)) {
                                                echo "selected";
