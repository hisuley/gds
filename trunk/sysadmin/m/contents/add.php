    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_news_add; ?></a></div>
        <hr/>
        <div class="infobox">
                ...
                <form action="a.php?act=news_add" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td style="line-height:18px;"><textarea name="content" id="content" cols="90"
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_news_add; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
