...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_add_category; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_add_category; ?></span> <span class="right"
                ...
                <form action="a.php?act=news_catadd" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        <tr>
                            ...
                            <td class="left"><input class="small-text" type="text" name="cat_name" value=""
                                                    style="width:200px;"/></td>
                        </tr>
                        <tr>
                            <td width="70px" class="left"><?php echo $a_langpackage->a_category_sort; ?>：</td>
                            <td class="left"><input class="small-text" type="text" name="sort_order" value=""
                                                    style="width:200px;"/></td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_category_add; ?>"/>
                            </td>
                            </span></tr>
                    </table>
                </form>
