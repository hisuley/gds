    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_news_edit; ?></a></div>
        <hr/>
        <div class="infobox">
                ...
                <form action="a.php?act=news_edit" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="tag_color"
                                       style=" background-color:<?php echo $news_info['tag_color'] ?>;"
                                       value="<?php echo $news_info['tag_color'] ?>" onclick="coloropen(event)"
                                       id="inputcolor"/>
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" id="content" cols="100"
