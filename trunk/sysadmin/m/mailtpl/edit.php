...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_mailtpl_edit; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_mailtpl_edit; ?></span> <span class="right"
                                                                                              style="margin-right:15px;"><a
                        href="m.php?app=mailtpl_set"><?php echo $a_langpackage->a_mailtpl_list; ?></a></span></h3>
            ...
            <div class="content2">
                <form name="cpform" method="post" action="a.php?act=mailtpl_upd">
                    ...
                    <table class="form-table">
                        <tr>
                            <td width="55px"><?php echo $a_langpackage->a_mail_name; ?>:</td>
                            <td><input class="small-text" name="tpl_title" value="<?php echo $row['tpl_title'] ?>"
                                       type="text" style="width:520px"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_mail_content; ?>:</td>
                            <td><textarea name="tpl_content" id="tplcontent" cols="75"
                                          rows="15"><?php echo $row['tpl_content'] ?></textarea></td>
                            <tfoot>
                        <tr>
                            <td colspan="2"><input type="submit" class="regular-button"
                                                   value="<?php echo $a_langpackage->a_mail_post; ?>"/></td>
                        </tr>
                        </tfoot>
                    </table>
                </form>
