...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_title_management_of_complaints; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_title_management_of_complaints; ?></span><span
                    class="right" style="margin-right:15px;"><a
                        href="m.php?app=complaint_type_edit"><?php echo $a_langpackage->a_add_a_complaint_title; ?></a></span>
            </h3>
                ...
                <form action="a.php?act=complaint_type_del" name="form1" id="form1" method="post">
                    <table class="list_table">
                        ...
                        <tr style="text-align:center;">
                            <th width="20px"><input type="checkbox" onclick="checkall(this,'type_id[]');" value=''/>
                            </th>
                        ...
                        <?php if ($result['result']) {
                            foreach ($result['result'] as $value) {
                                ?>
                                <tr style="text-align:center;">
                                    <td width="20px"><input type="checkbox" name="type_id[]"
                                                            value="<?php echo $value['type_id']; ?>"/></td>
                                    <td width="60px"><?php echo $value['type_id']; ?>.</td>
                                    <td align="left"><?php echo $value['type_content']; ?></td>
                                    <td width="90px"><a
                                            href="m.php?app=complaint_type_edit&type_id=<?php echo $value['type_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                                        | <a
                                            href="a.php?act=complaint_type_del&type_id=<?php echo $value['type_id']; ?>"><?php echo $a_langpackage->a_dele; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
