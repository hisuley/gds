        ...
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_title_management_of_complaints; ?></span><span
                    class="right" style="margin-right:15px;"><a
                        href="m.php?app=complaint_type"><?php echo $a_langpackage->a_heading_the_list_of_complaints; ?></a></span>
            </h3>
                ...
                <form action="a.php?act=complaint_type_edit" name="form1" id="form1" method="post"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="small-text" name="type_content"
                                       value="<?php echo $result['type_content']; ?>"/>
                                <input type="hidden" name="type_id" value="<?php echo $result['type_id']; ?>"/></td>
                        </tr>
                        <tr>
                            <td colspan="2"><input class="regular-button" type="submit"
                                                   value="<?php echo $a_langpackage->a_submit; ?>"/></td>
                        </tr>
                        </tbody>
                    </table>
                </form>
...
<script language="JavaScript">
    function check() {
        var type_content = document.getElementsByName("type_content")[0];
        if (type_content.value == '') {
            ShowMessageBox("<?php echo $a_langpackage->a_complaint_title_en; ?>", '0');
            return false;
        }
        return true;
    }
