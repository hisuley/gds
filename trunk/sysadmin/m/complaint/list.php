...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_complaints_list; ?></div>
        <hr/>
        <div class="infobox">
                    ...
                    <table class="list_table">
                        ...
                        <?php if ($result['result']) {
                            foreach ($result['result'] as $value) {
                                ?>
                                <tr style="text-align:center;">
                                    <td><input type="checkbox" name="type_id[]"
                                               value="<?php echo $value['complaints_id']; ?>"/></td>
                                    <td><?php echo $value['user_name']; ?></td>
                                    <td align="left"><a
                                            href="../shop.php?shopid=<?php echo $value['usered_id']; ?>&app=index"
                                            target="_blank"><?php echo $value['usered_name']; ?></a></td>
                                    <td align="left"><a href="../goods.php?id=<?php echo $value['goods_id']; ?>"
                                    ...
                                    <td align="left">
                                        <?php if ($value['locked'] == 0) { ?>
                                            <a href="a.php?act=member_locked_user&id=<?php echo $value['usered_id']; ?>"
                                               onclick="return confirm('<?php echo $a_langpackage->a_sure_member_lock; ?>');">
                                                <?php echo $a_langpackage->a_locked_informers; ?>
                                            </a>
                                        <?php } else { ?>
                                            <font
                                                color="red"><?php echo $a_langpackage->a_lock_to_be_informers; ?></font>
                                        <?php } ?>
                                        <br/>
                                        <?php if ($value['lock_flg'] == 0) { ?>
                                            <a href="a.php?act=lock_goods_user&id=<?php echo $value['goods_id']; ?>&v=1"
                                               onclick="return confirm('<?php echo $a_langpackage->a_operate_message; ?>')">
                                                <?php echo $a_langpackage->a_locked_reported_goods; ?>
                                            </a>
                                        <?php } else { ?>
                                            <font
                                                color="red"><?php echo $a_langpackage->a_lock_was_reported_goods; ?></font>
                                        <?php } ?>
                                        | <a
                                            href="a.php?act=complaint_del&id=<?php echo $value['complaints_id']; ?>"><?php echo $a_langpackage->a_dele; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
