...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_admin_list; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_admin_list; ?></span> <span class="right"
                                                                                            style="margin-right:15px;"><a
                        href="m.php?app=admin_add"><?php echo $a_langpackage->a_add_admin; ?></a></span></h3>
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td id="update_<?php echo $value['admin_id']; ?>">
                                        <?php if ($value['admin_id'] != 1) { ?>
                                            <span
                                                onclick="edit(this,<?php echo $value['admin_id']; ?>)">&nbsp;<?php echo $value['group_name']; ?>
                                                &nbsp;</span>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if ($value['admin_id'] != 1) { ?><a
                                            href="a.php?act=admin_del&id=<?php echo $value['admin_id']; ?>"><?php echo $a_langpackage->a_delete; ?></a><?php } ?>
                                    </td>
                                </tr>
                            <?php }
                        } else { ?>
