...
//	}
    ...
    if ($dbo->exeUpdate($sql)) {
        ...
        echo "<script type=\"text/javascript\"> ShowMessageBox('$a_permissions_update_suc','0');</script>";
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_m_member_oprate; ?> &gt;&gt; <a
                href=""><?php echo $ri_langpackage->ri_allot; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $ri_langpackage->ri_allot; ?></span> <span class="right"
                                                                                         style="margin-right:15px;"><a
                        href="m.php?app=admin_group"><?php echo $a_langpackage->a_m_admingroup_set; ?></a></span></h3>
            ...
            <div class="content2">
                <form action="m.php?app=group_rights" method="post" name="form">
                    ...
                    <table class="list_table">
                        <thead>
                        <tr>
                            <th><?php echo $ri_langpackage->ri_local_user; ?>：<?php echo $groups['group_name']; ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        foreach ($classes as $class) {
                            ...
                            for ($i = 0; $i < $items->length; $i++) {
                                ...
                                ?>
                                <li class='rights'><input type="checkbox" title="<?php echo "group_" . $group_num; ?>"
                                                          name="rights[<?php echo $items->item($i)->getAttributeNode('id')->value; ?>]"
                                                          value="<?php echo $items->item($i)->getAttributeNode('id')->value; ?>"  <?php echo $is_checked; ?> /><?php echo $items->item($i)->getAttributeNode('value')->value; ?>
                                </li>
                            <?php } ?>
                            </td></tr>
                            <tr>
                                <td style="height:5px; background:#E5E5E5;"></td>
                            </tr>
                        <?php
                        }
                        ...
                        <?php } ?>
                        <tr>
                            <td><span class="button-container"><input class="regular-button" type="submit" name="action"
                                                                      value="<?php echo $ri_langpackage->ri_allot; ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
