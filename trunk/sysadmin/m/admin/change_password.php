    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_m_member_oprate; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_edit_admin_psd; ?></a></div>
        <hr/>
        <div class="infobox">
                ...
                <form action="a.php?act=change_password" method="post" onsubmit="return check();">
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input class="small-text" type="password" name="password"/> <span class="red">*<span>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_new_passwd; ?>：</td>
                            <td><input class="small-text" type="password" name="new_password"/> <span
                                    class="red">*<span>数字或英文，6-16位</td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_repeat_passwd; ?>：</td>
                            <td><input class="small-text" type="password" name="re_password"/> <span class="red">*<span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_change_passwd; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
