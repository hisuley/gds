    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_m_member_oprate; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_add_admin; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_add_admin; ?></span> <span class="right"
                                                                                           style=" margin-right:15px;"><a
                        href="m.php?app=admin_list"><?php echo $a_langpackage->a_admin_list; ?></a></span></h3>
                ...
                <form action="a.php?act=admin_add" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="admin_name"
                                       value="<?php echo $info['admin_name']; ?>" style="width:200px;"/> <span>*</span>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_admin_email; ?>：</td>
                            <td><input class="small-text" type="text" name="admin_email"
                                       value="<?php echo $info['admin_email']; ?>" style="width:200px;"/><span>*</span>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_admin_passwd; ?>：</td>
                            <td><input class="small-text" type="password" name="admin_password"
                                       value="<?php echo $info['admin_password']; ?>"
                                       style="width:200px;"/><span>*</span>数字或英文，6-16位
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="group">
                                    <?php foreach ($result_group as $key => $value) { ?>
                                        <option
                                            value="<?php echo $value['id']; ?>"><?php echo $value['group_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_add_admin; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
