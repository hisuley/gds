...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_add_asd; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_add_asd; ?></span><span class="right"
                                                                                        style="margin-right:15px;"><a
                        href="m.php?app=asd_list"><?php echo $a_langpackage->a_asd_list; ?></a></span></h3>

            <div class="content2">
                <form id="add_asd_form" name="add_asd_form" action="a.php?act=asd_add" method="post"
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select name="position_id">
                                    <option value="0"
                                            title="0X0"><?php echo $a_langpackage->a_select_asdposition; ?></option>
                                    <?php foreach ($position_info as $value) { ?>
                                        <option value="<?php echo $value['position_id']; ?>"
                                                title="<?php echo $value['asd_width'] . "X" . $value['asd_height']; ?>" <?php if ($value['position_id'] == $asd_info['position_id']) {
                                            echo "selected";
                                        } ?> ><?php echo $value['position_name']; ?></option>
                                    <?php } ?>
                        ...
                        <tr>
                            ...
                            <td id="wh"></td>
                            <input type="hidden" name="asd_wh"/>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asd_name; ?>：</td>
                            <td><input class="small-text" type="text" name="asd_name"
                                       value="<?php echo $asd_info['asd_name']; ?>" style="width:200px;"/> <span
                                    id="asd_name_message">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asd_link; ?>：</td>
                            <td><input class="small-text" type="text" name="asd_link"
                                       value="<?php echo $asd_info['asd_link']; ?>" style="width:200px;"/> <span
                                    id="asd_link_message">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asd_type; ?>：</td>
                            <td><input type="radio" name="media_type"
                                       value="1" <?php if ($asd_info['media_type'] == 1) echo "checked"; ?>
                                       onclick="showcontent(this.value);"/><?php echo $a_langpackage->a_image; ?>
                                <input type="radio" name="media_type"
                                       value="2" <?php if ($asd_info['media_type'] == 2) echo "checked"; ?>
                                       onclick="showcontent(this.value);"/>flash
                                <input type="radio" name="media_type"
                                       value="3" <?php if ($asd_info['media_type'] == 3) echo "checked"; ?>
                                       onclick="showcontent(this.value);"/><?php echo $a_langpackage->a_text; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="remark"
                                          style="width:350px; height:100px;"><?php echo $asd_info['remark']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="button"
                                                                                  name="btn_submit"
                                                                                  value="<?php echo $a_langpackage->a_add_asd; ?>"
                                                                                  onclick='asd_exits()'/></span></td>
                        </tr>
                    </table>
                </form>
            </div>
