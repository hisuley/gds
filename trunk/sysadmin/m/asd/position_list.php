...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_promotion_manage;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_asdposition_list; ?></a></div>
        <hr />
	<div class="infobox">
		...
		<table class="list_table" style="font-size: 12px;">
		  <thead>
			<tr style=" text-align:center;">
				<th width="20px"><input type="checkbox" onclick="checkall(this,'position_id[]');" value='' /></th>
				<th width="20px">ID</th>
				<th width="" align="left"><?php echo $a_langpackage->a_asdposition_name; ?></th>
				<th width="85px" align="right"><?php echo $a_langpackage->a_asdposition_width; ?></th><th width=""></th>
				<th width="85px" align="right"><?php echo $a_langpackage->a_asdposition_height; ?></th><th width=""></th>
			...
			<tr style=" text-align:center;">
				...
				<td align="right"><div  onclick="edit(this,<?php echo $value['position_id'];?>,'divwidth<?php echo $value['position_id'];?>','a.php?act=updateAjax','tablename=asd_position&colname=asd_width&idname=position_id&idvalue=<?php echo $value['position_id'];?>&logcontent=编辑广告位：&colvalue=',3);"><?php echo $value['asd_width'];?></div>
				<div style="display:none"></div></td>
				<td align="left">px</td>
				<td align="right"><div  onclick="edit(this,<?php echo $value['position_id'];?>,'divheight<?php echo $value['position_id'];?>','a.php?act=updateAjax','tablename=asd_position&colname=asd_height&idname=position_id&idvalue=<?php echo $value['position_id'];?>&logcontent=编辑广告位：&colvalue=',3);"><?php echo $value['asd_height'];?></div>
				<div style="display:none"></div>
				</td><td align="left">px</td>
				<td align="left"><div onclick="edit(this,<?php echo $value['position_id'];?>,'divdesc<?php echo $value['position_id'];?>','a.php?act=updateAjax','tablename=asd_position&colname=position_desc&idname=position_id&idvalue=<?php echo $value['position_id'];?>&logcontent=编辑广告位：&colvalue=',8);"><?php echo $value['position_desc'];?></div><div style="display:none"></div></td>
				<td>
			...
			<tr>
				<td colspan="7">
					<span class="button-container"><input class="regular-button" type='submit' onclick="return delcheck();" name="" value="<?php echo $a_langpackage->a_batch_del;?>"  /></span>
				</td>
			</tr>
			<?php } else { ?>
			<tr>
