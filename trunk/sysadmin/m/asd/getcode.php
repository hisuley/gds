    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_getasd_code; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_getasd_code; ?></span> <span class="right"
            ...
            <div class="content2">
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $asd_position_info['asd_width']; ?>
                            X<?php echo $asd_position_info['asd_height']; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea style="width:90%; height:40px" id="content">
                                <script language="JavaScript"
                                        src="uploadfiles/asd/<?php echo $asd_position_info['position_id']; ?>.js"></script>
                            </textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2"><span class="button-container"><input class="regular-button" type="button"
                                                                              value="<?php echo $a_langpackage->a_copy_code; ?>"
                                                                              onclick="copyToClipBoard()"/></span></td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
<script language="JavaScript">
    ...
    function copyToClipBoard() {
        ...
        ShowMessageBox("<?php echo $a_langpackage->a_copyed_code; ?>!", '0');
    }
    //-->
</script>
</body>
