...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_edit_asdpostion; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_edit_asdpostion; ?></span> <span class="right"
                                                                                                 style="margin-right:15px;"><a
                        href="m.php?app=asd_position_list"><?php echo $a_langpackage->a_asdposition_list; ?></a></span>
            </h3>
                ...
                <form action="a.php?act=asd_position_edit" method="post">
                    <table class="form-table">
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="position_name"
                                       value="<?php echo $asd_position_info['position_name']; ?>" style="width:200px"/>
                                <span id="position_name_message">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asdposition_width; ?>：</td>
                            <td><input class="small-text" type="text" name="asd_width"
                                       value="<?php echo $asd_position_info['asd_width']; ?>" style="width:50px;"/> px
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asdposition_height; ?>：</td>
                            <td><input class="small-text" type="text" name="asd_height"
                                       value="<?php echo $asd_position_info['asd_height']; ?>" style="width:50px;"/> px
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_asdposition_desc; ?>：</td>
                            <td><textarea name="position_desc"
                                          style="width:350px; height:100px;"><?php echo $asd_position_info['position_desc']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <input type="hidden" name="position_id"
                                   value="<?php echo $asd_position_info['position_id']; ?>">
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_edit_asdpostion; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
