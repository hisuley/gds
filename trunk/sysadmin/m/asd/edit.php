    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_edit_asd; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_edit_asd; ?></span> <span class="right"
                                                                                          style="margin-right:15px;"><a
                        href="m.php?app=asd_list"><?php echo $a_langpackage->a_asd_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=asd_edit" method="post" onsubmit="return checkform();"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <input type="hidden" name="asd_wh"
                                   value="<?php echo intval($position_info[$asd_info['position_id']]['asd_width']) . "X" . intval($position_info[$asd_info['position_id']]['asd_height']); ?>"/>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_edit_asd; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
