...
if(!$asd_id) {trigger_error($a_langpackage->a_error);}
...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_promotion_manage;?> &gt;&gt; <a href=""><?php echo $a_langpackage->a_edit_asd; ?></a></div>
        <hr />
	<div class="infobox">
