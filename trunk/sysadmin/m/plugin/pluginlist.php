    ...
    <script type='text/javascript'>
        ...
        function installNext() {
            if (install_submit != "") {
                ...
                window.frames[0].document.setplugin.submit();//main-frame
                install_submit = "";
            } else {
                diag_install.show();
            }
        ...
        function Unloadfirm(url) {
            Dialog.confirm('<?php echo $pl_langpackage->pl_worning;?>', function () {
                Unload(url);
            }, "<?php echo $pl_langpackage->pl_sure;?>");
        }
        function noinstall() {
...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $pl_langpackage->pl_list; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                <table class="list_table">
                    ...
                    <tr>
                        ...
                        <th><?php echo $pl_langpackage->pl_state; ?></th>
                        <th><?php echo $pl_langpackage->pl_ctrl; ?></th>
                    </tr>
                    </thead>
                    <?php
