...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_key_managment; ?></div>
        <hr/>
        <div class="seachbox">
                ...
                <table class="form_table">
                    ...
                    <tr>
                        ...
                        <td width="180px">
                            ...
                            <input class="small-text" type="text" name="name" value=""/>
                        </td>
                        <td width="180px">
							<span style="margin:1px 0px 0px 0px; float:left; color: #000">
								<?php echo $a_langpackage->a_key_count; ?>:
							</span>
                            <input class="small-text" type="text" name="count" value=""/>
                    ...
                    <table class="list_table">
                        ...
                        <?php if ($result) {
                            foreach ($result as $value) {
                                ?>
                                <tr style="text-align:center;">
                                    <td><input type="checkbox" name="searchkey[]" value="<?php echo $value['id']; ?>"/>
                                    </td>
                                    ...
                                    <?php if ($right_array['keyword_del']) { ?>
                                        <td>
                                            <a href="a.php?act=searchkey_del&id=<?php echo $value['id']; ?>"><?php echo $a_langpackage->a_dele; ?></a>
                                        </td>
                                    <?php } else { ?>
                                        <td>&nbsp;</td>
                                    <?php } ?>
                            ...
                            <?php } ?>
                            <tr>
                                <td colspan="6"><?php if ($right_array['keyword_del']) { ?><INPUT class="regular-button"
                                                                                                  onclick="return confirm('<?php echo $a_langpackage->a_operate_message; ?>');"
                                                                                                  type=submit
                                                                                                  value="<?php echo $a_langpackage->a_dele; ?>"
                                                                                                  name=deletesubmit> <?php } ?>
                                </td>
                                <td align="right"><?php if ($right_array['keyword_update']) { ?><input
                                        class="regular-button" type="button"
                                        value="<?php echo $a_langpackage->a_start_update; ?>"
                                        onclick="updateGoodsKeyword();" /> <?php } ?></td>
                                <td><span id="updateKeyword_message"></span></td>
                            </tr>
                        <?php } else { ?>
                            <tr>
                                <td colspan="7"><?php echo $a_langpackage->a_no_data; ?></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
...
<script language="JavaScript">
    ...
    function submitform() {
        ...
        if (checknum == 0) {
            ShowMessageBox('<?php echo $a_langpackage->a_select_check;?>', '0');
            return false;
        }
        return true;
    }
