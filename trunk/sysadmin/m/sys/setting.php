...
function goto_smtptest() {
	...
	if(!user_email_reg.test(smtp_test)){
        ...
        //alert('<?php echo $a_langpackage->i_mail_format1;?>');
	...
	<div class="infobox">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td><input class="small-text" type="text" name="sysinfo[sys_smtpserver]" value="<?php echo $SYSINFO['sys_smtpserver']; ?>" style="width:200px;" />如:smtp.163.com</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input class="small-text" type="text" name="sysinfo[sys_smtpusermail]" value="<?php echo $SYSINFO['sys_smtpusermail']; ?>" style="width:200px;" />如:abc@163.com</td>
			</tr>
			<tr>
				<th><?php echo $a_langpackage->a_smpt_user_port;?>：</th>
				<td><input class="small-text" type="text" name="sysinfo[sys_smtpuser]" value="<?php echo $SYSINFO['sys_smtpuser']; ?>" style="width:200px;" />如:abc</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input class="small-text" type="text" id="sys_smtptest" name="sys_smtptest" style="width:200px;" />&nbsp;&nbsp;<a href="#" onclick="goto_smtptest();"><?php echo $a_langpackage->a_mail_test;?></a>（请填写好邮箱测试帐号后点击发送）</td>
			</tr>
			</tbody>
		</table>
		<table class="form-table">
			...
			<tr>
				...
				<td><input id='site_domain' class="small-text" type="text" name="sysinfo[site_domain]" value="<?php echo $SYSINFO['site_domain']; ?>" style="width:200px;" /></td>
			</tr>
			<tr>
