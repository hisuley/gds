...
<form id="form1" name="form1" method="post"
      action="a.php?act=sys_area_add&parent_id=<?php echo $parent_id; ?>&area_type=<?php echo $area_type ?>"
    ...
    <div id="maincontent">
        <div class="wrap">
            <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
                ...
                &gt;&gt; <?php echo $a_langpackage->a_area_list; ?></div>
            <hr/>
            <div class="seachbox">
                <div class="content2">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td width="">
                                <input class="regular-button" type="submit" name="button" id="button"
                                       value="<?php echo $a_langpackage->a_add; ?>"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="infobox">
                <h3><span class="left"><?php echo $a_langpackage->a_sys_area; ?></span><span class="right"
                                                                                             style="margin-right:15px;"><a
                            href="m.php?app=sys_area&parent_id=<?php echo $parent_id_last['0']; ?>&area_type=<?php echo $area_type - 1 ?>">
                            ...
                            foreach ($areas_info as $val) {
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td id="area_id_<?php echo $val['area_id']; ?>">
                                        <span
                                            onclick="edit_name(this,<?php echo $val['area_id']; ?>)">&nbsp;<?php echo $val['area_name']; ?>
                                            &nbsp;</span></td>
                                    <td width="30%">
                                        <a href="m.php?app=sys_area&parent_id=<?php echo $val['area_id']; ?>&area_type=<?php echo $area_type + 1 ?>"><?php echo $a_langpackage->a_edit; ?></a>
                                        <a href="a.php?act=sys_area_del&id=<?php echo $val['area_id']; ?>"
                                           onclick="return confirm('<?php echo $a_langpackage->a_suc_del; ?>');"><?php echo $a_langpackage->a_dele; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
...
<script language="JavaScript">
    ...
    function check() {
        ...
        if (text.length == 0) {
            ShowMessageBox("<?php echo $a_langpackage->a_rank_eoor;?>", '0');
            return false;
        }
        return true;
    }
