...
<div id="maincontent">
    ...
    <div class="wrap">
		...
		<a href="m.php?app=sys_integral"><?php echo $a_langpackage->a_m_sys_integral; ?></a>
            ...
            <div class="content2">
                <form action="a.php?act=integral_add" method="post" enctype="multipart/form-data"
                      onsubmit="return checkForm();">
                    <table class="form-table">
                        <tr>
                            <td width="72px"><?php echo $a_langpackage->a_grade; ?>：</td>
                            <td><input id="credit_grade" class="small-text" type="text" name="credit_grade"
                                       value="<?php echo $row['int_grade']; ?>" style="width:200px;"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_credit_min; ?>：</td>
                            <td><input id="credit_min" class="small-text" type="text" name="credit_min"
                                       value="<?php echo $row['int_min']; ?>" style="width:200px;"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_credit_max; ?>：</td>
                            <td><input id="credit_max" class="small-text" type="text" name="credit_max"
                                       value="<?php echo $row['int_max']; ?>" style="width:200px;"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $button_title; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
