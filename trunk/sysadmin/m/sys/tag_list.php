...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;<?php echo $a_langpackage->a_tags_manage; ?></div>
        <hr/>
        <div class="seachbox">
                    ...
                    <table class="list_table">
                        ...
                        <?php if ($tag_list) {
                            foreach ($tag_list as $value) {
                                ?>
                                <tr style="text-align:center;">
                                    <td><input type="checkbox" name="tagkey[]" value="<?php echo $value['tag_id']; ?>"/>
                                    </td>
                                    ...
                                    <td><?php if ($value['is_recommend'] == 1) { ?>
                                            <img src="../skin/default/images/yes.gif"
                                                 onclick="toggle_show(this,'no','<?php echo $value['tag_id']; ?>')"
                                                 style="cursor:pointer;" alt="前台只显示20家店铺"/>
                                        <?php } else { ?>
                                            <img src="../skin/default/images/no.gif"
                                                 onclick="toggle_show(this,'yes','<?php echo $value['tag_id']; ?>')"
                                                 style="cursor:pointer;" alt="前台只显示20家店铺"/>
                                        <?php } ?>
                                        &nbsp;&nbsp;</td>
                                    <td><?php echo $value['short_order'] ?></td>
                                    <td>
                                        <a href="m.php?app=tag_edit&tag_id=<?php echo $value['tag_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>&nbsp;<a
                                            href="a.php?act=tag_del&tagkey=<?php echo $value['tag_id'] ?>"><?php echo $a_langpackage->a_delete; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
