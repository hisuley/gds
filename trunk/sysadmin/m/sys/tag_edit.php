...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_tag_list; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_update_tag; ?></span> <span class="right"
                                                                                            style="margin-right:15px;"><a
                        href="m.php?app=tag_list"
                        style="float:right;"><?php echo $a_langpackage->a_tag_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=tag_edit" method="post" onsubmit="return checkform();"
                      enctype="multipart/form-data">
                    <table class="form-table">
                        <tr>
                            <td width="63px;"><?php echo $a_langpackage->a_tag_goods; ?>：</td>
                            <td><input class="small-text" type="text" name="tag_name"
                                       value="<?php echo $tag_info['tag_name']; ?>"/> <span>*</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="background:#<?php echo $tag_info['tag_color']; ?>"
                                       name="tag_color" value="#<?php echo $tag_info['tag_color'] ?>"
                        ...
                        <td>
                            <input type="checkbox" name="is_blod" value="1"  <?php if ($tag_info['is_blod'] == 1) {
                                echo "checked";
                            } ?>>
                        </td>
                        <tr>
                            <td><?php echo $a_langpackage->a_sort; ?>：</td>
                            <td><input type="text" name="short_order" value="<?php echo $tag_info['short_order'] ?>"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_submit2; ?>"/>
                            </td>
                        </tr>
                    </table>
                </form>
