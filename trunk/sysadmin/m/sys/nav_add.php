                ...
                <form action="a.php?act=nav_add" method="post" onsubmit="return check();">
                    <table class="list_table">
                        <tr>
                            ...
                            <td><input type="text" name="nav_name" value=""/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_news_links_url; ?>：</td>
                            <td><input type="radio" name="type" value="1" onclick="changeurl(this.value)"/>
                                <?php echo $a_langpackage->a_goods_category; ?><input type="radio" value="2" name="type"
                                                                                      onclick="changeurl(this.value)"/>
                                <?php echo $a_langpackage->a_brand_area ?><input type="radio" name="type" value="3"
                                                                                 onclick="changeurl(this.value)"/>
                                <?php echo $a_langpackage->a_store_category; ?><input type="radio" name="type" value="4"
                                                                                      onclick="changeurl(this.value)"
                                                                                      checked/>
                                <?php echo $a_langpackage->a_define; ?><input type="text" name="url" id="url_content"/>
