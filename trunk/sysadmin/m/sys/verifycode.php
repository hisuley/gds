...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_verifycode_setting; ?></div>
        <hr/>
        <div class="infobox">
                ...
                <table class="list_table" style="font-size:12px;">
                    ...
                    <tr style="text-align:center;">
                        ...
                        <th align="right" width="80px"
                            colspan="2"><?php echo $a_langpackage->a_verifycode_status; ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr style="text-align:center;">
                        ...
                        <td width="" align="right" id="now_status_1"><?php if ($verifycode['1'] == 1) {
                                echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                            } else {
                                echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                            } ?></td>
                        <td width="40px" align="right" onclick="toggle(this,1)"
                            style="cursor:pointer;text-decoration:underline;"><?php if ($verifycode['1']) {
                    ...
                    <tr style="text-align:center;">
                        ...
                        <td width="" align="right" id="now_status_2"><?php if ($verifycode['2'] == 1) {
                                echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                            } else {
                                echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                            } ?></td>
                        <td width="40px" align="right" onclick="toggle(this,2)"
                            style="cursor:pointer;text-decoration:underline;"><?php if ($verifycode['2']) {
                                echo $a_langpackage->a_close;
                            } else {
                                echo $a_langpackage->a_open;
                            } ?></td>
                    ...
                    <tr style="text-align:center;">
                        ...
                        <td width="" align="right" id="now_status_3"><?php if ($verifycode['3'] == 1) {
                                echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                            } else {
                                echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                            } ?></td>
                        <td width="40px" align="right" onclick="toggle(this,3)"
                            style="cursor:pointer;text-decoration:underline;"><?php if ($verifycode['3']) {
                                echo $a_langpackage->a_close;
                            } else {
                                echo $a_langpackage->a_open;
                            } ?></td>
                    ...
                    <tr style="text-align:center;">
                        ...
                        <td width="" align="right" id="now_status_4"><?php if ($verifycode['4'] == 1) {
                                echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                            } else {
                                echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                            } ?></td>
                        <td width="40px" align="right" onclick="toggle(this,4)"
                            style="cursor:pointer;text-decoration:underline;"><?php if ($verifycode['4']) {
                                echo $a_langpackage->a_close;
                            } else {
                                echo $a_langpackage->a_open;
                            } ?></td>
