...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_sensi_words; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_sensi_words; ?></span> <span class="right"
                                                                                             style="margin-right:15px;"><a
                        href="m.php?app=word_add"><?php echo $a_langpackage->a_words_add; ?></a></span></h3>
                ...
                <form action="a.php?act=word_del" name="form1" id="form1" method="post">
                    <table class="list_table">
                        ...
                        <tr style=" text-align:center">
                            <th width="30px"><input type="checkbox" onclick="checkall(this,'word_id[]');" value=''/>
                            </th>
                            <th width="30px">ID</th>
                        ...
                        <?php if ($result['result']) {
                            foreach ($result['result'] as $value) {
                                ?>
                                <tr style=" text-align:center">
                                    <td width="30px"><input type="checkbox" name="word_id[]"
                                                            value="<?php echo $value['word_id']; ?>"/></td>
