    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_words_edit; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_words_edit; ?></span><span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=word_list"><?php echo $a_langpackage->a_sensi_words; ?></a></span></h3>
                ...
                <form action="a.php?act=word_edit" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        <tr>
                            ...
                            <td style="text-align:left;"><input class="small-text" type="text" name="word_name"
                                                                id="word_name" value="<?php echo $row['word_name']; ?>"
                                                                style="width:200px;" maxlength="20"/> <span
                                    id="asd_name_message">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_words_beizhu; ?>：</td>
                            <td style="text-align:left;"><input type="hidden" name="word_id"
                                                                value="<?php echo $row['word_id']; ?>"/>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_words_edit; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
