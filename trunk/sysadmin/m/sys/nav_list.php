...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;<?php echo $a_langpackage->a_custom_navigation; ?> </div>
        <hr/>
        <div class="infobox">
            <h3><?php echo $a_langpackage->a_navigation_list; ?><a href="m.php?app=nav_add"
                                                                   style="float:right;*margin-top:-10px;margin-right:15px;"><?php echo $a_langpackage->a_add_navigation; ?></a>
            </h3>
                    ...
                    <?php if ($result['result']) {
                        foreach ($result['result'] as $value) {
                            ...
                            <tr style="text-align: center;">
                                ...
                                <td>
                                    <div
                                        onclick="edit(this,<?php echo $value['id']; ?>,'divname<?php echo $value['id']; ?>','a.php?act=updateAjax','tablename=nav&colname=nav_name&idname=id&idvalue=<?php echo $value['id']; ?>&logcontent=<?php echo $a_langpackage->a_modify_navigation; ?>&colvalue=',10);">
                                        <?php echo $value['nav_name']; ?></div>
                                    <div style="display:none;"></div>
                                </td>
                                <td>
                                    <div
                                        onclick="edit1(this,<?php echo $value['id']; ?>,'divurl<?php echo $value['id']; ?>','a.php?act=updateAjax','tablename=nav&colname=url&idname=id&idvalue=<?php echo $value['id']; ?>&logcontent=<?php echo $a_langpackage->a_modify_navigation; ?>&colvalue=',20,'<?php echo $value['url']; ?>');">
                                        <?php echo $value['url']; ?></div>
                                    <div style="display:none;"></div>
                                </td>
                                <td>
                                    <div
                                        onclick="editnum(this,<?php echo $value['id']; ?>,'divorder<?php echo $value['id']; ?>','a.php?act=updateAjax','tablename=nav&colname=short_order&idname=id&idvalue=<?php echo $value['id']; ?>&logcontent=<?php echo $a_langpackage->a_modify_navigation; ?>&colvalue=',3);">
                                        <?php echo $value['short_order']; ?></div>
                                    <div style="display:none;"></div>
                                </td>
                                <td>
                                    <a href="m.php?app=nav_edit&nav_id=<?php echo $value['id']; ?>"><?php echo $a_langpackage->a_update; ?></a>&nbsp;<a
                                        href="a.php?act=nav_del&nav_id=<?php echo $value['id']; ?>"><?php echo $a_langpackage->a_delete; ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
