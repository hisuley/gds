    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <a
                href=""><?php echo $a_langpackage->a_words_add; ?></a></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_words_add; ?></span><span class="right"
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td style="text-align:left;"><input class="small-text" type="text" name="word_name"
                                                                id="word_name" value="" style="width:200px;"
                                                                maxlength="20"/> <span id="asd_name_message">*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_words_add; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
