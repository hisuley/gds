...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_groupbuy_list; ?></div>
        <hr/>
                            ...
                            foreach ($result['result'] as $v) {
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td align="left" style="padding-left:10px"><a
                                            href="../goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo"
                                            target="_blank"><img src="../<?php echo $v['goods_thumb'] ?>" width="95"
                                                                 height="95" style="float:left;padding-right:15px"
                                                                 alt="<?php echo $v['goods_name']; ?>"
                                                                 onerror="this.src='../skin/default/images/nopic.gif'"/></a>

                                        <div><a href="../goods.php?id=<?php echo $v['group_id']; ?>&app=groupbuyinfo"
                                                target="_blank"><?php echo sub_str($v['group_name'], 22, false); ?></a><br/>

                                            [<?php echo $a_langpackage->a_groupbuy_explain; ?>
                                            ]<?php echo $v['group_desc']; ?></div>
                                    </td>
                                    <td align="center" class=""><em
                                            class="pic"><?php echo $a_langpackage->a_money_sign; ?><?php echo $v['spec_price']; ?><?php echo $a_langpackage->a_yuan; ?></em>
                                    </td>
                                    <td class=""><?php echo $v['min_quantity']; ?></td>
                                    <td class=""><a href="../goods.php?id=<?php echo $v['goods_id']; ?>"
                                                    target="_blank"><?php echo sub_str($v['goods_name'], 22, false); ?></a>
                                    </td>
                                    <td class=""><?php echo time_left(strtotime($v['end_time'])); ?>
                                        <?php if ($v['group_condition'] == 1 and $v['examine'] == 1) echo $a_langpackage->a_complate;
                                        if ($v['examine'] == 0) echo $a_langpackage->a_no_auditing; ?>
