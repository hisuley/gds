...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_promotion_manage; ?> &gt;&gt; <?php echo $a_langpackage->a_index_images; ?></div>
        <hr />
	<div class="infobox">
	...
	<h3><?php echo $a_langpackage->a_index_images; ?></h3>
		...
		<tr>
			<td colspan="8">
				<span class="button-container"><input class="regular-button" type='submit' onclick="return delcheck();" name="" value="<?php echo $a_langpackage->a_dele;?>"  /></span>
			</td>
		</tr>
		<?php } else { ?>
		<tr>
...
=======
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_content; ?>
            &gt;&gt; <?php echo $a_langpackage->a_index_images; ?></div>
        <hr/>
        <div class="infobox">
            <form action="a.php?act=index_images_del" method="post" enctype="multipart/form-data">
                <h3><?php echo $a_langpackage->a_index_images; ?></h3>
                ...
                <div class="content2">
                    <table class="list_table">
                        ...
                        <tr style="text-align:center;">
                            ...
                            <th width="20px">ID</th>
                            <th width="" align="left"><?php echo $a_langpackage->a_name; ?></th>
                            <th width="" align="left"><?php echo $a_langpackage->a_image_url; ?>
                                /<?php echo $a_langpackage->a_image_link; ?></th>
                            <th width="35px"><?php echo $a_langpackage->a_show; ?></th>
                            <th width="90px"><?php echo $a_langpackage->a_add_time; ?></th>
                            <th width="55px"><?php echo $a_langpackage->a_operate; ?></th>
                        </tr>
                        ...
                        <?php if ($result['result']) {
                            foreach ($result['result'] as $value) {
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td><?php echo $value['id']; ?></td>
                                    <td align="left"><a
                                            href="../<?php echo $value['images_url']; ?>"><?php echo $value['name']; ?></a>
                                    </td>
                                    <td align="left"><a href="../<?php echo $value['images_url']; ?>"
                                                        target="_blank"><?php echo $value['images_url']; ?></a><br/><?php echo $value['images_link']; ?>
                                    </td>
                                    <td>
                                        <?php if ($value['status']) { ?>
                                            <img src="../skin/default/images/yes.gif"
                                                 id="stasus_img_<?php echo $value['id']; ?>"
                                                 onclick="toggle_show('stasus_img','<?php echo $value['id']; ?>')"/>
                                        <?php } else { ?>
                                    ...
                                    <td><?php echo sub_str($value['add_time'], 10, false); ?></td>
                                    <td>
                                        <a href="a.php?act=index_images_del&id=<?php echo $value['id']; ?>"
                                           onclick="return confirm('<?php echo $a_langpackage->a_sure_delimage; ?>');"><?php echo $a_langpackage->a_delete; ?>
                                            <br/></a>
                                        <?php if ($value['status']) { ?>
                                            <a href="javascript:;"
                                               onclick="toggle_show('stasus_img','<?php echo $value['id']; ?>',this)"><?php echo $a_langpackage->a_cancel_show; ?></a>
                                        <?php } else { ?>
                                            <a href="javascript:;"
                                               onclick="toggle_show('stasus_img','<?php echo $value['id']; ?>',this)"><?php echo $a_langpackage->a_set_display; ?></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
                                <td colspan="8">
                                    <span class="button-container"><input class="regular-button" type='submit'
                                                                          ...
                                                                          value="<?php echo $a_langpackage->a_dele; ?>"/></span>
                                </td>
                            </tr>
                        <?php } else { ?>
                            <tr>
...
>>>>>>> remotes/origin/master
		<span class="button-container"><a href="javascript:addNewUploadSpan();">[+]</a>
            <?php echo $a_langpackage->a_descrption; ?>：<input class="small-text" type="text" name="img_name[]"
                                                               maxlength="200"/>
            <?php echo $a_langpackage->a_link; ?>*：<input type="text" class="small-text" name="img_link[]"
                                                          value="http://" maxlength="200" style="width:200px"/>
            <?php echo $a_langpackage->a_uploadFile; ?>*：<input type="file" name="attach[]"/></span>
                ...
                <table>
                    <tr>
                        <td width="115px">
                            <input type="submit" class="regular-button" name="submit"
                                   value="<?php echo $a_langpackage->a_uploadimage; ?>"/>
                        </td>
                        <td>
        	<span>
        	 <?php echo $a_langpackage->a_img_number; ?><br/>
...
<script language="JavaScript">
    ...
    function toggle_show(idname, id, obj2) {
        ...
        if (rights != '0') {
            ...
            if (isshow == 1) {
                ajax("a.php?act=images_status_toggle", "POST", "t=1&id=1&s=0", function (index_num) {
                    if (index_num) {
                        if (index_num > 5) {
                            if (confirm("<?php echo $a_langpackage->a_view_num_error;?>")) {
                                updateIsView(obj, obj2, id, isshow);
                            }
                        } else {
                            updateIsView(obj, obj2, id, isshow);
                        }
    ...
    function updateIsView(obj, obj2, id, isshow) {
        ajax("a.php?act=images_status_toggle", "POST", "t=0&id=" + id + "&s=" + isshow, function (data) {
            if (data) {
