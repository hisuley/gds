...
<head>
    ...
    <style>
        .error_box {
            ...
            height: 300px;
            margin: 10px auto;
            border: #F2FD95 1px solid;
            background: #FAFEE3 url(../skin/default/images/error.png) no-repeat 45px 125px;
        }
...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_error_message; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                <div class="error_box">
                    ...
                    <p><a href="m.php"
                          title="<?php echo $a_langpackage->a_clicktojump_index; ?>"><?php echo $a_langpackage->a_clicktojump_index; ?>
                            &gt;&gt;</a></p>
                </div>
            </div>
        </div>
