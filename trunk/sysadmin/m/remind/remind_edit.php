...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_message_update; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_message_update; ?></span> <span class="right"
                ...
                <form action="a.php?act=remind_update" method="post" onsubmit="return checkForm();">
                    <table class="form-table">
                        <tr><input type="hidden" name="rinfo_id" value="<?php echo $id; ?>"/>
                            ...
                            <td class="left"><textarea rows="6" cols="30"
                                                       name="remind_info"><?php echo $row['remind_info']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="submit"
                                                                                  value="<?php echo $a_langpackage->a_message_update; ?>"/>
                            </td>
                            </span></tr>
                    </table>
                </form>
