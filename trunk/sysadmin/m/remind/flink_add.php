...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;<?php echo $a_langpackage->a_flink_add; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_flink_add; ?></span><span class="right"
                                                                                          style="margin-right:15px;"><a
                        href="m.php?app=flink_list"><?php echo $a_langpackage->a_flink_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=flink_add" method="post" onsubmit="return checkform();"
                      enctype="multipart/form-data">
                    <table class="form-table">
                        <tbody>
                        <tr>
                            <td width="70px"><?php echo $a_langpackage->a_flink_name; ?>：</td>
                            <td><input type="text" class="small-text" name="brand_name"
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="small-text" name="site_url"
                                       value="<?php echo $info['site_url']; ?>"/></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_flink; ?>logo：<br/></td>
                            <td><input type="file" name="logo[]"/>(<span
                                    style="color:#F00"><?php echo $a_langpackage->a_set_logo; ?></span>)
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="submit" class="regular-button" name="submit"
                                       value="<?php echo $a_langpackage->a_flink_add; ?>"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
