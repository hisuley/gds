...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;<?php echo $a_langpackage->a_flink_edit; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_flink_edit; ?></span><span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=flink_list"><?php echo $a_langpackage->a_flink_list; ?></a></span></h3>

            <div class="content2">
                <form action="a.php?act=flink_edit" method="post" onsubmit="return checkform();"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input class="regular-button" type="submit" name="submit"
                                                   value="<?php echo $a_langpackage->a_flink_edit; ?>"/></td>
                        </tr>
                        </tbody>
                    </table>
                </form>
