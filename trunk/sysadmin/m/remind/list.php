...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_set_message; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_set_message; ?></span> <span class="right"
                                                                                             style="margin-right:15px;"><a
                        href="m.php?app=remind_add"><?php echo $a_langpackage->a_message_add; ?></a></span></h3>
                ...
                <form action="a.php?act=news_catdel" name="form1" id="form1" method="post">
                    <table class="list_table">
                        ...
                        <tr style=" text-align:center">
                            <th width="30px"><input type="checkbox" onclick="checkall(this,'rinfo_id[]');" value=''/>
                            </th>
                            <th width="30px">ID</th>
                            ...
                            foreach ($result['result'] as $value) {
                                ...
                                <tr style=" text-align:center">
                                    <td width="30px"><input type="checkbox" name="cat_id[]"
                                                            value="<?php echo $value['rinfo_id']; ?>"/></td>
                                    ...
                                    <td width="60px">
                                        ...
                                        <a href="a.php?act=remind_del&id=<?php echo $value['rinfo_id']; ?>"
                                           onclick="return confirm('<?php echo $a_langpackage->a_message_del; ?>');"><?php echo $a_langpackage->a_dele; ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            <tr>
