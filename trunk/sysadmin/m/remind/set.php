...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_remind_setting; ?></div>
        <hr/>
        <div class="infobox">
                        ...
                        <tr style="text-align:center;">
                            <td id="type_<?php echo $value['remind_id']; ?>" align="left">
                                <div style="display:none"><input type=hidden
                                                                 id="selectid<?php echo $value['remind_id']; ?>"
                                                                 value="<?php echo $value['remind_type']; ?>"/></div>
                                <div
                                    onclick="editselect(this,<?php echo $value['remind_id']; ?>,'typediv_<?php echo $value['remind_id']; ?>','a.php?act=updateAjax','tablename=remind&colname=remind_type&idname=remind_id&idvalue=<?php echo $value['remind_id']; ?>&logcontent=更新提醒设置内容&colvalue=',25);"><?php echo $type[$value['remind_type']]; ?></div>
                                <div style="display:none"></div>
                            </td>
                            <td id="name_<?php echo $value['remind_id']; ?>" align="left">
                                <div
                                    onclick="edit(this,<?php echo $value['remind_id']; ?>,'namediv_<?php echo $value['remind_id']; ?>','a.php?act=updateAjax','tablename=remind&colname=remind_name&idname=remind_id&idvalue=<?php echo $value['remind_id']; ?>&logcontent=更新提醒设置内容&colvalue=',25);"><?php echo $value['remind_name']; ?></div>
                                <div style="display:none"></div>
                            </td>
                            <td id="tpl_<?php echo $value['remind_id']; ?>" align="left">
                                <div
                                    onclick="edit(this,<?php echo $value['remind_id']; ?>,'tpldiv_<?php echo $value['remind_id']; ?>','a.php?act=updateAjax','tablename=remind&colname=remind_tpl&idname=remind_id&idvalue=<?php echo $value['remind_id']; ?>&logcontent=更新提醒设置内容&colvalue=',25);"><?php echo $value['remind_tpl']; ?></div>
                                <div style="display:none"></div>
                            </td>
                            <td width="" align="center"
                                id="now_status_<?php echo $value['remind_id']; ?>"><?php if ($value['enable'] == 1) {
                                    echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                                } else {
                                    echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                                } ?></td>
                            <td width="40px" align="center" onclick="toggle(this,<?php echo $value['remind_id']; ?>)"
                                style="cursor:pointer;text-decoration:underline;"><?php if ($value['enable']) {
                                    echo $a_langpackage->a_close;
                                } else {
                                    echo $a_langpackage->a_open;
                                } ?></td>
                            <td>
                                <a href="m.php?app=remind_edit&id=<?php echo $value['remind_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
                    <tr>
                        <td colspan="7"><?php echo $a_langpackage->a_remind_remark; ?></td>
                    </tr>
                </table>
            </div>
        </div>
