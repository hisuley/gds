...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;  <?php echo $a_langpackage->a_shop_category ?></div>
        <hr/>
        <div class="infobox">
	...
	<a href="m.php?app=shop_categories_import"
       style="float:right;"><?php echo $a_langpackage->a_shop_categories_import; ?>&nbsp;&nbsp;</a>
	
	<a href="m.php?app=shop_categories_export"
       style="float:right;"><?php echo $a_langpackage->a_shop_categories_export; ?>&nbsp;&nbsp;</a>
	</span></h3>
                        ...
                        foreach ($category_dg as $value) {
                            ...
                            <tr style=" text-align:center;">
                                ...
                                <td>
                                    ...
                                    <a href="a.php?act=shop_categories_del&id=<?php echo $value['cat_id']; ?>"
