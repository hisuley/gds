...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_create_shop; ?></div>
        <hr/>
        <div class="infobox">
            ...
            <div class="content2">
                <form method="post" action="a.php?act=shop_create" name="form_shop_request"
                        ...
                        <tr>
                            ...
                            <td class="templageimg">
                                ...
                                foreach ($shoptemplate_arr as $v) {
                                    ?>
                                    <span><img src="<?php echo $v['imgurl']; ?>" width="95"
                                               alt="<?php echo $v['tplname']; ?>"
                                               onclick="wshowimg('<?php echo $v['bigimgurl']; ?>')"
                                               onmouseover="imgmover(this)" onmouseout="imgmout(this)"
                                               onerror="this.src='../skin/default/images/nopic.gif'"/><br/>	<input
                                            type="radio" name="shop_template"
