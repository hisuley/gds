...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_shop_mengament;?>&gt;&gt;<?php echo $a_langpackage->a_category_edit; ?></div>
    <hr />
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_category_edit; ?></span><span class="right" style="margin-right:15px;"><a href="m.php?app=shop_categories_list"><?php echo $a_langpackage->a_category_list; ?></a></span></h3>
    <div class="content2">
		<form action="a.php?act=shop_categories_edit" method="post" onsubmit="return checkform();">
