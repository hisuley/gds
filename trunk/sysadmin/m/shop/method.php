...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_shipp; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_ship_method; ?></span><span class="right"
                                                                                            style="margin-right:15px;"><a
                        href="m.php?app=method_add" style="float:right;"><?php echo $a_langpackage->a_add_method; ?></a></span>
            </h3>

            <div class="content2">
                <table class="list_table">
                    <thead>
                    <tr style="text-align:center;"><input type="hidden" id="remind_oper"
                                                          value="<?php echo $right_array['remind_oper']; ?>">
                    ...
                    <?php foreach ($array as $value) { ?>
                        <tr style="text-align:center;">
                            ...
                            <td width="40px" align="center"
                                id="now_status_<?php echo $value['tranid']; ?>"><?php if ($value['ifopen'] == 1) {
                                    echo "<span style='color:green;'>" . $a_langpackage->a_open . "</span>";
                                } else {
                                    echo "<span style='color:red;'>" . $a_langpackage->a_close . "</span>";
                                } ?></td>
                            <td width="40px" align="center" style="cursor:pointer;text-decoration:underline;"><a
                                    href="javascript:;"
                                    onclick="toggle(this,<?php echo $value['tranid']; ?>)"><?php if ($value['ifopen']) {
                                        echo $a_langpackage->a_close;
                                    } else {
                                        echo $a_langpackage->a_open;
                                    } ?></a><br/><a
                                    href="m.php?app=method_edit&id=<?php echo $value['tranid']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
