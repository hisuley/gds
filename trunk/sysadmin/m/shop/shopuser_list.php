...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_no_create_list; ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                    ...
                    <table class="list_table">
                        ...
                        <tr style="text-align:center;">
                            <th width="160px" align="left"><?php echo $a_langpackage->a_memeber_name; ?>
                                /<?php echo $a_langpackage->a_memeber_email; ?></th>
                            <th width="275px"><?php echo $a_langpackage->a_register_time; ?>
                                / <?php echo $a_langpackage->a_last_login_time; ?></th>
                            <th width="276px"><?php echo $a_langpackage->a_email_check; ?>
                                /<?php echo $a_langpackage->a_user_rank; ?></th>
                                    ...
                                    <td class="center"><?php if ($value['shop_name']) { ?>
                                        ...
                                        <?php } else { ?>
                                            <span style='color:green;'><a
                                                    href="m.php?app=shop_add&id=<?php echo $value['user_id']; ?>"><?php echo $a_langpackage->a_shop_add; ?></a></span>
                                        <?php } ?></td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
