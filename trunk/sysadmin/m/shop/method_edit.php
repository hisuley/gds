...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_xiu_method; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_xiu_method; ?></span><span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=shop_method"><?php echo $a_langpackage->a_ship_method; ?></a></span></h3>

            <div class="content2">
                <form method="post" action="a.php?act=shop_method_edit" name="form_shop_request"
                    ...
                    <table>
                        <tr><input type="hidden" name="tranid" value="<?php echo $tranid; ?>"/>
                            ...
                            <td><input type="text" name="tran_name" maxlength="200" style="width:200px"
                                       value="<?php echo $info['tran_name']; ?>"/><span class="red">*</span></td>
                        </tr>
                        <tr>
                            <td><?php echo $a_langpackage->a_describe; ?>：</td>
                            <td><textarea rows="6" cols="30" name="content"><?php echo $info['content']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="btn_submit"
                                                                                  value="<?php echo $a_langpackage->a_xiu_method; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
