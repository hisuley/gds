...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_shop_list; ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
        ...
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_shop_list; ?></span><span class="right"
                                                                                          style="margin-right:15px;"> <a
                        href="m.php?app=shopadd_list" style="float:right;"><?php echo $a_langpackage->a_shop_add; ?></a></span>
            </h3>
                        ...
                        <?php if ($result['result']) {
                            foreach ($result['result'] as $value) {
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td>
                                        <a href="a.php?act=shop_goodsdownsale&id=<?php echo $value['shop_id']; ?>"
