...
<head>
    ...
    <script type="text/javascript"
            src="../servtools/jquery-1.3.2.min.js?v=1.3.2"></script>
    <script
        type="text/javascript"
        src="skin/xheditor/xheditor.min.js?v=1.0.0-final"></script>
    <script
        type="text/javascript">
        var introeditor;
        $(function () {
...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_shop_updat; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_shop_updat; ?></span><span
                    class="right" style="margin-right: 15px;"><a
                        href="m.php?app=shop_list"><?php echo $a_langpackage->a_memeber_list; ?></a></span></h3>

            <div class="content2">
                <form method="post" action="a.php?act=shop_edit" name="form_shop_request" onsubmit="return checkForm()">
                    <table>
                        <tr>
                            <td width="140px;"><?php echo $a_langpackage->a_shopname; ?>：</td>
                            <td><input type="text" name="shop_name" value="<?php echo $shop_info['shop_name']; ?>"
                                       style="width: 250px;" maxlength="50"/><span class="red">*</span></td>
                        </tr>
                            ...
                            <td><span id="shop_country">
								<select name="categories_parent" onchange="categorieschanged(this.value)">
                                    ...
                                    foreach ($shop_categories_parent as $v) {
                                        ?>
                                        <option
                                            value="<?php echo $v['cat_id']; ?>" <?php if ($v['cat_id'] == $categories_parent) {
                                            echo 'selected';
								...
								</span> <span id="shop_categories"></span><span class="red">*</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="templageimg"><?php
                                foreach ($shoptemplate_arr as $v) {
                                    ?>
                                    <span><img style="border:2px solid #FFF" src="<?php echo $v['imgurl']; ?>"
                                               width="95" alt="<?php echo $v['tplname']; ?>"
                                               onclick="wshowimg('<?php echo $v['bigimgurl']; ?>')"
                                               onmouseover="imgmover(this)" onmouseout="imgmout(this)"
                                               onerror="this.src='../skin/default/images/nopic.gif'"/><br/>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input
                                        ...
                                        value="<?php echo $a_langpackage->a_shop_updat; ?>"/></span></td>
                        </tr>
                    </table>
                </form>
            </div>
...
<script language="JavaScript">
    ...
    function categorieschanged(value, child_value) {
        if (value > 0) {
            ajax("a.php?act=ajax_categori", "POST", "value=" + value + "&child_value=" + child_value, function (return_text) {
