...
<div id="maincontent">
	...
	<div class="wrap">
		<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_shop_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_shop_updat; ?></div>
		<hr />
		<div class="infobox">
	...
	class="right" style="margin-right: 15px;"><a href="m.php?app=shop_list"><?php echo $a_langpackage->a_memeber_list; ?></a></span></h3>
				...
				<form method="post" action="a.php?act=shop_edit"	name="form_shop_request" onsubmit="return checkForm()">
					<table>
						<tr>
							...
							<td><input type="text" name="shop_name"	value="<?php echo $shop_info['shop_name']; ?>" style="width: 250px;" maxlength="50" /><span class="red">*</span></td>
						</tr>
					...
					?>
									<option value="<?php echo $v['cat_id']; ?>" <?php if($v['cat_id']==$categories_parent){echo 'selected';}?>><?php echo $v['cat_name']; ?></option>
									<?php
					}
					?>
								</select>
			...
			style="width: 250px;" maxlength="200" /> <span class="red">*</span></td>
				...
				foreach($shoptemplate_arr as $v){
					?>
								<span><img style="border:2px solid #FFF" src="<?php echo $v['imgurl']; ?>" width="95"	alt="<?php echo $v['tplname']; ?>"	onclick="wshowimg('<?php echo $v['bigimgurl']; ?>')" onmouseover="imgmover(this)" onmouseout="imgmout(this)" onerror="this.src='../skin/default/images/nopic.gif'" /><br />
								<input type="radio" name="shop_template"	value="<?php echo $v['tpltag']; ?>"	<?php if($shop_info['shop_template']==$v['tpltag']){echo 'checked';}?> /> <?php echo $v['tplname']; ?></span>
								<?php
				}
				?></td>
						</tr>
