...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_add_method; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_add_method; ?></span><span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=shop_method"><?php echo $a_langpackage->a_ship_method; ?></a></span></h3>

            <div class="content2">
                <form method="post" action="a.php?act=shop_method_add" name="form_shop_request"
                      onsubmit="return check_form(this)" enctype="multipart/form-data">
                    <table>
                        <tr>
                            <td width="140px;"><?php echo $a_langpackage->a_tran_name; ?>：</td>
                            <td><input type="text" name="tran_name" maxlength="200" style="width:200px" value=""/><span
                                    class="red">*</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="btn_submit"
                                                                                  value="<?php echo $a_langpackage->a_add_method; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
