...
<div id="maincontent">
 <?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_shop_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_m_check_commember;?></div>
        <hr />
        <div class="seachbox">
            <div class="content2">
                ...
                <table class="form-table">
                	...
                	<tr>
                		<td width="10px"><img src="skin/images/icon_search.gif" border="0" alt="SEARCH" /></td>
                       	...
                       	<td width="50px">
                       		<select name="s">
							<option value='10' <?php if($s=='10'){echo "selected";} ?> ><?php echo $a_langpackage->a_show_all;?></option>
	...
	<div class="infobox">
	<h3><?php 
	if($s=='10'){echo $a_langpackage->a_show_all;} 
	if($s=='1'){echo $a_langpackage->a_audit_succ;} 
	if($s=='2'){echo $a_langpackage->a_audit_refuse;}
	if($s=='100'){echo $a_langpackage->a_audit_wait;}?></h3>
    <div class="content2">
		<form action="a.php?act=shop_request" name="form1" method="post">
		<table class="list_table">
		  <thead>
			<tr style="text-align:center;">
				<th width="2px"><input type="checkbox" onclick="checkall(this,'request_id[]');" value='' /></th>
			...
			<tr>
				...
				<span style="margin:14px 14px 0px 0px; float:left;" >
					...
					<span class="button-container"><input type="submit" name="" class="regular-button"  onclick="return delcheck();" value="<?php echo $a_langpackage->a_batch_handle;?>" /></span>
				</td>
			</tr>
			<?php } else { ?>
			<tr>
