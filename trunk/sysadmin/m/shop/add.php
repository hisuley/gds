...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_app_member; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_app_member; ?></span><span class="right"
                                                                                           style="margin-right:15px;"><a
                        href="m.php?app=asd_list"><?php echo $a_langpackage->a_memeber_list; ?></a></span></h3>

            <div class="content2">
                <form method="post" action="a.php?act=shop_add" name="form_shop_request"
                      onsubmit="return check_form(this)" enctype="multipart/form-data">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" name="company_name" maxlength="200" style="width:200px"
                                       value="<?php echo $request_info['company_name']; ?>"/><span class="red">*</span>
                            </td>
                        </tr>
                        <input type="hidden" name="uid" value="<?php echo $uid; ?>"/><input type="hidden"
                                                                                            name="request_id"
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="person_name" maxlength="200" style="width:200px"
                                       value="<?php echo $request_info['person_name']; ?>"/><span class="red">*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="credit_num" maxlength="200" style="width:200px"
                                       value="<?php echo $request_info['credit_num']; ?>"/><span class="red">*</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="company_address" maxlength="200" style="width:300px"
                                       value="<?php echo $request_info['company_address']; ?>"/> <span
                                    class="red">*</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="telphone" maxlength="20" style="width:200px"
                                       value="<?php echo $request_info['telphone']; ?>"/> <span class="red">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><span class="button-container"><input class="regular-button" type="submit"
                                                                                  name="btn_submit"
                                                                                  value="<?php echo $a_langpackage->a_app_member; ?>"/></span>
                            </td>
                        </tr>
                    </table>
                </form>
