...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_m_check_commember; ?>
            &gt;&gt; <?php echo $a_langpackage->a_corporate_info; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_corporate_info; ?></span><span class="right"
                                                                                               style="margin-right:15px;"><a
                        href="m.php?app=shop_request"><?php echo $a_langpackage->a_m_check_commember; ?></a></span></h3>
                ...
                <form action="a.php?act=shop_request" name="form1" method="post">
                    <table class="list_table">
                        ...
                        <tr>
                            ...
                            <td><img src="../<?php echo $result['credit_commercial']; ?>" height="125px" width="230px"
                                     onerror="this.src='../skin/default/images/nopic.gif'"/></td>
                        </tr>
                        <tr>
        ...
        <?php if ($result['status'] == 0) { ?>
            <input type="button" name="" class="regular-button"
                   onclick="auditing(1,<?php echo $result['request_id']; ?>)" value="审核通过"/>
            <input type="button" name="" class="regular-button"
                   onclick="auditing(2,<?php echo $result['request_id']; ?>)" value="审核不通过"/>
        <?php } ?>
    </div>
</div>
</body>
