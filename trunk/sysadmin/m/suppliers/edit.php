...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_suppliers_edit; ?></div>
        <hr />
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_suppliers_edit; ?></span><span class="right" style="margin-right:15px;"><a href="m.php?app=suppliers_list"><?php echo $a_langpackage->a_suppliers_list; ?></a></span></h3>
    <div class="content2">
		<form method="post" action="a.php?act=suppliers_edit" name="form_suppliers_edit" onsubmit="return check_form(this)" enctype="multipart/form-data">
                    <table class="list_table" style="float:left; width:48%; margin-right:4%">
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <td><input type="text" name="user_name" value="<?php echo $user_info['user_name']; ?>" style="width:200px;" /> <span>*</span></td>
                            </tr>
                            <tr>
                                    <td align="right"><?php echo $a_langpackage->a_memeber_email;?>：</td>
                                    <td><input type="text" name="user_email" value="<?php echo $user_info['user_email']; ?>" style="width:200px;" /><span>*</span></td>
                            </tr>
                            <tr>
                                    <td align="right"><?php echo $a_langpackage->a_user_password;?>：</td>
                                    <td><input type="password" name="admin_password" value="<?php echo $user_info['user_password']; ?>" style="width:200px;" /><span>*</span><?php echo $a_langpackage->a_user_notupdate;?></td>
                            </tr>
                            <tr>
				...
				<td><input type="text" name="telphone" maxlength="20" style="width:200px" value="<?php echo $request_info['telphone']; ?>"/> <span class="red">*</span></td>
                    ...
                    <table class="list_table" style="clear:both; border:0px; padding:0px; margin:0px;">
                        ...
                        <tbody>
                                ...
                                <tr>
                                        <td colspan="2" align="center"><span class="button-container"><input class="regular-button" type="submit" name="btn_submit" value="<?php echo $a_langpackage->a_suppliers_edit; ?>"  /></span></td>
                                </tr>
                        </tbody>    
                </table>
		</form>
