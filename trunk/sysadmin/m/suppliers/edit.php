...
$user_info = get_user_info($dbo, $t_users, $uid);
...
<div class="crumbs"><?php echo $a_langpackage->a_location; ?>
    ...
    &gt;&gt; <?php echo $a_langpackage->a_suppliers_edit; ?></div>
<hr/>
<div class="infobox">
<h3><span class="left"><?php echo $a_langpackage->a_suppliers_edit; ?></span><span class="right"
                                                                                   style="margin-right:15px;"><a
            href="m.php?app=suppliers_list"><?php echo $a_langpackage->a_suppliers_list; ?></a></span></h3>

<div class="content2">
<form method="post" action="a.php?act=suppliers_edit" name="form_suppliers_edit" onsubmit="return check_form(this)"
...
<table class="list_table" style="float:left; width:48%; margin-right:4%">
    ...
    <tr>
        ...
        <td><input type="text" name="user_name" value="<?php echo $user_info['user_name']; ?>" style="width:200px;"/>
            <span>*</span></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_memeber_email; ?>：</td>
        <td><input type="text" name="user_email" value="<?php echo $user_info['user_email']; ?>"
                   style="width:200px;"/><span>*</span></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_user_password; ?>：</td>
        <td><input type="password" name="admin_password" value="<?php echo $user_info['user_password']; ?>"
                   style="width:200px;"/><span>*</span><?php echo $a_langpackage->a_user_notupdate; ?></td>
    </tr>
    <tr>
...
<table class="list_table" style="float:left; width:48%;">
    ...
    <tr>
        ...
        <td><input type="text" name="company_name" maxlength="200" style="width:200px"
                   value="<?php echo $request_info['company_name']; ?>"/><span class="red">*</span></td>
    </tr>
    <input type="hidden" name="uid" value="<?php echo $uid; ?>"/><input type="hidden" name="request_id"
                                                                        value="<?php echo $request_info['request_id']; ?>"/>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_person_name; ?>：</td>
        <td><input type="text" name="person_name" maxlength="200" style="width:200px"
                   value="<?php echo $request_info['person_name']; ?>"/><span class="red">*</span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="credit_num" maxlength="200" style="width:200px"
                   value="<?php echo $request_info['credit_num']; ?>"/><span class="red">*</span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="company_area" maxlength="200" style="width:200px"
                   value="<?php echo $request_info['company_area']; ?>"/></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_company_address; ?>：</td>
        <td><input type="text" name="company_address" maxlength="200" style="width:300px"
                   value="<?php echo $request_info['company_address']; ?>"/> <span class="red">*</span></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_zipcode; ?>：</td>
        <td><input type="text" name="zipcode" maxlength="10" style="width:100px"
                   value="<?php echo $request_info['zipcode']; ?>"/> <span class="red">*</span></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_mobile_code; ?>：</td>
        <td><input type="text" name="mobile" maxlength="20" style="width:200px"
                   value="<?php echo $request_info['mobile']; ?>"/> <span class="red">*</span></td>
    </tr>
    <tr>
        <td align="right"><?php echo $a_langpackage->a_telphone_code; ?>：</td>
        <td><input type="text" name="telphone" maxlength="20" style="width:200px"
                   value="<?php echo $request_info['telphone']; ?>"/> <span class="red">*</span></td>
    </tr>
    </tbody>
</table>
<table class="list_table" style="clear:both; border:0px; padding:0px; margin:0px;">
    ...
    <tr>
        ...
        <td><span id="shop_country"> <select name="categories_parent"
                    ...
                    foreach ($shop_categories_parent as $v) {
                        ?>
                        <option value="<?php echo $v['cat_id']; ?>"<?php if ($v['cat_id'] == $categories_parent) {
                            echo 'selected';
    ...
    <tr>
        ...
        <td>		<span id="shop_country">
                                                                        <select name="country"
                                                                                onchange="areachanged(this.value,0);">
                                                                            <option
                                                                                value='0'><?php echo $a_langpackage->a_selectcount; ?></option>
                                                                            <?php
                                                                            foreach ($areas_info[0] as $v) {
                                                                                ?>
                                                                                <option
                                                                                    value="<?php echo $v['area_id']; ?>"<?php if ($v['area_id'] == $shop_info['shop_country']) {
                                                                                    echo 'selected';
                                                                                } ?>>
                                                                        ...
                                                                        if ($shop_info['shop_country']) {
                                                                            ...
                                                                            <select name="province"
                                                                                    onchange="areachanged(this.value,1);">
                                                                                <option
                                                                                    value='0'><?php echo $a_langpackage->a_select_province; ?></option>
                                                                                <?php
                                                                                foreach ($areas_info[1] as $v) {
                                                                                    ?>
                                                                                    <option
                                                                                        value="<?php echo $v['area_id']; ?>"<?php if ($v['area_id'] == $shop_info['shop_province']) {
                                                                                        echo 'selected';
                                                                                    } ?>>
                                                                                        <?php echo $v['area_name']; ?></option>
                                                                                <?php
                                                                        ...
                                                                        if ($shop_info['shop_province']) {
                                                                            ?>
                                                                            <select name="city"
                                                                                    onchange="areachanged(this.value,2);">
                                                                                <option
                                                                                    value='0'><?php echo $a_langpackage->a_select_city; ?></option>
                                                                                <?php
                                                                                foreach ($areas_info[2] as $v) {
                                                                                    if ($v['parent_id'] == $shop_info['shop_province']) {
                                                                                        ?>
                                                                                        <option
                                                                                            value="<?php echo $v['area_id']; ?>"<?php if ($v['area_id'] == $shop_info['shop_city']) {
                                                                                            echo 'selected';
                                                                                        } ?>>
                                                                                            <?php echo $v['area_name']; ?></option>
                                                                                    <?php
                                                                        ...
                                                                        if ($shop_info['shop_city']) {
                                                                            ...
                                                                            <select name="district">
                                                                                <option
                                                                                    value='0'><?php echo $a_langpackage->a_select_dir; ?></option>
                                                                                <?php
                                                                                foreach ($areas_info[3] as $v) {
                                                                                    if ($v['parent_id'] == $shop_info['shop_city']) {
                                                                                        ?>
                                                                                        <option
                                                                                            value="<?php echo $v['area_id']; ?>"<?php if ($v['area_id'] == $shop_info['shop_district']) {
                                                                                            echo 'selected';
                                                                                        } ?>>
                                                                                            <?php echo $v['area_name']; ?></option>
                                                                                    <?php
    ...
    <tr>
        ...
        <td class="templageimg">
            ...
            foreach ($shoptemplate_arr as $v) {
                ?>
                <span><img src="<?php echo $v['imgurl']; ?>" width="95" alt="<?php echo $v['tplname']; ?>"
                           onclick="wshowimg('<?php echo $v['bigimgurl']; ?>')" onmouseover="imgmover(this)"
                           onmouseout="imgmout(this)"
                           onerror="this.src='../skin/default/images/nopic.gif'"/><br/>	<input type="radio"
                                                                                                  name="shop_template"
                                                                                                  value="<?php echo $v['tpltag']; ?>"    <?php if ($shop_info['shop_template'] == $v['tpltag']) {
                        echo 'checked';
    ...
    <tr>
        ...
        <td><textarea name="shop_intro" id="shop_intro" cols="75"
                      rows="15"><?php echo $shop_info['shop_intro']; ?></textarea></td>
    </tr>
    <tr>
        <td colspan="2" align="center"><span class="button-container"><input class="regular-button" type="submit"
                                                                             name="btn_submit"
                                                                             value="<?php echo $a_langpackage->a_suppliers_edit; ?>"/></span>
        </td>
    </tr>
    </tbody>
</table>
