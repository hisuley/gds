...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_suppliers_list;?></div>
        <hr />
	<div class="seachbox">
        <div class="content2">
	...
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_suppliers_list;?></span><span class="right" style="margin-right:15px;"> <a href="m.php?app=suppliers_add" style="float:right;"><?php echo $a_langpackage->a_suppliers_add; ?></a></span></h3>
    <div class="content2">
			...
			<table class="list_table">
			  ...
			  <tbody>
				...
				<tr style="text-align:center;">
					...
					<td>
						<a href="a.php?act=suppliers_goodsdownsale&id=<?php echo $value['shop_id']; ?>" onclick="return confirm('<?php echo $a_langpackage->a_goods_out_sale_message1.$value['shop_name'].$a_langpackage->a_goods_out_sale_message2;?>');"><?php echo $a_langpackage->a_goods_out_sale;?></a><br />
