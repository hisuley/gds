...
if(!$distributor_id) {exit($a_langpackage->a_error);}
...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_distributor_edit; ?></div>
    <hr />
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_distributor_edit; ?></span><span class="right" style="margin-right:15px;"><a href="m.php?app=distributor_list"><?php echo $a_langpackage->a_distributor_list; ?></a></span></h3>
    <div class="content2">
		...
		<table class="form-table">
		  <tbody>
			<tr>
				...
				<td><input type="text" class="small-text" name="distributor_name" value="<?php echo $info['distributor_name']; ?>" /> <span>*</span></td>
			</tr>
                        <tr>
				<td valign="top"><?php echo $a_langpackage->a_distributor_intro; ?>：</td>
                                <td><textarea name="distributor_intro" cols="45" rows="5"><?php echo $info['distributor_intro']; ?></textarea> <span>*</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input type="submit" class="regular-button" name="submit" value="<?php echo $a_langpackage->a_distributor_edit; ?>" /></td>
			</tr>
		</tbody>
		</table>
		</form>
