...
<div id="maincontent">
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt;  <?php echo $a_langpackage->a_distributor_management ?></div>
        <hr />
        <div class="seachbox">
            <div class="content2">
                ...
                <table class="form-table" style='font-size:14px;'>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $a_langpackage->a_distributor_name;?>: <input type="text" class="small-text" name="distributor_name" value="<?php echo $distributor_name; ?>" style="width:100px" />
                              <input type="hidden" name="app" value="distributor_list" /><input class="regular-button" type="submit" value="<?php echo $a_langpackage->a_serach;?>" />
                        </td>
                    </tr>
                    </tbody>
                </table>
    ...
    <div class="content2">
		<table class="list_table" style='font-size:12px;'>
			...
			<tr style=" text-align:center;">
				<th width="50px"><a href="m.php?app=distributor_list&orderby=distributor_id">ID</a></th>
				<th align="left"><?php echo $a_langpackage->a_distributor_name; ?></th>
				<th width="65px"><a href="m.php?app=distributor_list&orderby=sort_order"><?php echo $a_langpackage->a_show_sort; ?></a></th>
			...
			<tr style=" text-align:center;">
				...
				<td align="left"><?php echo $value['distributor_name'];?></td>
                                <td><div onclick="editnum(this,<?php echo $value['distributor_id'];?>,'divorder<?php echo $value['distributor_id'];?>','a.php?act=updateAjax','tablename=distributor&colname=sort_order&idname=distributor_id&idvalue=<?php echo $value['distributor_id'];?>&logcontent=<?php echo $a_langpackage->a_distributor_edit; ?>：&colvalue=',2);"><?php echo $value['sort_order'];?></div>
				    <div style="display:none"></div>
				</td>
				<td>
					<a href="m.php?app=distributor_edit&id=<?php echo $value['distributor_id'];?>"><?php echo $a_langpackage->a_update; ?></a>
					<a href="a.php?act=distributor_del&id=<?php echo $value['distributor_id'];?>" onclick="return confirm('<?php echo $a_langpackage->a_distributor_del_mess; ?>');"><?php echo $a_langpackage->a_delete; ?></a>
				</td>
			</tr>
			<?php }} else { ?>
			<tr>
