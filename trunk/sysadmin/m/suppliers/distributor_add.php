...
<div id="maincontent">
    ...
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt; <?php echo $a_langpackage->a_distributor_add; ?></div>
        <hr/>
        <div class="infobox">
            <h3><span class="left"><?php echo $a_langpackage->a_distributor_add; ?> </span><span class="right"
                                                                                                 style="margin-right:15px;"><a
                        href="m.php?app=distributor_list"
                        style="float:right;"><?php echo $a_langpackage->a_distributor_list; ?></a></span></h3>
                ...
                <form action="a.php?act=distributor_add" method="post" onsubmit="return checkform();">
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td><input class="small-text" type="text" name="distributor_name"
                        ...
                        <tr>
                            ...
                            <td><textarea name="distributor_intro" cols="45"
                                          rows="5"><?php echo $info['distributor_intro']; ?></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="button-container"><input class="regular-button" type="submit" name="submit"
                                                                      value="<?php echo $a_langpackage->a_distributor_add; ?>"/></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
