...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;  <?php echo $a_langpackage->a_notification_policy_management ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
...
=======
                            <td>
                                政策通知搜索: <input type="text" class="small-text" name="policy_title"
                                               value="<?php echo $policy_title; ?>" style="width:100px"/>
                                <input type="hidden" name="app" value="notification_policy_list"/><input
...
>>>>>>> remotes/origin/master
	...
	<a href="m.php?app=notification_policy_add"
       style="float:right;"><?php echo $a_langpackage->a_notification_policy_add; ?></a>
	</span></h3>
<<<<<<< HEAD
    <div class="content2">
...
=======
            ...
            <div class="content2">
                <table class="list_table" style='font-size:12px;'>
                    ...
                    <tr style=" text-align:center;">
                        <th width="50px">ID <a
                                href="m.php?app=notification_policy_list&orderby=a.policy_id&orderway=asc">↑</a><a
                                href="m.php?app=notification_policy_list&orderby=a.policy_id&orderway=desc">↓</a></th>
                        ...
                        <th width="65px"><?php echo $a_langpackage->a_show_sort; ?> <a
                                href="m.php?app=notification_policy_list&orderby=a.sort_order&orderway=asc">↑</a><a
                                href="m.php?app=notification_policy_list&orderby=a.sort_order&orderway=desc">↓</a></th>
                        <th width="115px"><?php echo $a_langpackage->a_operate; ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if ($result) {
                        foreach ($result as $value) {
                            ...
                            <tr style=" text-align:center;">
                                ...
                                <td>
                                    <div
                                        onclick="editnum(this,<?php echo $value['policy_id']; ?>,'divorder<?php echo $value['policy_id']; ?>','a.php?act=updateAjax','tablename=notification_policy&colname=sort_order&idname=policy_id&idvalue=<?php echo $value['policy_id']; ?>&logcontent=<?php echo $a_langpackage->a_edit_category; ?>：&colvalue=',2);"><?php echo $value['sort_order']; ?></div>
                                    <div style="display:none"></div>
                                </td>
                                <td>
                                    <a href="m.php?app=notification_policy_edit&id=<?php echo $value['policy_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                                    <a href="a.php?act=notification_policy_del&id=<?php echo $value['policy_id']; ?>"
                                       onclick="return confirm('<?php echo $a_langpackage->a_notification_policy_del_mess; ?>');"><?php echo $a_langpackage->a_delete; ?></a>
                                </td>
                            </tr>
                        <?php }
                    } else { ?>
