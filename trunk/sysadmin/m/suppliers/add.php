...
<div class="crumbs"><?php echo $a_langpackage->a_location; ?>
    ...
    &gt;&gt; <?php echo $a_langpackage->a_suppliers_add; ?></div>
<hr/>
<div class="infobox">
<h3><span class="left"><?php echo $a_langpackage->a_suppliers_add; ?></span><span class="right"
                                                                                  style="margin-right:15px;"><a
            href="m.php?app=suppliers_list"><?php echo $a_langpackage->a_suppliers_list; ?></a></span></h3>

<div class="content2">
<form method="post" action="a.php?act=suppliers_add" name="form_suppliers_add" onsubmit="return check_form(this)"
...
<table class="list_table" style="float:left; width:48%;">
    ...
    <tr>
        ...
        <td><input type="text" name="company_address" maxlength="200" style="width:300px"/> <span class="red">*</span>
        </td>
    </tr>
    <tr>
...
<table class="list_table" style="clear:both; border:0px; padding:0px; margin:0px;">
    ...
    <tr>
        <td colspan="2" align="center"><span class="button-container"><input class="regular-button" type="submit"
                                                                             name="btn_submit"
                                                                             value="<?php echo $a_langpackage->a_suppliers_add; ?>"/></span>
        </td>
    </tr>
    </tbody>
</table>
