...
<div id="maincontent">
    <div class="wrap">
        ...
        <div class="infobox">
            <h3>
                <span class="left"><?php echo $a_langpackage->a_suppliers_categories_export ?></span>
	...
	<a href="m.php?app=suppliers_categories_list"
       style="float:right;"><?php echo $a_langpackage->a_suppliers_category; ?></a>
            ...
            <div class="content2">
                ...
                <form action="a.php?act=suppliers_categories_export" method="post" id="cvsform" name='cvsform'>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input class="submit" type="submit" name="submit"
                                       value="<?php echo $a_langpackage->a_suppliers_categories_export; ?>"/>
                            </td>
                        </tr>
                    </table>
                </form>
