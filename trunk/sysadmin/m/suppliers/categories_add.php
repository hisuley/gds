...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_category_add; ?></div>
        <hr />
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_category_add; ?> </span><span class="right" style="margin-right:15px;"><a href="m.php?app=suppliers_categories_list" style="float:right;"><?php echo $a_langpackage->a_suppliers_list; ?></a></span></h3>
    <div class="content2">
