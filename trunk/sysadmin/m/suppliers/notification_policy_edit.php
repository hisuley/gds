...
if(!$policy_id) {exit($a_langpackage->a_error);}
...
<?php  include("messagebox.php");?>
	<div class="wrap">
	<div class="crumbs"><?php echo $a_langpackage->a_location; ?> &gt;&gt; <?php echo $a_langpackage->a_m_suppliers_mengament;?> &gt;&gt; <?php echo $a_langpackage->a_notification_policy_edit; ?></div>
    <hr />
	<div class="infobox">
	<h3><span class="left"><?php echo $a_langpackage->a_notification_policy_edit; ?></span><span class="right" style="margin-right:15px;"><a href="m.php?app=notification_policy_list"><?php echo $a_langpackage->a_notification_policy_list; ?></a></span></h3>
    <div class="content2">
		  ...
		  <tbody>
			<tr>
				...
				<td valign="top"><?php echo $a_langpackage->a_notification_policy_content; ?>：</td>
                                <td><textarea name="policy_content" cols="45" rows="5"><?php echo $info['policy_content']; ?></textarea> <span>*</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="2"><input type="submit" class="regular-button" name="submit" value="<?php echo $a_langpackage->a_notification_policy_edit; ?>" /></td>
			</tr>
		</tbody>
		</table>
		</form>
