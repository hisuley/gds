...
<div id="maincontent">
    <div class="wrap">
        ...
        <div class="infobox">
            <h3>
                <span class="left"><?php echo $a_langpackage->a_suppliers_categories_import ?></span>
	<span class="right" style="margin-right:15px;"> 
	<a href="m.php?app=suppliers_categories_list"
       style="float:right;"><?php echo $a_langpackage->a_suppliers_category; ?></a>
	</span></h3>

            <div class="content2">
                <form action="a.php?act=suppliers_categories_import" method="post" id="cvsform" name='cvsform'
                    ...
                    <table width="100%" style="border:0" cellspacing="0">
                        ...
                        <tr>
                            <td></td>
                            <td align="left"><input class="submit" type="submit" name="submit"
                                                    value="<?php echo $a_langpackage->a_suppliers_categories_import; ?>"/>
                            </td>
                        </tr>
                    </table>
                </form>
