...
<div id="maincontent">
    <div class="wrap">
        <div class="crumbs"><?php echo $a_langpackage->a_location; ?>
            ...
            &gt;&gt;  <?php echo $a_langpackage->a_suppliers_categorys ?></div>
        <hr/>
        <div class="seachbox">
            <div class="content2">
                <form action="m.php?app=suppliers_categories_list" name="searchForm" method="get">
                    <table class="form-table" style='font-size:14px;'>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $a_langpackage->a_category_name; ?>: <input type="text" class="small-text"
                                                                                       name="cat_name"
                                                                                       value="<?php echo $cat_name; ?>"
                                                                                       style="width:100px"/>
                                <input type="hidden" name="app" value="suppliers_categories_list"/><input
	...
	<a href="m.php?app=suppliers_categories_import"
       style="float:right;"><?php echo $a_langpackage->a_suppliers_categories_import; ?>&nbsp;&nbsp;</a>
	
	<a href="m.php?app=suppliers_categories_export"
       style="float:right;"><?php echo $a_langpackage->a_suppliers_categories_export; ?>&nbsp;&nbsp;</a>
	</span></h3>
            ...
            <div class="content2">
                <table class="list_table" style='font-size:12px;'>
                    ...
                    <tr style=" text-align:center;">
                        <th width="50px">ID <a
                                href="m.php?app=suppliers_categories_list&orderby=cat_id&orderway=asc">↑</a><a
                                href="m.php?app=suppliers_categories_list&orderby=cat_id&orderway=desc">↓</a></th>
                        <th align="left"><?php echo $a_langpackage->a_category_name; ?></th>
                        <th width="65px"><?php echo $a_langpackage->a_shop_num; ?></th>
                        <th width="65px"><?php echo $a_langpackage->a_suppliers_commission_ratio; ?><a
                                href="m.php?app=suppliers_categories_list&orderby=commission_ratio&orderway=asc">↑</a><a
                                href="m.php?app=suppliers_categories_list&orderby=commission_ratio&orderway=desc">↓</a>
                        </th>
                        <th width="65px"><?php echo $a_langpackage->a_show_sort; ?> <a
                                href="m.php?app=suppliers_categories_list&orderby=sort_order&orderway=asc">↑</a><a
                                href="m.php?app=suppliers_categories_list&orderby=sort_order&orderway=desc">↓</a></th>
                    ...
                    <?php if ($category_dg) {
                        foreach ($category_dg as $value) {
                            ...
                            <tr style=" text-align:center;">
                                ...
                                <td align="left" <?php if ($value['parent_id'] == '0') {
                                    echo 'style="font-weight:bold;"';
                                } ?>>
                                    <div>
                                        <div id="divname"><?php echo $value['str_pad']; ?>&nbsp;</div>
                                        <div id="divname"
                                             onclick="edit(this,<?php echo $value['cat_id']; ?>,'divname<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=shop_categories&colname=cat_name&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=<?php echo $a_langpackage->a_edit_category; ?>：&colvalue=',5);"><?php echo $value['cat_name']; ?></div>
                                ...
                                <td>
                                    <div
                                        onclick="editnum(this,<?php echo $value['cat_id']; ?>,'divorder<?php echo $value['cat_id']; ?>','a.php?act=updateAjax','tablename=shop_categories&colname=sort_order&idname=cat_id&idvalue=<?php echo $value['cat_id']; ?>&logcontent=<?php echo $a_langpackage->a_edit_category; ?>：&colvalue=',2);"><?php echo $value['sort_order']; ?></div>
                                    <div style="display:none"></div>
                                </td>
                                <td>
                                    <a href="m.php?app=suppliers_categories_edit&id=<?php echo $value['cat_id']; ?>"><?php echo $a_langpackage->a_update; ?></a>
                                    <a href="a.php?act=suppliers_categories_del&id=<?php echo $value['cat_id']; ?>"
                                       onclick="return confirm('<?php echo $a_langpackage->a_del_category_prompt; ?>？');"><?php echo $a_langpackage->a_delete; ?></a>
                                </td>
                            </tr>
                        <?php }
                    } else { ?>
