<?php
	...
	*/
	...
	if (empty($errstr)) {
		action_return(1,$a_langpackage->a_import_file_success,"m.php?app=suppliers_categories_list");
	}else{
		action_return(1,$a_langpackage->a_import_file_error.$errstr,"m.php?app=suppliers_categories_list");
	}
