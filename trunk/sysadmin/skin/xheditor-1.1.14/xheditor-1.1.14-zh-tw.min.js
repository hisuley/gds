(function (e, $) {
    ...
    var fb = {27: "esc", 9: "tab", 32: "space", 13: "enter", 8: "backspace", 145: "scroll", 20: "capslock", 144: "numlock", 19: "pause", 45: "insert", 36: "home", 46: "del", 35: "end", 33: "pageup", 34: "pagedown", 37: "left", 38: "up", 39: "right", 40: "down", 112: "f1", 113: "f2", 114: "f3", 115: "f4", 116: "f5", 117: "f6", 118: "f7", 119: "f8", 120: "f9", 121: "f10", 122: "f11", 123: "f12"}, Ta = "#FFFFFF,#CCCCCC,#C0C0C0,#999999,#666666,#333333,#000000,#FFCCCC,#FF6666,#FF0000,#CC0000,#990000,#660000,#330000,#FFCC99,#FF9966,#FF9900,#FF6600,#CC6600,#993300,#663300,#FFFF99,#FFFF66,#FFCC66,#FFCC33,#CC9933,#996633,#663333,#FFFFCC,#FFFF33,#FFFF00,#FFCC00,#999900,#666600,#333300,#99FF99,#66FF99,#33FF33,#33CC00,#009900,#006600,#003300,#99FFFF,#33FFFF,#66CCCC,#00CCCC,#339999,#336666,#003333,#CCFFFF,#66FFFF,#33CCFF,#3366FF,#3333FF,#000099,#000066,#CCCCFF,#9999FF,#6666CC,#6633FF,#6600CC,#333399,#330099,#FFCCFF,#FF99FF,#CC66CC,#CC33CC,#993399,#663366,#330033".split(","),
        gb = [
            ...
            {n: "x-small", s: "10px", t: "\u6975\u5c0f"},
            {n: "small", s: "12px", t: "\u7279\u5c0f"},
            {n: "medium", s: "16px", t: "\u5c0f"},
            {n: "large", s: "18px", t: "\u4e2d"},
            {n: "x-large", s: "24px", t: "\u5927"},
            {n: "xx-large", s: "32px", t: "\u7279\u5927"},
            {n: "-webkit-xxx-large", s: "48px", t: "\u6975\u5927"}
        ], ib = [
        ...
        ], kb = {"default": {name: "\u9810\u8a2d", width: 24, height: 24, line: 7, list: {smile: "\u5fae\u7b11", tongue: "\u5410\u820c\u982d", titter: "\u5077\u7b11", laugh: "\u5927\u7b11", sad: "\u96e3\u904e", wronged: "\u59d4\u5c48", fastcry: "\u5feb\u54ed\u4e86", cry: "\u54ed", wail: "\u5927\u54ed", mad: "\u751f\u6c23", knock: "\u6572\u6253", curse: "\u7f75\u4eba", crazy: "\u6293\u72c2", angry: "\u767c\u706b", ohmy: "\u9a5a\u8a1d",
    ...
    var lb = {a: "Link", img: "Img", embed: "Embed"}, mb = {"<": "&lt;", ">": "&gt;", '"': "&quot;", "\u00ae": "&reg;", "\u00a9": "&copy;"}, nb = /[<>"\u00ae\u00a9]/g, ra = function (z, o) {
        ...
        this.init = function () {
            ...
            j = "<html><head>" + P + "<title>\u53ef\u8996\u5316\u7de8\u8f2f\u5668,alt+1\u52309\u9375,\u5207\u63db\u5230\u5de5\u5177\u5340,tab\u9375,\u9078\u64c7\u6309\u9215,esc\u9375,\u8fd4\u56de\u7de8\u8f2f " +
            ...
            g.html5Upload && j.bind("dragenter dragover",
                function (a) {
                    ...
                    if (a && (b = a.files) && 0 < b.length) {
                        ...
                        1 === k ? alert("\u4e0a\u50b3\u6587\u4ef6\u7684\u64f4\u5c55\u540d\u5fc5\u9700\u70ba\uff1a" + j.replace(/\w+:,/g, "")) : 2 === k ? alert("\u6bcf\u6b21\u53ea\u80fd\u62d6\u653e\u4e0a\u50b3\u540c\u4e00\u985e\u578b\u6587\u4ef6") : k && d.startUpload(b, g["up" + k + "Url"], "*", function (a) {
                            var b = [], c;
                            (c = g.onUpload) && c(a);
        ...
        this.processHTML = function (a, b) {
            if ("write" === b) {
                ...
                a = a.replace(/(<(\w+))((?:\s+[\w\-:]+\s*=\s*(?:"[^"]*"|'[^']*'|[^>\s]+))*)\s*(\/?>)/g, function (a, b, c, d, e) {
                    var c = c.toLowerCase(), f, d = d.replace(/\s+_xhe_(?:src|href)\s*=\s*("[^"]*"|'[^']*'|[^>\s]+)/i, function (a, b) {
                        f = b.match(/^(["']?)(.*)\1/)[2];
                        return""
                    });
                    f && va && (f = V(f, va, F));
        ...
        this.formatXHTML = function (a, b) {
            ...
            var D = c("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"), k = c("address,applet,blockquote,button,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,p,pre,table,tbody,td,tfoot,th,thead,tr,ul,script"), y = c("a,abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),
                Z = c("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr"), l = c("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"), h = c("script,style"), o = {b: "strong", i: "em", s: "del", strike: "del"}, n = /<(?:\/([^\s>]+)|!([^>]*?)|([\w\-:]+)((?:"[^"]*"|'[^']*'|[^"'<>])*)\s*(\/?))>/g, x = /\s*([\w\-:]+)(?:\s*=\s*(?:"([^"]*)"|'([^']*)'|([^\s]+)))?/g, H = [], E = [];
            E.last = function () {
        ...
        this.toggleSource = function (a) {
            if (x !== a) {
                ...
                if (x)f = d.getSource(), c.html("").removeAttr("scroll").attr("class",
                    "editMode" + Q), h ? b.contentEditable = "true" : l.designMode = "On", qa && (d._exec("inserthtml", "-"), e("#" + za).show().focus().hide()), g = "\u539f\u59cb\u78bc"; else {
        ...
        this.showPreview = function () {
            ...
            a && (b = a(b));
            var a = "<html><head>" + P + "<title>\u9810\u89bd</title>" + (F ? '<base href="' + F + '"/>' : "") + "</head><body>" + b + "</body></html>", b = window.screen, b = window.open("", "xhePreview", "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + Math.round(0.9 * b.width) + ",height=" + Math.round(0.8 * b.height) + ",left=" + Math.round(0.05 * b.width)), c = b.document;
            c.open();
            c.write(a);
            c.close();
            b.focus()
        ...
        this.showPastetext = function () {
            var a = e('<div><label for="xhePastetextValue">\u4f7f\u7528\u9375\u76e4\u5feb\u6377\u9375(Ctrl+V)\u628a\u5167\u5bb9\u8cbc\u4e0a\u5230\u65b9\u6846\u88e1\uff0c\u6309 \u78ba\u5b9a</label></div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u78ba\u5b9a" /></div>'),
        ...
        this.showLink = function () {
            ...
            if (c) {
                ...
                a = a.replace(/(<div><label for="xheLinkTarget)/, '<div><label for="xheLinkAnchor">\u9801\u5167\u9328\u9ede: </label><select id="xheLinkAnchor"><option value="">\u672a\u9078\u64c7</option>' + f.join("") + "</select></div>$1")
            }
        ...
        this.showAnchor = function () {
            var a = e('<div><label for="xheAnchorName">\u9328\u9ede\u540d\u7a31: </label><input type="text" id="xheAnchorName" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="\u78ba\u5b9a" /></div>'), b = d.getParent("a"), c = e("#xheAnchorName", a), f = e("#xheSave", a);
            if (1 === b.length) {
        ...
        this.uploadInit = function (a, b, c) {
            ...
            if ("!" === b.substr(0, 1))m.click(function () {
                d.showIframeModal("\u4e0a\u50b3\u6587\u4ef6", b.substr(1), f, null, null)
            }); else {
        ...
        this.startUpload = function (a, b, c, f) {
            ...
            var m = [], j = g.html5Upload, p = j ? g.upMultiple : 1, h, s = e('<div style="padding:22px 0;text-align:center;line-height:30px;">\u6587\u4ef6\u4e0a\u50b3\u4e2d\uff0c\u8acb\u7a0d\u5019\u2026\u2026<br /></div>'), r = '<img src="' + ua + 'img/loading.gif">';
            ...
            d.showModal("\u6587\u4ef6\u4e0a\u50b3\u4e2d(Esc\u53d6\u6d88\u4e0a\u50b3)", s, 320, 150);
            c.start()
        };
        ...
        this.showModal = function (a, b, c, f, i) {
            ...
            c = c ? c : g.modalWidth;
            f = f ? f : g.modalHeight;
            K = e('<div class="xheModal" style="width:' + (c - 1) + "px;height:" + f + "px;margin-left:-" + Math.ceil(c / 2) + "px;" + (h && 7 > pa ? "" : "margin-top:-" + Math.ceil(f / 2) + "px") + '">' + (g.modalTitle ? '<div class="xheModalTitle"><span class="xheModalClose" title="\u95dc\u9589 (Esc)" tabindex="0" role="button"></span>' + a + "</div>" : "") + '<div class="xheModalContent"></div></div>').appendTo("body");
