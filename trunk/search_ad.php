...
<div id="wrapper">
    ...
    <div class="path"><?php echo $i_langpackage->i_location; ?>：<a
            href="index.php"><?php echo $i_langpackage->i_index; ?></a> > <?php echo $i_langpackage->i_serach_ad; ?>
    </div>
    <div class="pro_class">
        <FORM action="search.php" method='GET'>
            <TABLE cellSpacing=8 cellPadding=0 width="100%" align=center border=0>
                ...
                <TR>
                    ...
                    <TD><SELECT name="brand_id">
                            ...
                            <?php foreach ($brand_rs as $value) { ?>
                                <OPTION
                                    value=<?php echo $value['brand_id']; ?>><?php echo $value['brand_name']; ?></OPTION>
                            <?php } ?>
                        </SELECT></TD>
                </TR>
                <TR>
                    <TD align=right><?php echo $i_langpackage->i_price; ?>：</TD>
                    <TD><INPUT maxLength=8 size=10 name=min_price> - <INPUT maxLength=8 size=10 name=max_price></TD>
                </TR>
                <TR>
                    ...
                    <TD><span id="user_country"><select name="country" onchange="areachanged(this.value,0);">
                                ...
                                <?php foreach ($areas_info[0] as $v) { ?>
                                    <option value="<?php echo $v['area_id']; ?>" <?php if ($v['area_id'] == 1) {
                                        echo 'selected';
                ...
                <TR>
                    <TD align=right> </TD>
                    <TD height="40"><input class="button" type="submit" name="button" id="button"
                                           value="<?php echo $i_langpackage->i_post; ?>"/>
                    </TD>
                </TR>
            </TABLE>
        </FORM>
