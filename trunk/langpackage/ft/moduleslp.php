...
class moduleslp{
	...
	var $m_error_createshop = "只有申請並通過審核可以創建店舖！";

	var $m_error_messageshow = "錯誤信息提示";
	var $m_error_login = "您還沒有登錄!";
	/* menu */
	var $m_u_center = "個人中心";
	var $m_buyer = "我是買家";
	var $m_seller = "我是賣家";
	...
	var $m_base_setting = "個人設置";
	var $m_profile = "個人信息";
	var $m_web_navigation = "網站導航";
	var $m_goods_search ="搜商品";
	var $m_s_company = "搜商家";
	var $m_personal_home ="個人中心首頁";
	var $m_current_position ="您當前的位置是：";
	var $m_order_inquiry ="訂單查詢";

	var $m_createshop_vip = "企業會員才可";
	var $m_shop_view = "店舖預覽";
    ...
    var $m_apply_refund="申請退款";
    var $m_already_valuation="已評價";
    var $m_already_complain="已投訴";
...
//	var $m_goods_photo = "相冊";	/* favorite */
	...
	var $m_shop_bannerimg_msg = "建議大小:960X150,不修改請留空！";
	...
	var $m_order_thisbuyprice = "這次購物需要支付的總價";
	var $m_contact = "聯繫人";
	...
	var $m_hiserver_member_wait = "您的企業信息已提交，管理員正在審核中，請等待！";
	var $m_hiserver_member_fail = "審核失敗，請詳細正確填寫以下選項。";
	var $m_request_compayname = "企業名稱或個人姓名";
	...
	var $m_copyright = "版權所有 © 2005-2009 桂林旅游营销系统開放式技術實驗室，並保留所有權利。";
	var $m_isset_payment = "您還沒有設置支付方式!";


    var $m_start_time_error="開始時間不能大於結束時間";
    var $m_startend_time_error="開始時間或結束時間不能小於當前時間";
    var $m_timeformat_error="請輸入正確的時間格式 如：1999-01-01";
    var $m_goods_store="商品收藏";
    var $m_shop_store="店舖收藏";
    var $m_shop_logo="店舖logo";
    var $m_shop_infomation="店舖信息";
    var $m_forgot_info="此鏈接已失效";
    var $m_all_select="全選";
    var $m_reverse="反選";
    var $m_change_address="更換地址";
    var $m_confirm_get_address="確認收貨地址";
    var $m_confirm_address_error="不能添加新地址，請您去收貨地址進行操作！";
    var $m_buy_prompt="買家提醒";
    var $m_sell_prompt="賣家提醒";
    //goods
    var $m_goods_price_error="商品價格格式不正確";
    var $m_transport_error="運費格式不正確";
    var $m_store_form_error="庫存格式不正確";
    var $m_stort_type="運費方式";
    var $m_postage_template="郵費模板費用";
    var $m_stort_expense="運費費用";
    var $m_px="像素";
    var $m_goods_picinfo="圖片應小於1M，jpg、png或gif格式。建議為";
    var $m_other_brand="其它品牌";
    var $m_user_upload_pic="使用已上傳圖片";
    var $m_mygoods_error="自己的商品不能放入購物車";
    var $m_store_mygoods_error="自己的商品不能收藏";

    var $m_page_request_error="頁面請求已失效";
    var $m_goods_pk="商品對比";
    var $m_all_category="全部分類";
    var $m_all_remove="全部移除";
    var $m_remove="移除";
    var $m_collect="收藏";
    var $m_pic="圖片";
    var $m_move_cart="放入購物車";
    var $m_expense_country="運費(至全國)";
    var $m_money_sign="￥";
    var $m_store_info="此商舖已在您的收藏夾";
    var $m_shop_error="非法操作,店舖不存在";
    var $m_sys_error="繫統錯誤";
    var $m_import_taobao="導入淘寶csv";
    //reg
    var $m_member_register="會員註冊提示";
    var $m_think_register="感謝註冊";
    var $m_we="我們向";
    var $m_send_email="發送了激活郵件。";
    var $m_confirm_prompt="請點擊裡面的確認鏈接激活賬戶。";
    var $m_receive_email="沒有收到激活郵件？";
    var $m_register_prompt="在垃圾郵件目錄裡找找，或者";
    var $m_register_prompt1="重發郵件";
    var $m_register_prompt2="註冊郵箱是否正確：";
    var $m_register_prompt3="換其它郵箱註冊";
    var $m_forget_password="如果你忘記了登錄密碼";
    var $m_picchar="輸入圖片中的字符：";
    var $m_change_pic="換一張";
    var $m_email_form="您輸入的郵箱格式不正確";
    var $m_code_error="驗證碼不能為空";
    //shop
    var $m_s_category="商舖分類";
    var $m_default_template="默認模板";
    var $m_green_template="綠色模板";
    var $m_blue_template="藍色模板";
    var $m_red_template="紅色模板";
    var $m_purple_template="紫色模板";
    var $m_gray_template="灰色模板";
    var $m_credit_goods="好";
    var $m_credit_middle="中";
    var $m_credit_bad="差";
    var $m_close_map="點擊關閉地圖，設置完畢";
    var $m_check_complay="名稱不能為空！";
    var $m_check_person="法人代表姓名不能為空！";
    var $m_check_card="證件號碼不能為空！";
    var $m_check_truecard="請填寫真實的證件號碼！";
    var $m_check_address="公司地址不能為空！";
    var $m_check_postcode="郵編不能為空！";
    var $m_check_postcodeisnum="郵編必須是數字！";
    var $m_check_mobile="手機不能為空！";
    var $m_check_mobileisnum="手機必須是數字！";
    var $m_check_phone="電話不能為空！";
    var $m_check_phoneisnum="電話必須是數字！";
    //modules
    var $m_change_email="更換郵箱";
    var $m_register_username="您註冊的用戶名";
    var $m_register_password="您註冊時的密碼";
    var $m_new_email="您的新郵箱";
    var $m_fill_email="請填寫新郵箱";
    var $m_fill_right="請填寫正確的郵箱格式";
    var $m_changeemail_error="已經被鎖定或者已經通過郵箱驗證";
    var $m_programa="收起欄目/展開欄目";
    var $m_select_goods="請選擇您要購買的商品";
    var $m_select_goods_error="本商品不屬於同一店舖！";

    var $m_merge_order="合並所選訂單";
    var $m_same_order_error="不屬於同一店舖的訂單不能合並";
    var $m_select_order="請選擇要合並的訂單";
    var $m_tow_order="至少兩張訂單才能合並";
    var $m_merge_prompt="合並後的訂單收貨信息等将以最新的訂單為準，您確定要合並選擇的訂單嗎";

    var $m_enter_info="你輸入的信息有誤";
    var $m_user_locked="您已經被鎖定了";
    var $m_mail_use="郵箱已使用，請更換";
    var $m_mail_send_succ="發送成功";
    var $m_mail_config_error="網站暫時不提供郵件服務";
    var $m_select_user_error="查無此人";
    var $m_search_type="至少選擇一種配送方式";
    var $m_img_prompt="您已經上傳超過";
    var $m_img_prompt2="M的圖片，請清理後繼續上傳";
    var $m_mail_format="請填寫正確的郵箱地址";
    var $m_succ_prompt="發送成功，請進行郵箱驗證";
    var $m_del_select="請選擇刪除選項";
    var $m_no_refund="不符合退款要求";
    var $m_refund_succ="退款成功";
    var $m_zhifubao_vouch="支付寶純擔保";
    var $m_caifutong_soon="财付通即時到帳";
    var $m_caifutong_vouch="财付通中介擔保";
    var $m_illegal="非法請求";
    var $m_add_lable="添加商品標簽成功";
    var $m_add_lable_fail="很抱歉，添加商品標簽失敗";
    var $m_download_error="無法下載文件";
    var $m_file_type_error="文件類型不對";
    var $m_import_succ="導入成功";
    var $m_di="第";
    var $m_import_fail="行導入失敗";
    var $m_iconv_str="商品ID,店舖ID,商品名稱,分類ID,自定義分類ID,品牌ID,屬性類型ID,商品描述,批發說明,商品庫存,商品價格,商品運費,關鍵字,是否刪除,是否精品,是否新品,是否熱銷,是否特價,是否上架,是否設置圖片,商品縮略圖,關註度,被收藏次數,排序,添加時間,最後更新時間,是否鎖定,原始圖片 \n";
    var $m_paper_upload="證件上傳";
    var $m_work_count_error="輸入字數超長";
