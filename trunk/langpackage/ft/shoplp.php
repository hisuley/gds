...
class shoplp{
	...
	var $s_no_category="沒有分類！";
	var $s_no_message="沒有資訊！";
	var $s_message_center="資訊中心";
	var $s_no_goods2="沒有商品";
	var $s_no_news="不存在此資訊!";
	var $s_this_location="當前位置：";
	var $s_mall_intro="商城簡介";
	var $s_mall_intro2="關於商城";
	var $s_no_this_goods="沒有此商舖";
	var $s_shop_category="店舖分類";
	var $s_credit_good="好";
	...
	var $s_money_sign="￥";
	var $s_page_num1="當前第";
	var $s_page_num2="頁/總共";
	var $s_page_num3="頁";
    
	var $s_goods_locked="此商品已被鎖定";
    var $s_goods_error="沒有此商品";
    var $s_shop_error="沒有此商舖！";
    var $s_country="全國";
    var $s_all_category="全部分類";
    var $s_may_buy="可購";
    var $s_piece="件";
    var $s_have="已有";
    var $s_share="分&nbsp;享&nbsp;到：";
    ...
    var $s_kaixin="開心";
    var $s_douban="豆瓣";
    var $s_store_shop="收藏店舖";
    var $s_send_mail="發站内信";
    var $s_goods_label="商品標簽";
    var $s_enter_label="請在此輸入自定義標簽";
    var $s_add="添加";
    var $s_seller_commend="賣家推薦";
    var $s_mygoods_error="自己的商品不能放入收藏";
    var $s_myshop_error="自己的店舖不能收藏";
    var $s_store_mygoods_error="自己的商品不能放入購物車";
    var $s_store_info="此商舖已在您的收藏夾";
    var $s_shop_error1="非法操作,店舖不存在";
    var $s_buy_mygoods="自己不能購買自己的商品";
    var $s_less_stock="購買數量應小於庫存數!";
    var $s_enter_goods_label="請輸入商品標簽";
    var $s_no_login="對不起,您還沒有登錄";
    var $s_close="關閉";
    
    var $s_group_buy="團購展示";
    var $s_no_group="沒有此團購";
    var $s_shop_locked="此商舖已鎖定";
    var $s_shop_close="此商舖已關閉";
    var $s_no_notice="暫無公告";
    var $s_goods_commend="商品推薦";
    var $s_freight="運費";
    var $s_new_goods="最新上架";
    var $s_plugin="插件展示 ";
    var $s_work_count_error="輸入字數超長";
}
?>