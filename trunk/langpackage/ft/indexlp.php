...
class indexlp{
	...
	var $i_re_your_password ="請輸入您的常用郵箱，方便日後找回密碼。";
	/* forgot */
	...
	var $i_email_check="您已通過驗證，請勿重復驗證。";
	var $i_pass_check="恭喜您已通過驗證。";
	var $i_again_send="郵箱驗證碼錯誤，請重新發送。";
	var $i_check_url_error="url不完整，請確認。";
	var $i_goods_error="沒有此商品";
	
	var $i_shop_index="商城首頁";
	var $i_websit_navigation="網站導航";
	var $i_search_keyword="請輸入你要搜索的關鍵字";
	var $i_brand_list="品牌列表";
	var $i_no_product="沒有商品";
	var $i_locus="所在地";
	var $i_search_category="請選擇分類";
	var $i_search_brand="請選擇品牌";
	var $i_login_info="登錄社區，你将得到以下服務";
	var $i_no_shop="您訪問的店舖不存在!";
	var $i_href="繫統将在<span id=\"skip\">3</span>秒鐘返回...";
	var $i_hand_index="如果瀏覽器沒有自動調整，點擊這裡返回";
	var $i_brand_detail="品牌詳細頁";
	var $i_company_website="公司網站";
	var $i_category_filter="篩選分類";
	var $i_all="全部";
	...
	var $i_collection="收藏";
	var $i_contrast="對比";
	var $i_hot_label="熱門標簽集";
	var $i_start_compare="開始比較";
	var $i_illegal="非法請求";
	var $i_shop_filter="商品篩選";
	var $i_goods_commend="人氣商品推薦";
	var $i_brower_register="瀏覽記錄";
	var $i_compare_error1="只能比較同類商品";
	var $i_compare_error2="已經選擇了此商品";
	var $i_compare_error3="只能同時對比5個商品";
	var $i_all_category2="全部分類";
	var $i_groupbuy_list="團購列表";
	var $i_groupbuy_say="團購說明";
	var $i_lay_out="團購展示";
	var $i_brand_navigation="名優品牌導航";
	var $i_better_shop="優秀店舖推薦";
	var $i_groupbuy="團購";
	var $i_integral="積分";
	var $i_shop_infomation="店舖信息";
	var $i_jian="件";
	var $i_contract_goods="商品對比";
	var $i_close="關閉";
	var $i_remove="移除";
	var $i_free_open="免費開店";
	
	var $i_page_error="你請求的頁面不存在或有錯誤！";
	var $i_work_count_error="輸入字數超長";
	
	var $i_g_addedfavorite = "已成功添加到您的收藏夾！";
	var $i_g_stayfavorite = "此商品已在您的收藏夾裡！";
	var $i_g_addfailed = "添加失敗，請確認您是否已登陸！";
