...
<div id="leftColumn">
            ...
            <li><span><?php echo $i_langpackage->i_brand; ?>：</span>
                <?php foreach ($brand_list as $value) { ?>
                    <?php if (!empty($value['brand_name'])) { ?>
                        ...
                        <?php } else { ?>
                            <a title="<?php echo $value['brand_name']; ?>"
                               href="<?php echo $value['url']; ?>"><?php echo $value['brand_name']; ?></a>
                        <?php } ?>
                    <?php } ?>
                <?php } ?>
            </li>
    ...
    <div id="leftMian" class="content-common-box content-left-big-box">
        <div class="title">
            ...
            <ul class="toolbar">
                <a id="list" class="selected" hidefocus="true" href="javascript:void(0);"
                   onclick="changeStyle2('list',this)"><?php echo $i_langpackage->i_list; ?></a>
                <a id="window" hidefocus="true" href="javascript:void(0);"
                   onclick="changeStyle2('window',this)"><?php echo $i_langpackage->i_show_window; ?></a>
            </ul>
        </div>
            ...
            <ul class="list_view">
                <?php foreach ($goods_list as $k => $v) { ?>
                    <li id="showli_<?php echo $v['goods_id']; ?>" class="clearfix">
                        ...
                        <div class="smmery">
                            <h4>
                                <a href="<?php echo goods_url($v['goods_id']); ?>"><?php echo sub_str($v['goods_name'], 40); ?></a>
                            </h4>
                        ...
                        <div class="operating"><a class="addfavorite"
                            ...
                            <?php if ($v['goods_price'] == '0.00') { ?>
                                <a class="ask" title="<?php echo $i_langpackage->i_inquiry; ?>"
                                   href="inquiry.php?gid=<?php echo $v['goods_id']; ?>"></a>
                            <?php } else { ?>
                                <a class="itembuy" title="<?php echo $i_langpackage->i_buy; ?>"
                                   href="modules.php?app=user_order_adress&gid=<?php echo $v['goods_id']; ?>&v=1"></a>
                            <?php } ?>
                            <a class="compare" title="对比" href="javascript:;"
                               onclick="initFloatTips('<?php echo $v['goods_id']; ?>','<?php echo sub_str($v['goods_name'], 10); ?>',1,'<?php echo $v['cat_id']; ?>')"></a>
                        </div>
                    ...
                    <li id="showli_<?php echo $v['goods_id']; ?>" class="clearfix">
                        ...
                        <div class="operating">
                            <ul class="clearfix">
                                ...
                                <?php } ?>
                                <li><a class="compare" title="<?php echo $i_langpackage->i_contrast; ?>"
                                       href="javascript:;"
                                       onclick="initFloatTips('<?php echo $v['goods_id']; ?>','<?php echo sub_str($v['goods_name'], 10); ?>',1,'<?php echo $v['cat_id']; ?>')"></a>
                                </li>
                            </ul>
...
<div id="rightColumn">
    ...
    <?php if ($cat_id == 434) { ?>
        <div class="tagSet bg_gary mg12b content-common-box content-right-middle-box">
            ...
            <a href="http://weibo.com" style="
						display: block;
						margin-left: 10px;
						"><img src="http://www.sinaimg.cn/blog/developer/wiki/LOGO_64x64.png" style="
						margin-bottom: -20px;
						margin-right: 10px;
						">欢迎关注我们的微博</a>
            <!-- @TODO 判断用户是否订阅 -->
            <a href=".." style="
						...
						margin-top:30px;
						">
                <img src="skin/<?php echo $SYSINFO['templates']; ?>/images/rss.png" width="64" height="64" style="
						margin-bottom: -20px;
						margin-right: 10px;
						">
                RSS订阅景区信息</a>
        ...
        <div class="tags">
            <?php foreach ($tag_list as $value) { ?>
                <a href="<?php echo $value['url']; ?>"
                   style="color:<?php echo $value['tag_color']; ?>;<?php if ($value['is_blod']) { ?>font-weight:bold;<?php } ?>"><?php echo $value['tag_name']; ?></a>
            <?php } ?>
        </div>
    </div>
...
<div id="contrastbox"
    ...
    <form action="modules.php?app=contrast" method="post" target="_blank" id="contrastform">
        ...
        <a onclick="document.getElementById('contrastform').submit();return false;" href="javascript:;" class="button_4"
           style=" position:relative;top:25px;display:block;margin-left:100px; width:76px;height:24px;"><img
                src="skin/default/images/icon_contrast.gif" alt="<?php echo $i_langpackage->i_start_compare; ?>"
