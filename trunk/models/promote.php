...
$t_promote = $tablePreStr."promotions";
...
$header['title'] = "促销 - ".$SYSINFO['sys_title'];
...
foreach($promotes_id as $key=>$val){
    $promote_id[$key]=$val[0];
}
...
$sql .= " WHERE b.recommended = 0 and g.lock_flg =0 and b.group_condition ='0' and b.is_enabled = '1'";
if(!empty($kk)){
