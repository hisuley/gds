...
$sql = "select a.id,a.amount,a.add_time,a.user_note,a.payment,b.user_name from `$t_user_account` as a left join `$t_users` as b on a.user_id=b.user_id where a.user_id='$user_id' and a.process_type=0";
if ($start_time) {
