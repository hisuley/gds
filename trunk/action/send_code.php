...
if(!preg_match("/^([a-zA-Z0-9._-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/",$user_email)) {
...
if($row['user_email']!=$user_email) {
	action_return(0,$m_langpackage->m_mail_format,"-1");
}else{
...
//	( 这是系统自动产生的邮件，请勿回复。) <br />";
	...
	action_return(1,$m_langpackage->m_succ_prompt,'modules.php?app=email_verify');
}