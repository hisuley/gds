...
$user_verify_passwd = short_check(get_args('user_verify_passwd'));

if($user_new_passwd!=$user_verify_passwd){
	echo "<a href='modules.php?app=user_passwd'>".$m_langpackage->m_password_notsame."</a>";
	exit;
}
