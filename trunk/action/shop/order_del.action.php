...
//判断是否存在该订单
$order_info = get_order_info($dbo, $t_order_info, $t_order_goods, $t_goods, $t_shop_info, $order_id, 0, $user_id);
if (!$order_info) {
...
//更新订单状态
$sql = "update `$t_order_info` set order_status=0 where order_id='$order_id' and shop_id='$user_id'";
